...
exec /usr/local/django/virtualenvs/verdant-rca/bin/python /usr/local/django/verdant-rca/django-verdant/manage.py celeryd --settings=verdant.settings.staging
