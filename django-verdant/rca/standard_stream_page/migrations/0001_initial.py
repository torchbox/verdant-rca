# -*- coding: utf-8 -*-
# Generated by Django 1.9.13 on 2017-04-13 12:25
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('body', wagtail.wagtailcore.fields.StreamField([(b'paragraph', wagtail.wagtailcore.blocks.RichTextBlock()), (b'image', wagtail.wagtailcore.blocks.StructBlock([(b'image', wagtail.wagtailimages.blocks.ImageChooserBlock()), (b'overlay_text', wagtail.wagtailcore.blocks.CharBlock(max_length=255, required=False))])), (b'quote', wagtail.wagtailcore.blocks.StructBlock([(b'quotation', wagtail.wagtailcore.blocks.CharBlock(classname=b'title')), (b'quotee', wagtail.wagtailcore.blocks.CharBlock(max_length=255, required=False)), (b'quotee_job_title', wagtail.wagtailcore.blocks.CharBlock(max_length=255, required=False)), (b'position', wagtail.wagtailcore.blocks.ChoiceBlock(choices=[(b'full', b'Full-width quote block'), (b'right', b'Right-hand quote block')], default=b'full')), (b'image', wagtail.wagtailimages.blocks.ImageChooserBlock(help_text=b'Can be used only in a full-width quote block', required=False)), (b'left_hand_text', wagtail.wagtailcore.blocks.RichTextBlock(help_text=b'Can be used only in a right-hand quote block', required=False))])), (b'embed', wagtail.wagtailembeds.blocks.EmbedBlock()), (b'callout', wagtail.wagtailcore.blocks.StructBlock([(b'title', wagtail.wagtailcore.blocks.CharBlock(max_length=255)), (b'text', wagtail.wagtailcore.blocks.TextBlock()), (b'link_page', wagtail.wagtailcore.blocks.PageChooserBlock()), (b'image', wagtail.wagtailimages.blocks.ImageChooserBlock(required=False)), (b'left_hand_text', wagtail.wagtailcore.blocks.RichTextBlock())])), (b'carousel', wagtail.wagtailcore.blocks.ListBlock(wagtail.wagtailcore.blocks.StructBlock([(b'image', wagtail.wagtailcore.blocks.StructBlock([(b'image', wagtail.wagtailimages.blocks.ImageChooserBlock()), (b'overlay_text', wagtail.wagtailcore.blocks.CharBlock(max_length=255, required=False))])), (b'link', wagtail.wagtailcore.blocks.URLBlock(label=b'External link', required=False)), (b'link_page', wagtail.wagtailcore.blocks.PageChooserBlock(required=False))]), template=b'standard_stream_page/blocks/carousel_block.html'))])),
                ...
                ('download', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='wagtaildocs.Document')),
