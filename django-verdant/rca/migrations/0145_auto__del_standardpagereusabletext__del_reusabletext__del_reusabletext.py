...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'StandardPageReusableText'
        db.delete_table(u'rca_standardpagereusabletext')

        # Deleting model 'ReusableText'
        db.delete_table(u'rca_reusabletext')

        # Deleting model 'ReusableTextPlacement'
        db.delete_table(u'rca_reusabletextplacement')

        # Adding model 'ReusableTextSnippet'
        db.create_table(u'rca_reusabletextsnippet', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('text', self.gf('wagtail.wagtailcore.fields.RichTextField')()),
        ))
        db.send_create_signal(u'rca', ['ReusableTextSnippet'])

        # Adding model 'ReusableTextSnippetPlacement'
        db.create_table(u'rca_reusabletextsnippetplacement', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('page', self.gf('modelcluster.fields.ParentalKey')(related_name='reusable_text_snippet_placements', to=orm['wagtailcore.Page'])),
            ('reusable_text_snippet', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['rca.ReusableTextSnippet'])),
        ))
        db.send_create_signal(u'rca', ['ReusableTextSnippetPlacement'])

        # Adding model 'StandardPageReusableTextSnippet'
        db.create_table(u'rca_standardpagereusabletextsnippet', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sort_order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('page', self.gf('modelcluster.fields.ParentalKey')(related_name='reusable_text_snippets', to=orm['rca.StandardPage'])),
            ('reusable_text_snippet', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['rca.ReusableTextSnippet'])),
        ))
        db.send_create_signal(u'rca', ['StandardPageReusableTextSnippet'])


    def backwards(self, orm):
        # Adding model 'StandardPageReusableText'
        db.create_table(u'rca_standardpagereusabletext', (
            ('reusable_text', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['rca.ReusableText'])),
            ('sort_order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('page', self.gf('modelcluster.fields.ParentalKey')(related_name='reusable_texts', to=orm['rca.StandardPage'])),
        ))
        db.send_create_signal(u'rca', ['StandardPageReusableText'])
        ...
        db.create_table(u'rca_reusabletextplacement', (
            ('reusable_text', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['rca.ReusableText'])),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('page', self.gf('modelcluster.fields.ParentalKey')(related_name='reusable_rich_text_placements', to=orm['wagtailcore.Page'])),
        ))
        db.send_create_signal(u'rca', ['ReusableTextPlacement'])

        # Deleting model 'ReusableTextSnippet'
        db.delete_table(u'rca_reusabletextsnippet')

        # Deleting model 'ReusableTextSnippetPlacement'
        db.delete_table(u'rca_reusabletextsnippetplacement')

        # Deleting model 'StandardPageReusableTextSnippet'
        db.delete_table(u'rca_standardpagereusabletextsnippet')
