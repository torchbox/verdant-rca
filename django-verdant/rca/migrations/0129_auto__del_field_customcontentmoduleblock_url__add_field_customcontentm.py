...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CustomContentModuleBlock.url'
        db.delete_column(u'rca_customcontentmoduleblock', 'url')

        # Adding field 'CustomContentModuleBlock.link'
        db.add_column(u'rca_customcontentmoduleblock', 'link',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['wagtailcore.Page']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'CustomContentModuleBlock.url'
        db.add_column(u'rca_customcontentmoduleblock', 'url',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'CustomContentModuleBlock.link'
        db.delete_column(u'rca_customcontentmoduleblock', 'link_id')
