...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        snippet_types = [
            ('advert', "Can edit adverts"),
            ('customcontentmodule', "Can edit custom content modules"),
            ('reusabletextsnippet', "Can edit reusable text snippets"),
            ('contactsnippet', "Can edit contact snippets"),
        ]
        ...
        for name, permission_desc in snippet_types:
            content_type, created = orm['contenttypes.ContentType'].objects.get_or_create(
                model=name, app_label='rca')
            permission, created = orm['auth.permission'].objects.get_or_create(
                content_type=content_type, codename='change_%s' % name, defaults=dict(name=permission_desc))
