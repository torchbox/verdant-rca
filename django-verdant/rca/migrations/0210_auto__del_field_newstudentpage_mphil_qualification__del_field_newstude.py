...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'NewStudentPage.innovation_rca_fellow'
        db.add_column(u'rca_newstudentpage', 'innovation_rca_fellow',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'NewStudentPage.innovation_rca_fellow'
        db.delete_column(u'rca_newstudentpage', 'innovation_rca_fellow')
