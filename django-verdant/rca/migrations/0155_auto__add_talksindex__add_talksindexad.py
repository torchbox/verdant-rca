...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TalksIndex'
        db.create_table(u'rca_talksindex', (
        ...
        db.send_create_signal(u'rca', ['TalksIndex'])

        # Adding model 'TalksIndexAd'
        db.create_table(u'rca_talksindexad', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sort_order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('page', self.gf('cluster.fields.ParentalKey')(related_name='manual_adverts', to=orm['rca.TalksIndex'])),
            ('ad', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['rca.Advert'])),
        ))
        db.send_create_signal(u'rca', ['TalksIndexAd'])


    def backwards(self, orm):
        # Deleting model 'TalksIndex'
        db.delete_table(u'rca_talksindex')

        # Deleting model 'TalksIndexAd'
        db.delete_table(u'rca_talksindexad')
