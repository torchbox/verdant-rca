...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'NewStudentPageShowCarouselItem'
        db.create_table(u'rca_newstudentpageshowcarouselitem', (
            ...
            ('page', self.gf('modelcluster.fields.ParentalKey')(related_name='show_carousel_items', to=orm['rca.NewStudentPage'])),
        ))
        db.send_create_signal(u'rca', ['NewStudentPageShowCarouselItem'])

        # Adding model 'NewStudentPageShowCollaborator'
        db.create_table(u'rca_newstudentpageshowcollaborator', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sort_order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('page', self.gf('modelcluster.fields.ParentalKey')(related_name='show_collaborators', to=orm['rca.NewStudentPage'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
        ))
        db.send_create_signal(u'rca', ['NewStudentPageShowCollaborator'])

        # Adding model 'NewStudentPagePreviousDegree'
        db.create_table(u'rca_newstudentpagepreviousdegree', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sort_order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('page', self.gf('modelcluster.fields.ParentalKey')(related_name='previous_degrees', to=orm['rca.NewStudentPage'])),
            ('degree', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'rca', ['NewStudentPagePreviousDegree'])

        # Adding model 'NewStudentPageConference'
        db.create_table(u'rca_newstudentpageconference', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sort_order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('page', self.gf('modelcluster.fields.ParentalKey')(related_name='conferences', to=orm['rca.NewStudentPage'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
        ))
        db.send_create_signal(u'rca', ['NewStudentPageConference'])
        ...
        # Adding model 'NewStudentPageShowAwards'
        db.create_table(u'rca_newstudentpageshowawards', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sort_order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('page', self.gf('modelcluster.fields.ParentalKey')(related_name='show_awards', to=orm['rca.NewStudentPage'])),
            ('award', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
        ))
        db.send_create_signal(u'rca', ['NewStudentPageShowAwards'])

        # Adding model 'NewStudentPageContactsEmail'
        db.create_table(u'rca_newstudentpagecontactsemail', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sort_order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('page', self.gf('modelcluster.fields.ParentalKey')(related_name='emails', to=orm['rca.NewStudentPage'])),
            ('email', self.gf('django.db.models.fields.EmailField')(max_length=255, blank=True)),
        ))
        db.send_create_signal(u'rca', ['NewStudentPageContactsEmail'])

        # Adding model 'NewStudentPageExperience'
        db.create_table(u'rca_newstudentpageexperience', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sort_order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('page', self.gf('modelcluster.fields.ParentalKey')(related_name='experiences', to=orm['rca.NewStudentPage'])),
            ('experience', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
        ))
        db.send_create_signal(u'rca', ['NewStudentPageExperience'])

        # Adding model 'NewStudentPageContactsPhone'
        db.create_table(u'rca_newstudentpagecontactsphone', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sort_order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('page', self.gf('modelcluster.fields.ParentalKey')(related_name='phones', to=orm['rca.NewStudentPage'])),
            ('phone', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
        ))
        db.send_create_signal(u'rca', ['NewStudentPageContactsPhone'])

        # Adding model 'NewStudentPageExhibition'
        db.create_table(u'rca_newstudentpageexhibition', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sort_order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('page', self.gf('modelcluster.fields.ParentalKey')(related_name='exhibitions', to=orm['rca.NewStudentPage'])),
            ('exhibition', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
        ))
        db.send_create_signal(u'rca', ['NewStudentPageExhibition'])

        # Adding model 'NewStudentPage'
        db.create_table(u'rca_newstudentpage', (
            ...
            ('preferred_name', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('profile_image', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage'])),
            ('statement', self.gf('wagtail.wagtailcore.fields.RichTextField')(blank=True)),
            ('twitter_handle', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('funding', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('feed_image', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['rca.RcaImage'])),
            ('show_on_homepage', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('rca_content_id', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('random_order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('postgrad_school', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('postgrad_programme', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('postgrad_degree_year', self.gf('django.db.models.fields.CharField')(max_length=4, blank=True)),
            ('postgrad_specialism', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('show_work_title', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('show_work_type', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('show_work_location', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('show_work_description', self.gf('wagtail.wagtailcore.fields.RichTextField')(blank=True)),
            ('show_in_show', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('research_school', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('research_programme', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('research_start_year', self.gf('django.db.models.fields.CharField')(max_length=4, blank=True)),
            ('research_graduation_year', self.gf('django.db.models.fields.CharField')(max_length=4, blank=True)),
            ('research_qualification', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('research_dissertation_title', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('research_statement', self.gf('wagtail.wagtailcore.fields.RichTextField')(blank=True)),
            ('research_in_show', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'rca', ['NewStudentPage'])

        # Adding model 'NewStudentPageContactsWebsite'
        db.create_table(u'rca_newstudentpagecontactswebsite', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sort_order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('page', self.gf('modelcluster.fields.ParentalKey')(related_name='websites', to=orm['rca.NewStudentPage'])),
            ('website', self.gf('django.db.models.fields.URLField')(max_length=255, blank=True)),
        ))
        db.send_create_signal(u'rca', ['NewStudentPageContactsWebsite'])

        # Adding model 'NewStudentPagePublication'
        db.create_table(u'rca_newstudentpagepublication', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sort_order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('page', self.gf('modelcluster.fields.ParentalKey')(related_name='publications', to=orm['rca.NewStudentPage'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
        ))
        db.send_create_signal(u'rca', ['NewStudentPagePublication'])
        ...
        # Adding model 'NewStudentPageShowSponsor'
        db.create_table(u'rca_newstudentpageshowsponsor', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sort_order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('page', self.gf('modelcluster.fields.ParentalKey')(related_name='show_sponsors', to=orm['rca.NewStudentPage'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
        ))
        db.send_create_signal(u'rca', ['NewStudentPageShowSponsor'])


    def backwards(self, orm):
        # Deleting model 'NewStudentPageShowCarouselItem'
        db.delete_table(u'rca_newstudentpageshowcarouselitem')

        # Deleting model 'NewStudentPageShowCollaborator'
        db.delete_table(u'rca_newstudentpageshowcollaborator')

        # Deleting model 'NewStudentPagePreviousDegree'
        db.delete_table(u'rca_newstudentpagepreviousdegree')

        # Deleting model 'NewStudentPageConference'
        db.delete_table(u'rca_newstudentpageconference')

        # Deleting model 'NewStudentPageResearchCarouselItem'
        db.delete_table(u'rca_newstudentpageresearchcarouselitem')

        # Deleting model 'NewStudentPageShowAwards'
        db.delete_table(u'rca_newstudentpageshowawards')

        # Deleting model 'NewStudentPageContactsEmail'
        db.delete_table(u'rca_newstudentpagecontactsemail')

        # Deleting model 'NewStudentPageExperience'
        db.delete_table(u'rca_newstudentpageexperience')

        # Deleting model 'NewStudentPageContactsPhone'
        db.delete_table(u'rca_newstudentpagecontactsphone')

        # Deleting model 'NewStudentPageExhibition'
        db.delete_table(u'rca_newstudentpageexhibition')

        # Deleting model 'NewStudentPage'
        db.delete_table(u'rca_newstudentpage')

        # Deleting model 'NewStudentPageContactsWebsite'
        db.delete_table(u'rca_newstudentpagecontactswebsite')

        # Deleting model 'NewStudentPagePublication'
        db.delete_table(u'rca_newstudentpagepublication')

        # Deleting model 'NewStudentPageResearchSupervisor'
        db.delete_table(u'rca_newstudentpageresearchsupervisor')

        # Deleting model 'NewStudentPageShowSponsor'
        db.delete_table(u'rca_newstudentpageshowsponsor')
    ...
    models = {
        ...
        u'rca.newstudentpage': {
            ...
            u'page_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['wagtailcore.Page']", 'unique': 'True', 'primary_key': 'True'}),
            'postgrad_degree_year': ('django.db.models.fields.CharField', [], {'max_length': '4', 'blank': 'True'}),
            'postgrad_programme': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'postgrad_school': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'postgrad_specialism': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'preferred_name': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'profile_image': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['rca.RcaImage']"}),
            'random_order': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'rca_content_id': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'research_dissertation_title': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'research_graduation_year': ('django.db.models.fields.CharField', [], {'max_length': '4', 'blank': 'True'}),
            'research_in_show': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'research_programme': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'research_qualification': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'research_school': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'research_start_year': ('django.db.models.fields.CharField', [], {'max_length': '4', 'blank': 'True'}),
            'research_statement': ('wagtail.wagtailcore.fields.RichTextField', [], {'blank': 'True'}),
            'show_in_show': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        u'rca.newstudentpageresearchcarouselitem': {
            'Meta': {'ordering': "['sort_order']", 'object_name': 'NewStudentPageResearchCarouselItem'},
            'embedly_url': ('django.db.models.fields.URLField', [], {'max_length': '200', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['rca.RcaImage']"}),
            'link': ('django.db.models.fields.URLField', [], {'max_length': '200', 'blank': 'True'}),
            'link_page': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['wagtailcore.Page']"}),
            'overlay_text': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'page': ('modelcluster.fields.ParentalKey', [], {'related_name': "'research_carousel_items'", 'to': u"orm['rca.NewStudentPage']"}),
            'poster_image': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['rca.RcaImage']"}),
            'sort_order': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'})
        },
        u'rca.newstudentpageresearchsupervisor': {
            'Meta': {'ordering': "['sort_order']", 'object_name': 'NewStudentPageResearchSupervisor'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'page': ('modelcluster.fields.ParentalKey', [], {'related_name': "'research_supervisors'", 'to': u"orm['rca.NewStudentPage']"}),
            'sort_order': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
        ...
        u'rca.newstudentpageshowawards': {
            'Meta': {'ordering': "['sort_order']", 'object_name': 'NewStudentPageShowAwards'},
            'award': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'page': ('modelcluster.fields.ParentalKey', [], {'related_name': "'show_awards'", 'to': u"orm['rca.NewStudentPage']"}),
            'sort_order': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'})
        },
