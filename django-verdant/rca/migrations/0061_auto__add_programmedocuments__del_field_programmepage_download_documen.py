...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProgrammeDocuments'
        db.create_table(u'rca_programmedocuments', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('page', self.gf('django.db.models.fields.related.ForeignKey')(related_name='documents', to=orm['rca.ProgrammePage'])),
        ...
        db.send_create_signal(u'rca', ['ProgrammeDocuments'])
    ...
    def backwards(self, orm):
        # Deleting model 'ProgrammeDocuments'
        db.delete_table(u'rca_programmedocuments')
