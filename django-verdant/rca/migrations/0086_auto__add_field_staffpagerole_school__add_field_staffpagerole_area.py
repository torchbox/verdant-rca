...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StaffPageRole.school'
        db.add_column(u'rca_staffpagerole', 'school',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'StaffPageRole.area'
        db.add_column(u'rca_staffpagerole', 'area',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StaffPageRole.school'
        db.delete_column(u'rca_staffpagerole', 'school')

        # Deleting field 'StaffPageRole.area'
        db.delete_column(u'rca_staffpagerole', 'area')
