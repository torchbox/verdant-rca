...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'NewStudentPageResearchAwards'
        db.create_table(u'rca_newstudentpageresearchawards', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sort_order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('page', self.gf('modelcluster.fields.ParentalKey')(related_name='research_awards', to=orm['rca.NewStudentPage'])),
            ('award', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
        ))
        db.send_create_signal(u'rca', ['NewStudentPageResearchAwards'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'NewStudentPageResearchAwards'
        db.delete_table(u'rca_newstudentpageresearchawards')
