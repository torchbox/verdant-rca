...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'rca_homepagerelatedlink', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sort_order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('page', self.gf('cluster.fields.ParentalKey')(related_name='related_links', to=orm['rca.HomePage'])),
        ...
        db.send_create_signal(u'rca', ['HomePageRelatedLink'])


    def backwards(self, orm):
        # Deleting model 'HomePageRelatedLink'
        db.delete_table(u'rca_homepagerelatedlink')
