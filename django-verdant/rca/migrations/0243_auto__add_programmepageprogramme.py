...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProgrammePageProgramme'
        db.create_table(u'rca_programmepageprogramme', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('page', self.gf('modelcluster.fields.ParentalKey')(related_name='programmes', to=orm['rca.ProgrammePage'])),
            ('programme', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
        ))
        db.send_create_signal(u'rca', ['ProgrammePageProgramme'])


    def backwards(self, orm):
        # Deleting model 'ProgrammePageProgramme'
        db.delete_table(u'rca_programmepageprogramme')
