...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'rca_customcontentmodule', 'page',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='custom_content_module', null=True, to=orm['core.Page']),
                      keep_default=False)
    ...
    models = {
        ...
        u'rca.customcontentmodule': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'page': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'custom_content_module'", 'null': 'True', 'to': u"orm['core.Page']"})
        },
