...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for rcanowpage in orm['rca.RcaNowPage'].objects.all():
            area_pk = None
            if rcanowpage.area:
                area, created = orm['rca.RcaNowPageArea'].objects.get_or_create(page=rcanowpage, area=rcanowpage.area)
                area_pk = area.pk

            # Update revisions
            for revision in rcanowpage.revisions.all():
                # Decode json
