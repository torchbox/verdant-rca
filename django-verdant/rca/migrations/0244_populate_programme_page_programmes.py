...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for page in orm['rca.ProgrammePage'].objects.filter(live=True):
            programme, _ = orm['rca.ProgrammePageProgramme'].objects.get_or_create(page=page, programme=page.programme)
            ...
            # Add area
            if revision_data['programme']:
                revision_data['programmes'] = [{
                    'pk': programme.pk,
                    'page': page.pk,
                    'programme': revision_data['programme'],
                }]
