...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'JobPageReusableTextSnippet'
        db.create_table(u'rca_jobpagereusabletextsnippet', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sort_order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('page', self.gf('cluster.fields.ParentalKey')(related_name='reusable_text_snippets', to=orm['rca.JobPage'])),
            ('reusable_text_snippet', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['rca.ReusableTextSnippet'])),
        ))
        db.send_create_signal(u'rca', ['JobPageReusableTextSnippet'])


    def backwards(self, orm):
        # Deleting model 'JobPageReusableTextSnippet'
        db.delete_table(u'rca_jobpagereusabletextsnippet')
