...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EventItemDatesTimes'
        db.create_table(u'rca_eventitemdatestimes', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('page', self.gf('django.db.models.fields.related.ForeignKey')(related_name='dates_times', to=orm['rca.EventItem'])),
            ('date_from', self.gf('django.db.models.fields.DateField')()),
            ('date_to', self.gf('django.db.models.fields.DateField')(blank=True)),
            ('time_from', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('time_to', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
        ))
        db.send_create_signal(u'rca', ['EventItemDatesTimes'])

        # Deleting field 'EventItem.date_from'
        db.delete_column(u'rca_eventitem', 'date_from')

        # Deleting field 'EventItem.times'
        db.delete_column(u'rca_eventitem', 'times')

        # Deleting field 'EventItem.date_to'
        db.delete_column(u'rca_eventitem', 'date_to')

        # Adding field 'ProgrammePage.twitter_feed'
        db.add_column(u'rca_programmepage', 'twitter_feed',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'EventItemDatesTimes'
        db.delete_table(u'rca_eventitemdatestimes')


        # User chose to not deal with backwards NULL issues for 'EventItem.date_from'
        raise RuntimeError("Cannot reverse this migration. 'EventItem.date_from' and its values cannot be restored.")
        # Adding field 'EventItem.times'
        db.add_column(u'rca_eventitem', 'times',
                      self.gf('core.fields.RichTextField')(default='', blank=True),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'EventItem.date_to'
        raise RuntimeError("Cannot reverse this migration. 'EventItem.date_to' and its values cannot be restored.")
        # Deleting field 'ProgrammePage.twitter_feed'
        db.delete_column(u'rca_programmepage', 'twitter_feed')
