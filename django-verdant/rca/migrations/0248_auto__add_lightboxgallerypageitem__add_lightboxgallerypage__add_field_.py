...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'LightboxGalleryPageItem'
        db.create_table(u'rca_lightboxgallerypageitem', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sort_order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('page', self.gf('modelcluster.fields.ParentalKey')(related_name='gallery_items', to=orm['rca.LightboxGalleryPage'])),
        ...
        db.send_create_signal(u'rca', ['LightboxGalleryPageItem'])

        # Adding model 'LightboxGalleryPage'
        db.create_table(u'rca_lightboxgallerypage', (
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'rca_lightboxgallerypageitem')
    ...
    models = {
        ...
        u'rca.lightboxgallerypage': {
            'Meta': {'object_name': 'LightboxGalleryPage', '_ormbases': [u'wagtailcore.Page']},
            'feed_image': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['rca.RcaImage']"}),
            'intro': ('wagtail.wagtailcore.fields.RichTextField', [], {'blank': 'True'}),
            'listing_intro': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
            u'page_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['wagtailcore.Page']", 'unique': 'True', 'primary_key': 'True'}),
        ...
        u'rca.lightboxgallerypageitem': {
            'Meta': {'ordering': "['sort_order']", 'object_name': 'LightboxGalleryPageItem'},
            'embedly_url': ('django.db.models.fields.URLField', [], {'max_length': '200', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['rca.RcaImage']"}),
            'page': ('modelcluster.fields.ParentalKey', [], {'related_name': "'gallery_items'", 'to': u"orm['rca.LightboxGalleryPage']"}),
            'poster_image': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['rca.RcaImage']"}),
            'sort_order': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'})
        },
        u'rca.newsindex': {
