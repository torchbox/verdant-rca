...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'StandardIndexOurSites'
        db.create_table(u'rca_standardindexoursites', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sort_order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('page', self.gf('cluster.fields.ParentalKey')(related_name='our_sites', to=orm['rca.StandardIndex'])),
        ...
        db.send_create_signal(u'rca', ['StandardIndexOurSites'])


    def backwards(self, orm):
        # Deleting model 'StandardIndexOurSites'
        db.delete_table(u'rca_standardindexoursites')
