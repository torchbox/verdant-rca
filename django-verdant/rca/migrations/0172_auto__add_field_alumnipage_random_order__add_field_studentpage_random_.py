...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AlumniPage.random_order'
        db.add_column(u'rca_alumnipage', 'random_order',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'StudentPage.random_order'
        db.add_column(u'rca_studentpage', 'random_order',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AlumniPage.random_order'
        db.delete_column(u'rca_alumnipage', 'random_order')

        # Deleting field 'StudentPage.random_order'
        db.delete_column(u'rca_studentpage', 'random_order')
