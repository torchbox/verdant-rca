...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RcaNowPagePageCarouselItem'
        db.create_table(u'rca_rcanowpagepagecarouselitem', (
            ...
            ('page', self.gf('django.db.models.fields.related.ForeignKey')(related_name='carousel_items', to=orm['rca.RcaNowPage'])),
        ))
        db.send_create_signal(u'rca', ['RcaNowPagePageCarouselItem'])

        # Adding field 'RcaNowPage.body'
        db.add_column(u'rca_rcanowpage', 'body',
                      self.gf('wagtail.wagtailcore.fields.RichTextField')(default=''),
                      keep_default=False)

        # Adding field 'RcaNowPage.programme'
        db.add_column(u'rca_rcanowpage', 'programme',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Adding field 'RcaNowPage.school'
        db.add_column(u'rca_rcanowpage', 'school',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Adding field 'RcaNowPage.area'
        db.add_column(u'rca_rcanowpage', 'area',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Adding field 'RcaNowPage.show_on_homepage'
        db.add_column(u'rca_rcanowpage', 'show_on_homepage',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'RcaNowPagePageCarouselItem'
        db.delete_table(u'rca_rcanowpagepagecarouselitem')

        # Deleting field 'RcaNowPage.body'
        db.delete_column(u'rca_rcanowpage', 'body')

        # Deleting field 'RcaNowPage.programme'
        db.delete_column(u'rca_rcanowpage', 'programme')

        # Deleting field 'RcaNowPage.school'
        db.delete_column(u'rca_rcanowpage', 'school')

        # Deleting field 'RcaNowPage.area'
        db.delete_column(u'rca_rcanowpage', 'area')

        # Deleting field 'RcaNowPage.show_on_homepage'
        db.delete_column(u'rca_rcanowpage', 'show_on_homepage')
