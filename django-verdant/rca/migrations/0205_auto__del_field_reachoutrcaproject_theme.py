...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ReachOutRCAProject.theme'
        db.delete_column(u'rca_reachoutrcaproject', 'theme')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'ReachOutRCAProject.theme'
        raise RuntimeError("Cannot reverse this migration. 'ReachOutRCAProject.theme' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'ReachOutRCAProject.theme'
        db.add_column(u'rca_reachoutrcaproject', 'theme',
