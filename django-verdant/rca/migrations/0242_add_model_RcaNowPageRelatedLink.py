...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RcaNowPageRelatedLink'
        db.create_table(u'rca_rcanowpagerelatedlink', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sort_order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('page', self.gf('modelcluster.fields.ParentalKey')(related_name='related_links', to=orm['rca.RcaNowPage'])),
            ('link', self.gf('django.db.models.fields.URLField')(max_length=255, blank=True)),
        ))
        db.send_create_signal(u'rca', ['RcaNowPageRelatedLink'])


    def backwards(self, orm):
        # Deleting model 'RcaNowPageRelatedLink'
        db.delete_table(u'rca_rcanowpagerelatedlink')
