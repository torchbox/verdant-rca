...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ReviewPageQuotation'
        db.create_table(u'rca_reviewpagequotation', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sort_order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('page', self.gf('modelcluster.fields.ParentalKey')(related_name='quotations', to=orm['rca.ReviewPage'])),
        ...
        db.send_create_signal(u'rca', ['ReviewPageQuotation'])

        # Adding model 'ReviewPageAd'
        db.create_table(u'rca_reviewpagead', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sort_order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('page', self.gf('modelcluster.fields.ParentalKey')(related_name='manual_adverts', to=orm['rca.ReviewPage'])),
            ('ad', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['rca.Advert'])),
        ))
        db.send_create_signal(u'rca', ['ReviewPageAd'])

        # Adding model 'ReviewPageImage'
        db.create_table(u'rca_reviewpageimage', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sort_order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('page', self.gf('modelcluster.fields.ParentalKey')(related_name='images', to=orm['rca.ReviewPage'])),
            ('image', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['rca.RcaImage'])),
        ))
        db.send_create_signal(u'rca', ['ReviewPageImage'])

        # Adding model 'ReviewPageRelatedLink'
        db.create_table(u'rca_reviewpagerelatedlink', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sort_order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('page', self.gf('modelcluster.fields.ParentalKey')(related_name='related_links', to=orm['rca.ReviewPage'])),
        ...
        db.send_create_signal(u'rca', ['ReviewPageRelatedLink'])

        # Adding model 'ReviewPage'
        db.create_table(u'rca_reviewpage', (
        ...
        db.send_create_signal(u'rca', ['ReviewPage'])

        # Adding model 'ReviewPageRelatedDocument'
        db.create_table(u'rca_reviewpagerelateddocument', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sort_order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('page', self.gf('modelcluster.fields.ParentalKey')(related_name='documents', to=orm['rca.ReviewPage'])),
            ('document', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['wagtaildocs.Document'])),
            ('document_name', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'rca', ['ReviewPageRelatedDocument'])

        # Adding model 'ReviewPageCarouselItem'
        db.create_table(u'rca_reviewpagecarouselitem', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sort_order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('image', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['rca.RcaImage'])),
            ...
            ('page', self.gf('modelcluster.fields.ParentalKey')(related_name='carousel_items', to=orm['rca.ReviewPage'])),
        ))
        db.send_create_signal(u'rca', ['ReviewPageCarouselItem'])


    def backwards(self, orm):
        # Deleting model 'ReviewPageQuotation'
        db.delete_table(u'rca_reviewpagequotation')

        # Deleting model 'ReviewPageAd'
        db.delete_table(u'rca_reviewpagead')

        # Deleting model 'ReviewPageImage'
        db.delete_table(u'rca_reviewpageimage')

        # Deleting model 'ReviewPageRelatedLink'
        db.delete_table(u'rca_reviewpagerelatedlink')

        # Deleting model 'ReviewPage'
        db.delete_table(u'rca_reviewpage')

        # Deleting model 'ReviewPageRelatedDocument'
        db.delete_table(u'rca_reviewpagerelateddocument')

        # Deleting model 'ReviewPageCarouselItem'
        db.delete_table(u'rca_reviewpagecarouselitem')
