...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'rca_reviewpagequotation', (
            ...
            ('page', self.gf('cluster.fields.ParentalKey')(related_name='quotations', to=orm['rca.ReviewPage'])),
        ...
        db.create_table(u'rca_reviewpagead', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sort_order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('page', self.gf('cluster.fields.ParentalKey')(related_name='manual_adverts', to=orm['rca.ReviewPage'])),
        ...
        db.create_table(u'rca_reviewpageimage', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sort_order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('page', self.gf('cluster.fields.ParentalKey')(related_name='images', to=orm['rca.ReviewPage'])),
        ...
        db.create_table(u'rca_reviewpagerelatedlink', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sort_order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('page', self.gf('cluster.fields.ParentalKey')(related_name='related_links', to=orm['rca.ReviewPage'])),
        ...
        db.create_table(u'rca_reviewpagerelateddocument', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sort_order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('page', self.gf('cluster.fields.ParentalKey')(related_name='documents', to=orm['rca.ReviewPage'])),
        ...
        db.create_table(u'rca_reviewpagecarouselitem', (
            ...
            ('page', self.gf('cluster.fields.ParentalKey')(related_name='carousel_items', to=orm['rca.ReviewPage'])),
        ))
