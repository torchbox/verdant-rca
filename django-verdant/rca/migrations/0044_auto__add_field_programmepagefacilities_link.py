...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProgrammePageFacilities.link'
        db.add_column(u'rca_programmepagefacilities', 'link',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['wagtailcore.Page']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProgrammePageFacilities.link'
        db.delete_column(u'rca_programmepagefacilities', 'link_id')
