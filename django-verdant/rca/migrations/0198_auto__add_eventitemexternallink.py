...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EventItemExternalLink'
        db.create_table(u'rca_eventitemexternallink', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sort_order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('page', self.gf('modelcluster.fields.ParentalKey')(related_name='external_links', to=orm['rca.EventItem'])),
            ('link', self.gf('django.db.models.fields.URLField')(max_length=200)),
            ('text', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
        ))
        db.send_create_signal(u'rca', ['EventItemExternalLink'])


    def backwards(self, orm):
        # Deleting model 'EventItemExternalLink'
        db.delete_table(u'rca_eventitemexternallink')
