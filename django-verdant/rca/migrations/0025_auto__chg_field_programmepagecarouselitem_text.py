...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProgrammePageCarouselItem.text'
        db.alter_column(u'rca_programmepagecarouselitem', 'text', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'ProgrammePageCarouselItem.text'
        db.alter_column(u'rca_programmepagecarouselitem', 'text', self.gf('django.db.models.fields.CharField')(max_length=25))
