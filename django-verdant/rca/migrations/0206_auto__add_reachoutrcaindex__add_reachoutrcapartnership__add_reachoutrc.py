...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ReachOutRCAIndex'
        db.create_table(u'rca_reachoutrcaindex', (
        ...
        db.send_create_signal(u'rca', ['ReachOutRCAIndex'])

        # Adding model 'ReachOutRCAPartnership'
        db.create_table(u'rca_reachoutrcapartnership', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sort_order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('page', self.gf('modelcluster.fields.ParentalKey')(related_name='partnerships', to=orm['rca.ReachOutRCAProject'])),
            ('partnership', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
        ))
        db.send_create_signal(u'rca', ['ReachOutRCAPartnership'])

        # Adding model 'ReachOutRCAIndexAd'
        db.create_table(u'rca_reachoutrcaindexad', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sort_order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('page', self.gf('modelcluster.fields.ParentalKey')(related_name='manual_adverts', to=orm['rca.ReachOutRCAIndex'])),
            ('ad', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['rca.Advert'])),
        ))
        db.send_create_signal(u'rca', ['ReachOutRCAIndexAd'])


    def backwards(self, orm):
        # Deleting model 'ReachOutRCAIndex'
        db.delete_table(u'rca_reachoutrcaindex')

        # Deleting model 'ReachOutRCAPartnership'
        db.delete_table(u'rca_reachoutrcapartnership')

        # Deleting model 'ReachOutRCAIndexAd'
        db.delete_table(u'rca_reachoutrcaindexad')
