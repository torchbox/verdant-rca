...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'SustainRCAIndexAd'
        db.create_table(u'rca_sustainrcaindexad', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sort_order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('page', self.gf('modelcluster.fields.ParentalKey')(related_name='manual_adverts', to=orm['rca.SustainRCAIndex'])),
            ('ad', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['rca.Advert'])),
        ))
        db.send_create_signal(u'rca', ['SustainRCAIndexAd'])

        # Adding model 'SustainRCAProjectCarouselItem'
        db.create_table(u'rca_sustainrcaprojectcarouselitem', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sort_order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ...
            ('page', self.gf('modelcluster.fields.ParentalKey')(related_name='carousel_items', to=orm['rca.SustainRCAProject'])),
        ))
        db.send_create_signal(u'rca', ['SustainRCAProjectCarouselItem'])

        # Adding model 'SustainRCAProjectCreator'
        db.create_table(u'rca_sustainrcaprojectcreator', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sort_order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('page', self.gf('modelcluster.fields.ParentalKey')(related_name='creator', to=orm['rca.SustainRCAProject'])),
            ('person', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['wagtailcore.Page'])),
            ('manual_person_name', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
        ))
        db.send_create_signal(u'rca', ['SustainRCAProjectCreator'])

        # Adding model 'SustainRCAProject'
        db.create_table(u'rca_sustainrcaproject', (
            ...
            ('description', self.gf('wagtail.wagtailcore.fields.RichTextField')()),
            ...
            ('twitter_feed', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('show_on_homepage', self.gf('django.db.models.fields.BooleanField')()),
            ('random_order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('feed_image', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage'])),
        ))
        db.send_create_signal(u'rca', ['SustainRCAProject'])

        # Adding model 'SustainRCAProjectLink'
        db.create_table(u'rca_sustainrcaprojectlink', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sort_order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('page', self.gf('modelcluster.fields.ParentalKey')(related_name='links', to=orm['rca.SustainRCAProject'])),
            ('link', self.gf('django.db.models.fields.URLField')(max_length=200)),
            ('link_text', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'rca', ['SustainRCAProjectLink'])

        # Adding model 'SustainRCAIndex'
        db.create_table(u'rca_sustainrcaindex', (
            (u'page_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['wagtailcore.Page'], unique=True, primary_key=True)),
            ('social_image', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage'])),
            ('social_text', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
        ...
        db.send_create_signal(u'rca', ['SustainRCAIndex'])


    def backwards(self, orm):
        # Deleting model 'SustainRCAIndexAd'
        db.delete_table(u'rca_sustainrcaindexad')

        # Deleting model 'SustainRCAProjectCarouselItem'
        db.delete_table(u'rca_sustainrcaprojectcarouselitem')

        # Deleting model 'SustainRCAProjectCreator'
        db.delete_table(u'rca_sustainrcaprojectcreator')

        # Deleting model 'SustainRCAProject'
        db.delete_table(u'rca_sustainrcaproject')

        # Deleting model 'SustainRCAProjectLink'
        db.delete_table(u'rca_sustainrcaprojectlink')

        # Deleting model 'SustainRCAIndex'
        db.delete_table(u'rca_sustainrcaindex')
    ...
    models = {
        ...
        u'rca.homepage': {
            ...
            'packery_blog': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
        ...
        u'rca.newsitemarea': {
            'Meta': {'object_name': 'NewsItemArea'},
            'area': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'page': ('modelcluster.fields.ParentalKey', [], {'related_name': "'areas'", 'to': u"orm['rca.NewsItem']"})
        },
        ...
        u'rca.newstudentpage': {
            ...
            'mphil_degree_type': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            ...
            'mphil_status': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'mphil_work_location': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            u'page_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['wagtailcore.Page']", 'unique': 'True', 'primary_key': 'True'}),
            'phd_degree_type': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            ...
            'phd_status': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
        ...
        u'rca.oeformpage': {
            'Meta': {'object_name': 'OEFormPage', '_ormbases': [u'wagtailcore.Page']},
            'body': ('wagtail.wagtailcore.fields.RichTextField', [], {'blank': 'True'}),
        ...
        u'rca.pressreleasearea': {
            'Meta': {'object_name': 'PressReleaseArea'},
            'area': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'page': ('modelcluster.fields.ParentalKey', [], {'related_name': "'areas'", 'to': u"orm['rca.PressRelease']"})
        },
        ...
        u'rca.programmepage': {
            ...
            'background_image': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['rca.RcaImage']"}),
            'collapse_upcoming_events': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'contact_address': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'contact_link': ('django.db.models.fields.URLField', [], {'max_length': '200', 'blank': 'True'}),
            'contact_link_text': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'contact_title': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            ...
            'head_of_programme_second': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['rca.StaffPage']"}),
        ...
        u'rca.programmepagefacilitiescarouselitem': {
            'Meta': {'ordering': "['sort_order']", 'object_name': 'ProgrammePageFacilitiesCarouselItem'},
            'facilities_image': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['rca.RcaImage']"}),
            'facilities_link': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['wagtailcore.Page']"}),
            'facilities_text': ('wagtail.wagtailcore.fields.RichTextField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'page': ('modelcluster.fields.ParentalKey', [], {'related_name': "'facilities_carousel_items'", 'to': u"orm['rca.ProgrammePage']"}),
            'sort_order': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'})
        },
        ...
        u'rca.programmepageprogramme': {
            'Meta': {'object_name': 'ProgrammePageProgramme'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'page': ('modelcluster.fields.ParentalKey', [], {'related_name': "'programmes'", 'to': u"orm['rca.ProgrammePage']"}),
            'programme': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'})
        },
        ...
        u'rca.rcablogindex': {
            'Meta': {'object_name': 'RcaBlogIndex', '_ormbases': [u'wagtailcore.Page']},
        ...
        u'rca.rcablogpage': {
            'Meta': {'object_name': 'RcaBlogPage', '_ormbases': [u'wagtailcore.Page']},
            'area': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
        ...
        u'rca.rcablogpagearea': {
            'Meta': {'object_name': 'RcaBlogPageArea'},
            'area': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'page': ('modelcluster.fields.ParentalKey', [], {'related_name': "'areas'", 'to': u"orm['rca.RcaBlogPage']"})
        },
        u'rca.rcablogpagepagecarouselitem': {
            'Meta': {'ordering': "['sort_order']", 'object_name': 'RcaBlogPagePageCarouselItem'},
            'embedly_url': ('django.db.models.fields.URLField', [], {'max_length': '200', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['rca.RcaImage']"}),
            'link': ('django.db.models.fields.URLField', [], {'max_length': '200', 'blank': 'True'}),
            'link_page': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['wagtailcore.Page']"}),
            'overlay_text': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'page': ('modelcluster.fields.ParentalKey', [], {'related_name': "'carousel_items'", 'to': u"orm['rca.RcaBlogPage']"}),
            'poster_image': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['rca.RcaImage']"}),
            'sort_order': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'})
        },
        u'rca.rcablogpagetag': {
            'Meta': {'object_name': 'RcaBlogPageTag'},
            'content_object': ('modelcluster.fields.ParentalKey', [], {'related_name': "'tagged_items'", 'to': u"orm['rca.RcaBlogPage']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'tag': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'rca_rcablogpagetag_items'", 'to': u"orm['taggit.Tag']"})
        },
        u'rca.rcaimage': {
        ...
        u'rca.rcanowpagearea': {
            'Meta': {'object_name': 'RcaNowPageArea'},
            'area': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'page': ('modelcluster.fields.ParentalKey', [], {'related_name': "'areas'", 'to': u"orm['rca.RcaNowPage']"})
        },
        ...
        u'rca.rcanowpagerelatedlink': {
            'Meta': {'ordering': "['sort_order']", 'object_name': 'RcaNowPageRelatedLink'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'link': ('django.db.models.fields.URLField', [], {'max_length': '255', 'blank': 'True'}),
            'page': ('modelcluster.fields.ParentalKey', [], {'related_name': "'related_links'", 'to': u"orm['rca.RcaNowPage']"}),
            'sort_order': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'})
        },
        u'rca.rcanowpagetag': {
        ...
        u'rca.rcarendition': {
            'Meta': {'unique_together': "(('image', 'filter', 'focal_point_key'),)", 'object_name': 'RcaRendition'},
            'file': ('django.db.models.fields.files.ImageField', [], {'max_length': '100'}),
        ...
        u'rca.standardindex': {
            ...
            'feed_image': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['rca.RcaImage']"}),
            'hide_body': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'intro': ('wagtail.wagtailcore.fields.RichTextField', [], {'blank': 'True'}),
            'intro_link': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['wagtailcore.Page']"}),
            'news_carousel_area': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            u'page_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['wagtailcore.Page']", 'unique': 'True', 'primary_key': 'True'}),
        ...
        u'rca.streampage': {
            'Meta': {'object_name': 'StreamPage', '_ormbases': [u'wagtailcore.Page']},
            'body': ('wagtail.wagtailcore.fields.RichTextField', [], {}),
            'feed_image': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['rca.RcaImage']"}),
            'intro': ('wagtail.wagtailcore.fields.RichTextField', [], {'blank': 'True'}),
            u'page_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['wagtailcore.Page']", 'unique': 'True', 'primary_key': 'True'}),
        ...
        u'rca.streampagead': {
            'Meta': {'ordering': "['sort_order']", 'object_name': 'StreamPageAd'},
            'ad': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'to': u"orm['rca.Advert']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'page': ('modelcluster.fields.ParentalKey', [], {'related_name': "'manual_adverts'", 'to': u"orm['rca.StreamPage']"}),
            'sort_order': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'})
        },
        u'rca.streampagerelatedlink': {
            'Meta': {'ordering': "['sort_order']", 'object_name': 'StreamPageRelatedLink'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'link': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'to': u"orm['wagtailcore.Page']"}),
            'link_external': ('django.db.models.fields.URLField', [], {'max_length': '200', 'blank': 'True'}),
            'link_text': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'page': ('modelcluster.fields.ParentalKey', [], {'related_name': "'related_links'", 'to': u"orm['rca.StreamPage']"}),
            'sort_order': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'})
        },
        u'rca.studentpage': {
        ...
        u'rca.sustainrcaindex': {
            'Meta': {'object_name': 'SustainRCAIndex', '_ormbases': [u'wagtailcore.Page']},
            'feed_image': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['rca.RcaImage']"}),
            'intro': ('wagtail.wagtailcore.fields.RichTextField', [], {'blank': 'True'}),
            u'page_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['wagtailcore.Page']", 'unique': 'True', 'primary_key': 'True'}),
            'social_image': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['rca.RcaImage']"}),
        ...
        u'rca.sustainrcaindexad': {
            'Meta': {'ordering': "['sort_order']", 'object_name': 'SustainRCAIndexAd'},
            'ad': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'to': u"orm['rca.Advert']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'page': ('modelcluster.fields.ParentalKey', [], {'related_name': "'manual_adverts'", 'to': u"orm['rca.SustainRCAIndex']"}),
            'sort_order': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'})
        },
        u'rca.sustainrcaproject': {
            'Meta': {'object_name': 'SustainRCAProject', '_ormbases': [u'wagtailcore.Page']},
        ...
        u'rca.sustainrcaprojectcarouselitem': {
            'Meta': {'ordering': "['sort_order']", 'object_name': 'SustainRCAProjectCarouselItem'},
            'embedly_url': ('django.db.models.fields.URLField', [], {'max_length': '200', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['rca.RcaImage']"}),
            'link': ('django.db.models.fields.URLField', [], {'max_length': '200', 'blank': 'True'}),
            'link_page': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['wagtailcore.Page']"}),
            'overlay_text': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'page': ('modelcluster.fields.ParentalKey', [], {'related_name': "'carousel_items'", 'to': u"orm['rca.SustainRCAProject']"}),
            'poster_image': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['rca.RcaImage']"}),
            'sort_order': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'})
        },
        u'rca.sustainrcaprojectcreator': {
            'Meta': {'ordering': "['sort_order']", 'object_name': 'SustainRCAProjectCreator'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'manual_person_name': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'page': ('modelcluster.fields.ParentalKey', [], {'related_name': "'creator'", 'to': u"orm['rca.SustainRCAProject']"}),
            'person': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'to': u"orm['wagtailcore.Page']"}),
            'sort_order': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'})
        },
        u'rca.sustainrcaprojectlink': {
            'Meta': {'ordering': "['sort_order']", 'object_name': 'SustainRCAProjectLink'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'link': ('django.db.models.fields.URLField', [], {'max_length': '200'}),
            'link_text': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'page': ('modelcluster.fields.ParentalKey', [], {'related_name': "'links'", 'to': u"orm['rca.SustainRCAProject']"}),
            'sort_order': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'})
        },
        u'rca.talksindex': {
