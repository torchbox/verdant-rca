...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AlumniPage.listing_intro'
        db.add_column(u'rca_alumnipage', 'listing_intro',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'RcaNowPage.author'
        db.add_column(u'rca_rcanowpage', 'author',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'AlumniPage.listing_intro'
        db.delete_column(u'rca_alumnipage', 'listing_intro')

        # Deleting field 'RcaNowPage.author'
        db.delete_column(u'rca_rcanowpage', 'author')
