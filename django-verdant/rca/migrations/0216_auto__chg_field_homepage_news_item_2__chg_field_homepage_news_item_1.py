...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'HomePage.news_item_2'
        db.alter_column(u'rca_homepage', 'news_item_2_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.NewsItem']))

        # Changing field 'HomePage.news_item_1'
        db.alter_column(u'rca_homepage', 'news_item_1_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.NewsItem']))
