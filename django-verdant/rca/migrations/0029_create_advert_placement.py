...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'rca_advertplacement', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('page', self.gf('django.db.models.fields.related.ForeignKey')(related_name='advert_placements', to=orm['wagtailcore.Page'])),
            ('advert', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['rca.Advert'])),
        ))
        db.send_create_signal(u'rca', ['AdvertPlacement'])


        # Changing field 'Advert.url'
        db.alter_column(u'rca_advert', 'url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

        # Changing field 'Advert.page'
        db.alter_column(u'rca_advert', 'page_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['wagtailcore.Page']))

    def backwards(self, orm):
        # Deleting model 'AdvertPlacement'
        db.delete_table(u'rca_advertplacement')


        # Changing field 'Advert.url'
        db.alter_column(u'rca_advert', 'url', self.gf('django.db.models.fields.URLField')(default='', max_length=200))

        # Changing field 'Advert.page'
        db.alter_column(u'rca_advert', 'page_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['wagtailcore.Page']))
