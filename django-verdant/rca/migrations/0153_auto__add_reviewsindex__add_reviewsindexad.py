...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ReviewsIndex'
        db.create_table(u'rca_reviewsindex', (
        ...
        db.send_create_signal(u'rca', ['ReviewsIndex'])

        # Adding model 'ReviewsIndexAd'
        db.create_table(u'rca_reviewsindexad', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sort_order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('page', self.gf('cluster.fields.ParentalKey')(related_name='manual_adverts', to=orm['rca.ReviewsIndex'])),
            ('ad', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['rca.Advert'])),
        ))
        db.send_create_signal(u'rca', ['ReviewsIndexAd'])


    def backwards(self, orm):
        # Deleting model 'ReviewsIndex'
        db.delete_table(u'rca_reviewsindex')

        # Deleting model 'ReviewsIndexAd'
        db.delete_table(u'rca_reviewsindexad')
