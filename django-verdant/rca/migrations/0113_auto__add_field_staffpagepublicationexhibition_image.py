...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StaffPagePublicationExhibition.image'
        db.add_column(u'rca_staffpagepublicationexhibition', 'image',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['rca.RcaImage']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StaffPagePublicationExhibition.image'
        db.delete_column(u'rca_staffpagepublicationexhibition', 'image_id')
