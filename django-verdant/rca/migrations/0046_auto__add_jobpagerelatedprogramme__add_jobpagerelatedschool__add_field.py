...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'JobPageRelatedProgramme'
        db.create_table(u'rca_jobpagerelatedprogramme', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('page', self.gf('django.db.models.fields.related.ForeignKey')(related_name='related_programmes', to=orm['rca.JobPage'])),
            ('programme', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
        ))
        db.send_create_signal(u'rca', ['JobPageRelatedProgramme'])

        # Adding model 'JobPageRelatedSchool'
        db.create_table(u'rca_jobpagerelatedschool', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('page', self.gf('django.db.models.fields.related.ForeignKey')(related_name='related_schools', to=orm['rca.JobPage'])),
            ('school', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
        ))
        db.send_create_signal(u'rca', ['JobPageRelatedSchool'])

        # Adding field 'JobPage.programme'
        db.add_column(u'rca_jobpage', 'programme',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'JobPage.school'
        db.add_column(u'rca_jobpage', 'school',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'JobPage.other_department'
        db.add_column(u'rca_jobpage', 'other_department',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'JobPage.closing_date'
        db.add_column(u'rca_jobpage', 'closing_date',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 9, 30, 0, 0)),
                      keep_default=False)

        # Adding field 'JobPage.interview_date'
        db.add_column(u'rca_jobpage', 'interview_date',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 9, 30, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'JobPage.responsible_to'
        db.add_column(u'rca_jobpage', 'responsible_to',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'JobPage.required_hours'
        db.add_column(u'rca_jobpage', 'required_hours',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'JobPage.campus'
        db.add_column(u'rca_jobpage', 'campus',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'JobPage.salary'
        db.add_column(u'rca_jobpage', 'salary',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'JobPage.ref_number'
        db.add_column(u'rca_jobpage', 'ref_number',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'JobPage.grade'
        db.add_column(u'rca_jobpage', 'grade',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'JobPage.description'
        db.add_column(u'rca_jobpage', 'description',
                      self.gf('wagtail.wagtailcore.fields.RichTextField')(default=''),
                      keep_default=False)

        # Adding field 'JobPage.download_info'
        db.add_column(u'rca_jobpage', 'download_info',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['wagtaildocs.Document']),
                      keep_default=False)

        # Adding field 'JobPage.listing_intro'
        db.add_column(u'rca_jobpage', 'listing_intro',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'JobPage.show_on_homepage'
        db.add_column(u'rca_jobpage', 'show_on_homepage',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'JobPageRelatedProgramme'
        db.delete_table(u'rca_jobpagerelatedprogramme')

        # Deleting model 'JobPageRelatedSchool'
        db.delete_table(u'rca_jobpagerelatedschool')

        # Deleting field 'JobPage.programme'
        db.delete_column(u'rca_jobpage', 'programme')

        # Deleting field 'JobPage.school'
        db.delete_column(u'rca_jobpage', 'school')

        # Deleting field 'JobPage.other_department'
        db.delete_column(u'rca_jobpage', 'other_department')

        # Deleting field 'JobPage.closing_date'
        db.delete_column(u'rca_jobpage', 'closing_date')

        # Deleting field 'JobPage.interview_date'
        db.delete_column(u'rca_jobpage', 'interview_date')

        # Deleting field 'JobPage.responsible_to'
        db.delete_column(u'rca_jobpage', 'responsible_to')

        # Deleting field 'JobPage.required_hours'
        db.delete_column(u'rca_jobpage', 'required_hours')

        # Deleting field 'JobPage.campus'
        db.delete_column(u'rca_jobpage', 'campus')

        # Deleting field 'JobPage.salary'
        db.delete_column(u'rca_jobpage', 'salary')

        # Deleting field 'JobPage.ref_number'
        db.delete_column(u'rca_jobpage', 'ref_number')

        # Deleting field 'JobPage.grade'
        db.delete_column(u'rca_jobpage', 'grade')

        # Deleting field 'JobPage.description'
        db.delete_column(u'rca_jobpage', 'description')

        # Deleting field 'JobPage.download_info'
        db.delete_column(u'rca_jobpage', 'download_info_id')

        # Deleting field 'JobPage.listing_intro'
        db.delete_column(u'rca_jobpage', 'listing_intro')

        # Deleting field 'JobPage.show_on_homepage'
        db.delete_column(u'rca_jobpage', 'show_on_homepage')
    ...
    models = {
        ...
        u'rca.programmepage': {
            ...
            'head_of_programme': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'to': u"orm['wagtailcore.Page']"}),
