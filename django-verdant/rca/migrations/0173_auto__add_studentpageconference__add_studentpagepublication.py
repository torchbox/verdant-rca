...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'rca_studentpageconference', (
            ...
            ('page', self.gf('modelcluster.fields.ParentalKey')(related_name='conferences', to=orm['rca.StudentPage'])),
        ...
        db.create_table(u'rca_studentpagepublication', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sort_order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('page', self.gf('modelcluster.fields.ParentalKey')(related_name='publications', to=orm['rca.StudentPage'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
        ))
