...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'StudentPageConference'
        db.create_table(u'rca_studentpageconference', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sort_order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('page', self.gf('cluster.fields.ParentalKey')(related_name='conferences', to=orm['rca.StudentPage'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
        ))
        db.send_create_signal(u'rca', ['StudentPageConference'])

        # Adding model 'StudentPagePublication'
        db.create_table(u'rca_studentpagepublication', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sort_order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('page', self.gf('cluster.fields.ParentalKey')(related_name='publications', to=orm['rca.StudentPage'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
        ))
        db.send_create_signal(u'rca', ['StudentPagePublication'])


    def backwards(self, orm):
        # Deleting model 'StudentPageConference'
        db.delete_table(u'rca_studentpageconference')

        # Deleting model 'StudentPagePublication'
        db.delete_table(u'rca_studentpagepublication')
