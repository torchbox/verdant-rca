...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'InnovationRCAProject.feed_image'
        db.alter_column(u'rca_innovationrcaproject', 'feed_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage']))

        # Changing field 'ReachOutRCAProject.feed_image'
        db.alter_column(u'rca_reachoutrcaproject', 'feed_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage']))

        # Changing field 'InnovationRCAIndex.feed_image'
        db.alter_column(u'rca_innovationrcaindex', 'feed_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage']))

        # Changing field 'TalksIndex.feed_image'
        db.alter_column(u'rca_talksindex', 'feed_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage']))

        # Changing field 'EventItem.feed_image'
        db.alter_column(u'rca_eventitem', 'feed_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage']))

        # Changing field 'StandardPage.feed_image'
        db.alter_column(u'rca_standardpage', 'feed_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage']))

        # Changing field 'JobsIndex.feed_image'
        db.alter_column(u'rca_jobsindex', 'feed_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage']))

        # Changing field 'GalleryPage.feed_image'
        db.alter_column(u'rca_gallerypage', 'feed_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage']))

        # Changing field 'NewsIndex.feed_image'
        db.alter_column(u'rca_newsindex', 'feed_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage']))

        # Changing field 'EventIndex.feed_image'
        db.alter_column(u'rca_eventindex', 'feed_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage']))

        # Changing field 'JobPage.feed_image'
        db.alter_column(u'rca_jobpage', 'feed_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage']))

        # Changing field 'HomePage.feed_image'
        db.alter_column(u'rca_homepage', 'feed_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage']))

        # Changing field 'ResearchStudentIndex.feed_image'
        db.alter_column(u'rca_researchstudentindex', 'feed_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage']))

        # Changing field 'ContactUsPage.feed_image'
        db.alter_column(u'rca_contactuspage', 'feed_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage']))

        # Changing field 'StandardIndex.feed_image'
        db.alter_column(u'rca_standardindex', 'feed_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage']))

        # Changing field 'NewsItem.feed_image'
        db.alter_column(u'rca_newsitem', 'feed_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage']))

        # Changing field 'RcaNowPage.feed_image'
        db.alter_column(u'rca_rcanowpage', 'feed_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage']))

        # Changing field 'StaffPage.feed_image'
        db.alter_column(u'rca_staffpage', 'feed_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage']))

        # Changing field 'AlumniPage.feed_image'
        db.alter_column(u'rca_alumnipage', 'feed_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage']))

        # Changing field 'ReviewPage.feed_image'
        db.alter_column(u'rca_reviewpage', 'feed_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage']))

        # Changing field 'ResearchItem.feed_image'
        db.alter_column(u'rca_researchitem', 'feed_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage']))

        # Changing field 'AlumniIndex.feed_image'
        db.alter_column(u'rca_alumniindex', 'feed_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage']))

        # Changing field 'ReviewsIndex.feed_image'
        db.alter_column(u'rca_reviewsindex', 'feed_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage']))

        # Changing field 'DonationPage.feed_image'
        db.alter_column(u'rca_donationpage', 'feed_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage']))

        # Changing field 'PressRelease.feed_image'
        db.alter_column(u'rca_pressrelease', 'feed_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage']))

        # Changing field 'NewStudentPage.feed_image'
        db.alter_column(u'rca_newstudentpage', 'feed_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage']))

        # Changing field 'NewStudentPage.postcard_image'
        db.alter_column(u'rca_newstudentpage', 'postcard_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage']))

        # Changing field 'SchoolPage.feed_image'
        db.alter_column(u'rca_schoolpage', 'feed_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage']))

        # Changing field 'PressReleaseIndex.feed_image'
        db.alter_column(u'rca_pressreleaseindex', 'feed_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage']))

        # Changing field 'StudentPage.feed_image'
        db.alter_column(u'rca_studentpage', 'feed_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage']))

        # Changing field 'ReachOutRCAIndex.feed_image'
        db.alter_column(u'rca_reachoutrcaindex', 'feed_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage']))

        # Changing field 'ResearchInnovationPage.feed_image'
        db.alter_column(u'rca_researchinnovationpage', 'feed_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage']))

        # Changing field 'StaffIndex.feed_image'
        db.alter_column(u'rca_staffindex', 'feed_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage']))

        # Changing field 'ProgrammePage.feed_image'
        db.alter_column(u'rca_programmepage', 'feed_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage']))

        # Changing field 'RcaNowIndex.feed_image'
        db.alter_column(u'rca_rcanowindex', 'feed_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage']))

        # Changing field 'CurrentResearchPage.feed_image'
        db.alter_column(u'rca_currentresearchpage', 'feed_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage']))

    def backwards(self, orm):

        # Changing field 'InnovationRCAProject.feed_image'
        db.alter_column(u'rca_innovationrcaproject', 'feed_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rca.RcaImage']))

        # Changing field 'ReachOutRCAProject.feed_image'
        db.alter_column(u'rca_reachoutrcaproject', 'feed_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rca.RcaImage']))

        # Changing field 'InnovationRCAIndex.feed_image'
        db.alter_column(u'rca_innovationrcaindex', 'feed_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rca.RcaImage']))

        # Changing field 'TalksIndex.feed_image'
        db.alter_column(u'rca_talksindex', 'feed_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rca.RcaImage']))

        # Changing field 'EventItem.feed_image'
        db.alter_column(u'rca_eventitem', 'feed_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rca.RcaImage']))

        # Changing field 'StandardPage.feed_image'
        db.alter_column(u'rca_standardpage', 'feed_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rca.RcaImage']))

        # Changing field 'JobsIndex.feed_image'
        db.alter_column(u'rca_jobsindex', 'feed_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rca.RcaImage']))

        # Changing field 'GalleryPage.feed_image'
        db.alter_column(u'rca_gallerypage', 'feed_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rca.RcaImage']))

        # Changing field 'NewsIndex.feed_image'
        db.alter_column(u'rca_newsindex', 'feed_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rca.RcaImage']))

        # Changing field 'EventIndex.feed_image'
        db.alter_column(u'rca_eventindex', 'feed_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rca.RcaImage']))

        # Changing field 'JobPage.feed_image'
        db.alter_column(u'rca_jobpage', 'feed_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rca.RcaImage']))

        # Changing field 'HomePage.feed_image'
        db.alter_column(u'rca_homepage', 'feed_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rca.RcaImage']))

        # Changing field 'ResearchStudentIndex.feed_image'
        db.alter_column(u'rca_researchstudentindex', 'feed_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rca.RcaImage']))

        # Changing field 'ContactUsPage.feed_image'
        db.alter_column(u'rca_contactuspage', 'feed_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rca.RcaImage']))

        # Changing field 'StandardIndex.feed_image'
        db.alter_column(u'rca_standardindex', 'feed_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rca.RcaImage']))

        # Changing field 'NewsItem.feed_image'
        db.alter_column(u'rca_newsitem', 'feed_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rca.RcaImage']))

        # Changing field 'RcaNowPage.feed_image'
        db.alter_column(u'rca_rcanowpage', 'feed_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rca.RcaImage']))

        # Changing field 'StaffPage.feed_image'
        db.alter_column(u'rca_staffpage', 'feed_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rca.RcaImage']))

        # Changing field 'AlumniPage.feed_image'
        db.alter_column(u'rca_alumnipage', 'feed_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rca.RcaImage']))

        # Changing field 'ReviewPage.feed_image'
        db.alter_column(u'rca_reviewpage', 'feed_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rca.RcaImage']))

        # Changing field 'ResearchItem.feed_image'
        db.alter_column(u'rca_researchitem', 'feed_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rca.RcaImage']))

        # Changing field 'AlumniIndex.feed_image'
        db.alter_column(u'rca_alumniindex', 'feed_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rca.RcaImage']))

        # Changing field 'ReviewsIndex.feed_image'
        db.alter_column(u'rca_reviewsindex', 'feed_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rca.RcaImage']))

        # Changing field 'DonationPage.feed_image'
        db.alter_column(u'rca_donationpage', 'feed_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rca.RcaImage']))

        # Changing field 'PressRelease.feed_image'
        db.alter_column(u'rca_pressrelease', 'feed_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rca.RcaImage']))

        # Changing field 'NewStudentPage.feed_image'
        db.alter_column(u'rca_newstudentpage', 'feed_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rca.RcaImage']))

        # Changing field 'NewStudentPage.postcard_image'
        db.alter_column(u'rca_newstudentpage', 'postcard_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rca.RcaImage']))

        # Changing field 'SchoolPage.feed_image'
        db.alter_column(u'rca_schoolpage', 'feed_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rca.RcaImage']))

        # Changing field 'PressReleaseIndex.feed_image'
        db.alter_column(u'rca_pressreleaseindex', 'feed_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rca.RcaImage']))

        # Changing field 'StudentPage.feed_image'
        db.alter_column(u'rca_studentpage', 'feed_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rca.RcaImage']))

        # Changing field 'ReachOutRCAIndex.feed_image'
        db.alter_column(u'rca_reachoutrcaindex', 'feed_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rca.RcaImage']))

        # Changing field 'ResearchInnovationPage.feed_image'
        db.alter_column(u'rca_researchinnovationpage', 'feed_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rca.RcaImage']))

        # Changing field 'StaffIndex.feed_image'
        db.alter_column(u'rca_staffindex', 'feed_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rca.RcaImage']))

        # Changing field 'ProgrammePage.feed_image'
        db.alter_column(u'rca_programmepage', 'feed_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rca.RcaImage']))

        # Changing field 'RcaNowIndex.feed_image'
        db.alter_column(u'rca_rcanowindex', 'feed_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rca.RcaImage']))

        # Changing field 'CurrentResearchPage.feed_image'
        db.alter_column(u'rca_currentresearchpage', 'feed_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rca.RcaImage']))
    ...
    models = {
        ...
        u'rca.alumniindex': {
            ...
            'feed_image': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['rca.RcaImage']"}),
        ...
        u'rca.newstudentpage': {
            ...
            'innovation_rca_fellow': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            ...
            'postcard_image': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['rca.RcaImage']"}),
            'profile_image': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['rca.RcaImage']"}),
            'random_order': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'rca_content_id': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
        ...
        u'rca.staffpage': {
            ...
            'social_image': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['rca.RcaImage']"}),
            'social_text': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'staff_location': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
