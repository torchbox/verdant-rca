...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NewStudentPage.mphil_status'
        db.add_column(u'rca_newstudentpage', 'mphil_status',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'NewStudentPage.mphil_degree_type'
        db.add_column(u'rca_newstudentpage', 'mphil_degree_type',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'NewStudentPage.phd_status'
        db.add_column(u'rca_newstudentpage', 'phd_status',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'NewStudentPage.phd_degree_type'
        db.add_column(u'rca_newstudentpage', 'phd_degree_type',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NewStudentPage.mphil_status'
        db.delete_column(u'rca_newstudentpage', 'mphil_status')

        # Deleting field 'NewStudentPage.mphil_degree_type'
        db.delete_column(u'rca_newstudentpage', 'mphil_degree_type')

        # Deleting field 'NewStudentPage.phd_status'
        db.delete_column(u'rca_newstudentpage', 'phd_status')

        # Deleting field 'NewStudentPage.phd_degree_type'
        db.delete_column(u'rca_newstudentpage', 'phd_degree_type')
