...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'StudentPage.degree_year'
        db.alter_column(u'rca_studentpage', 'degree_year', self.gf('django.db.models.fields.CharField')(max_length=4))

    def backwards(self, orm):

        # Changing field 'StudentPage.degree_year'
        db.alter_column(u'rca_studentpage', 'degree_year', self.gf('django.db.models.fields.IntegerField')(max_length=255))
