...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OEFormPage.data_protection'
        db.add_column(u'rca_oeformpage', 'data_protection',
                      self.gf('wagtail.wagtailcore.fields.RichTextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OEFormPage.data_protection'
        db.delete_column(u'rca_oeformpage', 'data_protection')
