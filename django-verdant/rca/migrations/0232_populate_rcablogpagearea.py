...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for rcablogpage in orm['rca.RcaBlogPage'].objects.all():
            area_pk = None
            if rcablogpage.area:
                area, created = orm['rca.RcaBlogPageArea'].objects.get_or_create(page=rcablogpage, area=rcablogpage.area)
                area_pk = area.pk

            # Update revisions
            for revision in rcablogpage.revisions.all():
                # Decode json
