...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ReusableTextSnippet.name'
        db.add_column(u'rca_reusabletextsnippet', 'name',
                      self.gf('django.db.models.fields.CharField')(default='snippet name', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ReusableTextSnippet.name'
        db.delete_column(u'rca_reusabletextsnippet', 'name')
