...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RcaNowPageTag'
        db.create_table(u'rca_rcanowpagetag', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('tag', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'rca_rcanowpagetag_items', to=orm['taggit.Tag'])),
            ('content_object', self.gf('cluster.fields.ParentalKey')(related_name='tagged_items', to=orm['rca.RcaNowPage'])),
        ))
        db.send_create_signal(u'rca', ['RcaNowPageTag'])


    def backwards(self, orm):
        # Deleting model 'RcaNowPageTag'
        db.delete_table(u'rca_rcanowpagetag')
