...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        orm['auth.group'].objects.get_or_create(name='MA Students')
        orm['auth.group'].objects.get_or_create(name='MPhil Students')
        orm['auth.group'].objects.get_or_create(name='PhD Students')
