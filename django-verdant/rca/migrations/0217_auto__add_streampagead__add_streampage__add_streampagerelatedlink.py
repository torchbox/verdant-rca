...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'StreamPageAd'
        db.create_table(u'rca_streampagead', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sort_order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('page', self.gf('modelcluster.fields.ParentalKey')(related_name='manual_adverts', to=orm['rca.StreamPage'])),
            ('ad', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['rca.Advert'])),
        ))
        db.send_create_signal(u'rca', ['StreamPageAd'])

        # Adding model 'StreamPage'
        db.create_table(u'rca_streampage', (
        ...
        db.send_create_signal(u'rca', ['StreamPage'])

        # Adding model 'StreamPageRelatedLink'
        db.create_table(u'rca_streampagerelatedlink', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sort_order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('page', self.gf('modelcluster.fields.ParentalKey')(related_name='related_links', to=orm['rca.StreamPage'])),
        ...
        db.send_create_signal(u'rca', ['StreamPageRelatedLink'])


    def backwards(self, orm):
        # Deleting model 'StreamPageAd'
        db.delete_table(u'rca_streampagead')

        # Deleting model 'StreamPage'
        db.delete_table(u'rca_streampage')

        # Deleting model 'StreamPageRelatedLink'
        db.delete_table(u'rca_streampagerelatedlink')
