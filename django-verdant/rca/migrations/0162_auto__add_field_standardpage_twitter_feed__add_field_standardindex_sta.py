...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StandardPage.twitter_feed'
        db.add_column(u'rca_standardpage', 'twitter_feed',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'StandardIndex.staff_feed_source'
        db.add_column(u'rca_standardindex', 'staff_feed_source',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StandardPage.twitter_feed'
        db.delete_column(u'rca_standardpage', 'twitter_feed')

        # Deleting field 'StandardIndex.staff_feed_source'
        db.delete_column(u'rca_standardindex', 'staff_feed_source')
