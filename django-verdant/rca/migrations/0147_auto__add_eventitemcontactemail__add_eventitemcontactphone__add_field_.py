...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'rca_eventitemcontactemail', (
            ...
            ('page', self.gf('cluster.fields.ParentalKey')(related_name='contact_email', to=orm['rca.EventItem'])),
        ...
        db.create_table(u'rca_eventitemcontactphone', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sort_order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('page', self.gf('cluster.fields.ParentalKey')(related_name='contact_phone', to=orm['rca.EventItem'])),
