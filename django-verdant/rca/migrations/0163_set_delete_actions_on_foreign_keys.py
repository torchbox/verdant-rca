...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ResearchInnovationPageCarouselItem.image'
        db.alter_column(u'rca_researchinnovationpagecarouselitem', 'image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage']))

        # Changing field 'ResearchInnovationPageCarouselItem.poster_image'
        db.alter_column(u'rca_researchinnovationpagecarouselitem', 'poster_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage']))

        # Changing field 'AlumniIndex.social_image'
        db.alter_column(u'rca_alumniindex', 'social_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage']))

        # Changing field 'StaffPageCarouselItem.image'
        db.alter_column(u'rca_staffpagecarouselitem', 'image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage']))

        # Changing field 'StaffPageCarouselItem.poster_image'
        db.alter_column(u'rca_staffpagecarouselitem', 'poster_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage']))

        # Changing field 'StandardPage.social_image'
        db.alter_column(u'rca_standardpage', 'social_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage']))

        # Changing field 'JobsIndex.social_image'
        db.alter_column(u'rca_jobsindex', 'social_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage']))

        # Changing field 'ProgrammePageOurSites.image'
        db.alter_column(u'rca_programmepageoursites', 'image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage']))

        # Changing field 'ReviewPageCarouselItem.image'
        db.alter_column(u'rca_reviewpagecarouselitem', 'image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage']))

        # Changing field 'ReviewPageCarouselItem.poster_image'
        db.alter_column(u'rca_reviewpagecarouselitem', 'poster_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage']))

        # Changing field 'GalleryPage.social_image'
        db.alter_column(u'rca_gallerypage', 'social_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage']))

        # Changing field 'StudentPageCarouselItem.image'
        db.alter_column(u'rca_studentpagecarouselitem', 'image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage']))

        # Changing field 'StudentPageCarouselItem.poster_image'
        db.alter_column(u'rca_studentpagecarouselitem', 'poster_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage']))

        # Changing field 'RcaNowPagePageCarouselItem.image'
        db.alter_column(u'rca_rcanowpagepagecarouselitem', 'image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage']))

        # Changing field 'RcaNowPagePageCarouselItem.poster_image'
        db.alter_column(u'rca_rcanowpagepagecarouselitem', 'poster_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage']))

        # Changing field 'NewsIndex.social_image'
        db.alter_column(u'rca_newsindex', 'social_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage']))

        # Changing field 'CustomContentModuleBlock.image'
        db.alter_column(u'rca_customcontentmoduleblock', 'image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage']))

        # Changing field 'CustomContentModuleBlock.link'
        db.alter_column(u'rca_customcontentmoduleblock', 'link_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['wagtailcore.Page']))

        # Changing field 'StaffPagePublicationExhibition.image'
        db.alter_column(u'rca_staffpagepublicationexhibition', 'image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage']))

        # Changing field 'JobPage.social_image'
        db.alter_column(u'rca_jobpage', 'social_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage']))

        # Changing field 'JobPage.download_info'
        db.alter_column(u'rca_jobpage', 'download_info_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['verdantdocs.Document']))

        # Changing field 'ResearchInnovationPage.background_image'
        db.alter_column(u'rca_researchinnovationpage', 'background_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage']))

        # Changing field 'ResearchInnovationPage.intro_link'
        db.alter_column(u'rca_researchinnovationpage', 'intro_link_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['wagtailcore.Page']))

        # Changing field 'ResearchInnovationPage.social_image'
        db.alter_column(u'rca_researchinnovationpage', 'social_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage']))

        # Changing field 'HomePage.news_item_2'
        db.alter_column(u'rca_homepage', 'news_item_2_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['wagtailcore.Page']))

        # Changing field 'HomePage.background_image'
        db.alter_column(u'rca_homepage', 'background_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage']))

        # Changing field 'HomePage.social_image'
        db.alter_column(u'rca_homepage', 'social_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage']))

        # Changing field 'HomePage.news_item_1'
        db.alter_column(u'rca_homepage', 'news_item_1_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['wagtailcore.Page']))

        # Changing field 'ContactUsPage.social_image'
        db.alter_column(u'rca_contactuspage', 'social_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage']))

        # Changing field 'StandardIndex.background_image'
        db.alter_column(u'rca_standardindex', 'background_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage']))

        # Changing field 'StandardIndex.intro_link'
        db.alter_column(u'rca_standardindex', 'intro_link_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['wagtailcore.Page']))

        # Changing field 'StandardIndex.social_image'
        db.alter_column(u'rca_standardindex', 'social_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage']))

        # Changing field 'HomePageCarouselItem.image'
        db.alter_column(u'rca_homepagecarouselitem', 'image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage']))

        # Changing field 'HomePageCarouselItem.poster_image'
        db.alter_column(u'rca_homepagecarouselitem', 'poster_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage']))

        # Changing field 'AlumniPage.social_image'
        db.alter_column(u'rca_alumnipage', 'social_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage']))

        # Changing field 'AlumniPage.profile_image'
        db.alter_column(u'rca_alumnipage', 'profile_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage']))

        # Changing field 'StandardIndexTeaser.image'
        db.alter_column(u'rca_standardindexteaser', 'image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage']))

        # Changing field 'StandardIndexTeaser.link'
        db.alter_column(u'rca_standardindexteaser', 'link_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['wagtailcore.Page']))

        # Changing field 'NewsItem.social_image'
        db.alter_column(u'rca_newsitem', 'social_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage']))

        # Changing field 'SchoolPageCarouselItem.image'
        db.alter_column(u'rca_schoolpagecarouselitem', 'image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage']))

        # Changing field 'SchoolPageCarouselItem.poster_image'
        db.alter_column(u'rca_schoolpagecarouselitem', 'poster_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage']))

        # Changing field 'NewsItemCarouselItem.image'
        db.alter_column(u'rca_newsitemcarouselitem', 'image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage']))

        # Changing field 'NewsItemCarouselItem.poster_image'
        db.alter_column(u'rca_newsitemcarouselitem', 'poster_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage']))

        # Changing field 'RcaNowPage.social_image'
        db.alter_column(u'rca_rcanowpage', 'social_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage']))

        # Changing field 'StaffPage.profile_image'
        db.alter_column(u'rca_staffpage', 'profile_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage']))

        # Changing field 'StaffPage.social_image'
        db.alter_column(u'rca_staffpage', 'social_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage']))

        # Changing field 'EventItemSpeaker.image'
        db.alter_column(u'rca_eventitemspeaker', 'image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage']))

        # Changing field 'StandardPageCarouselItem.image'
        db.alter_column(u'rca_standardpagecarouselitem', 'image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage']))

        # Changing field 'StandardPageCarouselItem.poster_image'
        db.alter_column(u'rca_standardpagecarouselitem', 'poster_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage']))

        # Changing field 'ResearchItem.social_image'
        db.alter_column(u'rca_researchitem', 'social_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage']))

        # Changing field 'ReviewPage.social_image'
        db.alter_column(u'rca_reviewpage', 'social_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage']))

        # Changing field 'ProgrammePageStudentStory.image'
        db.alter_column(u'rca_programmepagestudentstory', 'image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage']))

        # Changing field 'ProgrammePageStudentStory.link'
        db.alter_column(u'rca_programmepagestudentstory', 'link_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['wagtailcore.Page']))

        # Changing field 'EventIndex.social_image'
        db.alter_column(u'rca_eventindex', 'social_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage']))

        # Changing field 'TalksIndex.social_image'
        db.alter_column(u'rca_talksindex', 'social_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage']))

        # Changing field 'ResearchInnovationPageTeaser.image'
        db.alter_column(u'rca_researchinnovationpageteaser', 'image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage']))

        # Changing field 'DonationPage.social_image'
        db.alter_column(u'rca_donationpage', 'social_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage']))

        # Changing field 'DonationPage.redirect_to_when_done'
        db.alter_column(u'rca_donationpage', 'redirect_to_when_done_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.PROTECT, to=orm['wagtailcore.Page']))

        # Changing field 'PressRelease.social_image'
        db.alter_column(u'rca_pressrelease', 'social_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage']))

        # Changing field 'SchoolPage.background_image'
        db.alter_column(u'rca_schoolpage', 'background_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage']))

        # Changing field 'SchoolPage.head_of_school'
        db.alter_column(u'rca_schoolpage', 'head_of_school_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.StaffPage']))

        # Changing field 'SchoolPage.head_of_school_link'
        db.alter_column(u'rca_schoolpage', 'head_of_school_link_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['wagtailcore.Page']))

        # Changing field 'SchoolPage.head_of_research_link'
        db.alter_column(u'rca_schoolpage', 'head_of_research_link_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['wagtailcore.Page']))

        # Changing field 'SchoolPage.head_of_research'
        db.alter_column(u'rca_schoolpage', 'head_of_research_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.StaffPage']))

        # Changing field 'SchoolPage.social_image'
        db.alter_column(u'rca_schoolpage', 'social_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage']))

        # Changing field 'PressReleaseIndex.social_image'
        db.alter_column(u'rca_pressreleaseindex', 'social_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage']))

        # Changing field 'PressReleaseCarouselItem.image'
        db.alter_column(u'rca_pressreleasecarouselitem', 'image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage']))

        # Changing field 'PressReleaseCarouselItem.poster_image'
        db.alter_column(u'rca_pressreleasecarouselitem', 'poster_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage']))

        # Changing field 'EventItemCarouselItem.image'
        db.alter_column(u'rca_eventitemcarouselitem', 'image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage']))

        # Changing field 'EventItemCarouselItem.poster_image'
        db.alter_column(u'rca_eventitemcarouselitem', 'poster_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage']))

        # Changing field 'StudentPage.supervisor'
        db.alter_column(u'rca_studentpage', 'supervisor_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.StaffPage']))

        # Changing field 'StudentPage.profile_image'
        db.alter_column(u'rca_studentpage', 'profile_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage']))

        # Changing field 'StudentPage.social_image'
        db.alter_column(u'rca_studentpage', 'social_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage']))

        # Changing field 'EventItem.social_image'
        db.alter_column(u'rca_eventitem', 'social_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage']))

        # Changing field 'ReviewsIndex.social_image'
        db.alter_column(u'rca_reviewsindex', 'social_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage']))

        # Changing field 'StandardIndexOurSites.image'
        db.alter_column(u'rca_standardindexoursites', 'image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage']))

        # Changing field 'ResearchItemCarouselItem.image'
        db.alter_column(u'rca_researchitemcarouselitem', 'image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage']))

        # Changing field 'ResearchItemCarouselItem.poster_image'
        db.alter_column(u'rca_researchitemcarouselitem', 'poster_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage']))

        # Changing field 'StandardIndexCarouselItem.image'
        db.alter_column(u'rca_standardindexcarouselitem', 'image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage']))

        # Changing field 'StandardIndexCarouselItem.poster_image'
        db.alter_column(u'rca_standardindexcarouselitem', 'poster_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage']))

        # Changing field 'ResearchStudentIndex.social_image'
        db.alter_column(u'rca_researchstudentindex', 'social_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage']))

        # Changing field 'StaffIndex.social_image'
        db.alter_column(u'rca_staffindex', 'social_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage']))

        # Changing field 'ProgrammePage.head_of_programme'
        db.alter_column(u'rca_programmepage', 'head_of_programme_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.StaffPage']))

        # Changing field 'ProgrammePage.background_image'
        db.alter_column(u'rca_programmepage', 'background_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage']))

        # Changing field 'ProgrammePage.social_image'
        db.alter_column(u'rca_programmepage', 'social_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage']))

        # Changing field 'ProgrammePage.head_of_programme_link'
        db.alter_column(u'rca_programmepage', 'head_of_programme_link_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['wagtailcore.Page']))

        # Changing field 'ProgrammePage.facilities_image'
        db.alter_column(u'rca_programmepage', 'facilities_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage']))

        # Changing field 'ProgrammePage.facilities_link'
        db.alter_column(u'rca_programmepage', 'facilities_link_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['wagtailcore.Page']))

        # Changing field 'ProgrammePage.programme_video_poster_image'
        db.alter_column(u'rca_programmepage', 'programme_video_poster_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage']))

        # Changing field 'RcaNowIndex.social_image'
        db.alter_column(u'rca_rcanowindex', 'social_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage']))

        # Changing field 'CurrentResearchPage.social_image'
        db.alter_column(u'rca_currentresearchpage', 'social_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage']))

    def backwards(self, orm):

        # Changing field 'ResearchInnovationPageCarouselItem.image'
        db.alter_column(u'rca_researchinnovationpagecarouselitem', 'image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rca.RcaImage']))

        # Changing field 'ResearchInnovationPageCarouselItem.poster_image'
        db.alter_column(u'rca_researchinnovationpagecarouselitem', 'poster_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rca.RcaImage']))

        # Changing field 'AlumniIndex.social_image'
        db.alter_column(u'rca_alumniindex', 'social_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rca.RcaImage']))

        # Changing field 'StaffPageCarouselItem.image'
        db.alter_column(u'rca_staffpagecarouselitem', 'image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rca.RcaImage']))

        # Changing field 'StaffPageCarouselItem.poster_image'
        db.alter_column(u'rca_staffpagecarouselitem', 'poster_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rca.RcaImage']))
        ...
        # Changing field 'ReviewPageCarouselItem.image'
        db.alter_column(u'rca_reviewpagecarouselitem', 'image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rca.RcaImage']))

        # Changing field 'ReviewPageCarouselItem.poster_image'
        db.alter_column(u'rca_reviewpagecarouselitem', 'poster_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rca.RcaImage']))
        ...
        # Changing field 'StudentPageCarouselItem.image'
        db.alter_column(u'rca_studentpagecarouselitem', 'image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rca.RcaImage']))

        # Changing field 'StudentPageCarouselItem.poster_image'
        db.alter_column(u'rca_studentpagecarouselitem', 'poster_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rca.RcaImage']))

        # Changing field 'RcaNowPagePageCarouselItem.image'
        db.alter_column(u'rca_rcanowpagepagecarouselitem', 'image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rca.RcaImage']))

        # Changing field 'RcaNowPagePageCarouselItem.poster_image'
        db.alter_column(u'rca_rcanowpagepagecarouselitem', 'poster_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rca.RcaImage']))

        # Changing field 'NewsIndex.social_image'
        db.alter_column(u'rca_newsindex', 'social_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rca.RcaImage']))

        # Changing field 'CustomContentModuleBlock.image'
        db.alter_column(u'rca_customcontentmoduleblock', 'image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rca.RcaImage']))

        # Changing field 'CustomContentModuleBlock.link'
        db.alter_column(u'rca_customcontentmoduleblock', 'link_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['wagtailcore.Page']))

        # Changing field 'StaffPagePublicationExhibition.image'
        db.alter_column(u'rca_staffpagepublicationexhibition', 'image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rca.RcaImage']))
        ...
        # Changing field 'JobPage.download_info'
        db.alter_column(u'rca_jobpage', 'download_info_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['verdantdocs.Document']))

        # Changing field 'ResearchInnovationPage.background_image'
        db.alter_column(u'rca_researchinnovationpage', 'background_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rca.RcaImage']))

        # Changing field 'ResearchInnovationPage.intro_link'
        db.alter_column(u'rca_researchinnovationpage', 'intro_link_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['wagtailcore.Page']))
        ...
        # Changing field 'HomePage.news_item_2'
        db.alter_column(u'rca_homepage', 'news_item_2_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['wagtailcore.Page']))

        # Changing field 'HomePage.background_image'
        db.alter_column(u'rca_homepage', 'background_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rca.RcaImage']))
        ...
        # Changing field 'HomePage.news_item_1'
        db.alter_column(u'rca_homepage', 'news_item_1_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['wagtailcore.Page']))
        ...
        # Changing field 'StandardIndex.background_image'
        db.alter_column(u'rca_standardindex', 'background_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rca.RcaImage']))

        # Changing field 'StandardIndex.intro_link'
        db.alter_column(u'rca_standardindex', 'intro_link_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['wagtailcore.Page']))
        ...
        # Changing field 'HomePageCarouselItem.image'
        db.alter_column(u'rca_homepagecarouselitem', 'image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rca.RcaImage']))

        # Changing field 'HomePageCarouselItem.poster_image'
        db.alter_column(u'rca_homepagecarouselitem', 'poster_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rca.RcaImage']))

        # Changing field 'AlumniPage.social_image'
        db.alter_column(u'rca_alumnipage', 'social_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rca.RcaImage']))

        # Changing field 'AlumniPage.profile_image'
        db.alter_column(u'rca_alumnipage', 'profile_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rca.RcaImage']))

        # Changing field 'StandardIndexTeaser.image'
        db.alter_column(u'rca_standardindexteaser', 'image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rca.RcaImage']))

        # Changing field 'StandardIndexTeaser.link'
        db.alter_column(u'rca_standardindexteaser', 'link_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['wagtailcore.Page']))
        ...
        # Changing field 'SchoolPageCarouselItem.image'
        db.alter_column(u'rca_schoolpagecarouselitem', 'image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rca.RcaImage']))

        # Changing field 'SchoolPageCarouselItem.poster_image'
        db.alter_column(u'rca_schoolpagecarouselitem', 'poster_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rca.RcaImage']))
        ...
        # Changing field 'StaffPage.profile_image'
        db.alter_column(u'rca_staffpage', 'profile_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rca.RcaImage']))
        ...
        # Changing field 'ReviewPage.social_image'
        db.alter_column(u'rca_reviewpage', 'social_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rca.RcaImage']))
        ...
        # Changing field 'ProgrammePageStudentStory.link'
        db.alter_column(u'rca_programmepagestudentstory', 'link_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['wagtailcore.Page']))

        # Changing field 'EventIndex.social_image'
        db.alter_column(u'rca_eventindex', 'social_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rca.RcaImage']))

        # Changing field 'TalksIndex.social_image'
        db.alter_column(u'rca_talksindex', 'social_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rca.RcaImage']))

        # Changing field 'ResearchInnovationPageTeaser.image'
        db.alter_column(u'rca_researchinnovationpageteaser', 'image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rca.RcaImage']))

        # Changing field 'DonationPage.social_image'
        db.alter_column(u'rca_donationpage', 'social_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rca.RcaImage']))

        # Changing field 'DonationPage.redirect_to_when_done'
        db.alter_column(u'rca_donationpage', 'redirect_to_when_done_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['wagtailcore.Page']))

        # Changing field 'PressRelease.social_image'
        db.alter_column(u'rca_pressrelease', 'social_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rca.RcaImage']))

        # Changing field 'SchoolPage.background_image'
        db.alter_column(u'rca_schoolpage', 'background_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rca.RcaImage']))

        # Changing field 'SchoolPage.head_of_school'
        db.alter_column(u'rca_schoolpage', 'head_of_school_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rca.StaffPage']))

        # Changing field 'SchoolPage.head_of_school_link'
        db.alter_column(u'rca_schoolpage', 'head_of_school_link_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['wagtailcore.Page']))

        # Changing field 'SchoolPage.head_of_research_link'
        db.alter_column(u'rca_schoolpage', 'head_of_research_link_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['wagtailcore.Page']))

        # Changing field 'SchoolPage.head_of_research'
        db.alter_column(u'rca_schoolpage', 'head_of_research_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rca.StaffPage']))

        # Changing field 'SchoolPage.social_image'
        db.alter_column(u'rca_schoolpage', 'social_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rca.RcaImage']))

        # Changing field 'PressReleaseIndex.social_image'
        db.alter_column(u'rca_pressreleaseindex', 'social_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rca.RcaImage']))

        # Changing field 'PressReleaseCarouselItem.image'
        db.alter_column(u'rca_pressreleasecarouselitem', 'image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rca.RcaImage']))

        # Changing field 'PressReleaseCarouselItem.poster_image'
        db.alter_column(u'rca_pressreleasecarouselitem', 'poster_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rca.RcaImage']))
        ...
        # Changing field 'EventItemCarouselItem.poster_image'
        db.alter_column(u'rca_eventitemcarouselitem', 'poster_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rca.RcaImage']))

        # Changing field 'StudentPage.supervisor'
        db.alter_column(u'rca_studentpage', 'supervisor_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rca.StaffPage']))
        ...
        # Changing field 'ReviewsIndex.social_image'
        db.alter_column(u'rca_reviewsindex', 'social_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rca.RcaImage']))

        # Changing field 'StandardIndexOurSites.image'
        db.alter_column(u'rca_standardindexoursites', 'image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rca.RcaImage']))

        # Changing field 'ResearchItemCarouselItem.image'
        db.alter_column(u'rca_researchitemcarouselitem', 'image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rca.RcaImage']))

        # Changing field 'ResearchItemCarouselItem.poster_image'
        db.alter_column(u'rca_researchitemcarouselitem', 'poster_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rca.RcaImage']))

        # Changing field 'StandardIndexCarouselItem.image'
        db.alter_column(u'rca_standardindexcarouselitem', 'image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rca.RcaImage']))

        # Changing field 'StandardIndexCarouselItem.poster_image'
        db.alter_column(u'rca_standardindexcarouselitem', 'poster_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rca.RcaImage']))

        # Changing field 'ResearchStudentIndex.social_image'
        db.alter_column(u'rca_researchstudentindex', 'social_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rca.RcaImage']))

        # Changing field 'StaffIndex.social_image'
        db.alter_column(u'rca_staffindex', 'social_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rca.RcaImage']))

        # Changing field 'ProgrammePage.head_of_programme'
        db.alter_column(u'rca_programmepage', 'head_of_programme_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rca.StaffPage']))

        # Changing field 'ProgrammePage.background_image'
        db.alter_column(u'rca_programmepage', 'background_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rca.RcaImage']))

        # Changing field 'ProgrammePage.social_image'
        db.alter_column(u'rca_programmepage', 'social_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rca.RcaImage']))

        # Changing field 'ProgrammePage.head_of_programme_link'
        db.alter_column(u'rca_programmepage', 'head_of_programme_link_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['wagtailcore.Page']))

        # Changing field 'ProgrammePage.facilities_image'
        db.alter_column(u'rca_programmepage', 'facilities_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rca.RcaImage']))

        # Changing field 'ProgrammePage.facilities_link'
        db.alter_column(u'rca_programmepage', 'facilities_link_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['wagtailcore.Page']))

        # Changing field 'ProgrammePage.programme_video_poster_image'
        db.alter_column(u'rca_programmepage', 'programme_video_poster_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rca.RcaImage']))
    ...
    models = {
        ...
        u'rca.contactsnippetplacement': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'page': ('cluster.fields.ParentalKey', [], {'related_name': "'contact_snippet_placements'", 'to': u"orm['wagtailcore.Page']"})
        },
        u'rca.contactuspage': {
        ...
        u'rca.homepage': {
            ...
            'news_item_1': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['wagtailcore.Page']"}),
            'news_item_2': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['wagtailcore.Page']"}),
        ...
        u'rca.reusabletextsnippetplacement': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'page': ('cluster.fields.ParentalKey', [], {'related_name': "'reusable_text_snippet_placements'", 'to': u"orm['wagtailcore.Page']"}),
            'reusable_text_snippet': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'to': u"orm['rca.ReusableTextSnippet']"})
        },
        u'rca.reviewpage': {
