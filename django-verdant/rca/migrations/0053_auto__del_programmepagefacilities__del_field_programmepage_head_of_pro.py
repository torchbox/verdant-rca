...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ProgrammePage.head_of_programme_statement'
        db.delete_column(u'rca_programmepage', 'head_of_programme_statement')

        # Adding field 'ProgrammePage.head_of_programme_link'
        db.add_column(u'rca_programmepage', 'head_of_programme_link',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['wagtailcore.Page']),
                      keep_default=False)

        # Adding field 'ProgrammePage.facilities_text'
        db.add_column(u'rca_programmepage', 'facilities_text',
                      self.gf('wagtail.wagtailcore.fields.RichTextField')(default=''),
                      keep_default=False)

        # Adding field 'ProgrammePage.facilities_image'
        db.add_column(u'rca_programmepage', 'facilities_image',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['rca.RcaImage']),
                      keep_default=False)

        # Adding field 'ProgrammePage.facilities_link'
        db.add_column(u'rca_programmepage', 'facilities_link',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['wagtailcore.Page']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'rca_programmepagefacilities', (
            ...
            ('link', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['wagtailcore.Page'], blank=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'rca', ['ProgrammePageFacilities'])


        # User chose to not deal with backwards NULL issues for 'ProgrammePage.head_of_programme_statement'
        raise RuntimeError("Cannot reverse this migration. 'ProgrammePage.head_of_programme_statement' and its values cannot be restored.")
        # Deleting field 'ProgrammePage.head_of_programme_link'
        db.delete_column(u'rca_programmepage', 'head_of_programme_link_id')

        # Deleting field 'ProgrammePage.facilities_text'
        db.delete_column(u'rca_programmepage', 'facilities_text')

        # Deleting field 'ProgrammePage.facilities_image'
        db.delete_column(u'rca_programmepage', 'facilities_image_id')

        # Deleting field 'ProgrammePage.facilities_link'
        db.delete_column(u'rca_programmepage', 'facilities_link_id')
    ...
    models = {
        ...
        u'rca.programmepage': {
            ...
            'facilities_text': ('wagtail.wagtailcore.fields.RichTextField', [], {}),
            ...
            'open_day': ('django.db.models.fields.DateField', [], {'blank': 'True'}),
            'open_day_link': ('django.db.models.fields.URLField', [], {'max_length': '255', 'blank': 'True'}),
            u'page_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['wagtailcore.Page']", 'unique': 'True', 'primary_key': 'True'}),
