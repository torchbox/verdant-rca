...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ResearchItem.subtitle'
        db.add_column(u'rca_researchitem', 'subtitle',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ResearchItem.subtitle'
        db.delete_column(u'rca_researchitem', 'subtitle')
