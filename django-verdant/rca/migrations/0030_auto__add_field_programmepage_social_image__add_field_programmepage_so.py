...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProgrammePage.social_image'
        db.add_column(u'rca_programmepage', 'social_image',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['rca.RcaImage']),
                      keep_default=False)

        # Adding field 'ProgrammePage.social_text'
        db.add_column(u'rca_programmepage', 'social_text',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProgrammePage.social_image'
        db.delete_column(u'rca_programmepage', 'social_image_id')

        # Deleting field 'ProgrammePage.social_text'
        db.delete_column(u'rca_programmepage', 'social_text')
