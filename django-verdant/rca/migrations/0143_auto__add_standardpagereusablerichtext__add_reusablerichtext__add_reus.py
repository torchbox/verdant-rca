...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        u'rca.reusablerichtext': {
            'Meta': {'object_name': 'ReusableRichText'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'text': ('wagtail.wagtailcore.fields.RichTextField', [], {})
        },
        u'rca.reusablerichtextplacement': {
            'Meta': {'object_name': 'ReusableRichTextPlacement'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'page': ('modelcluster.fields.ParentalKey', [], {'related_name': "'reusable_rich_text_placements'", 'to': u"orm['wagtailcore.Page']"}),
            'reusable_rich_text': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'to': u"orm['rca.ReusableRichText']"})
        },
        u'rca.reviewpage': {
        ...
        u'rca.standardpagereusablerichtext': {
            'Meta': {'ordering': "['sort_order']", 'object_name': 'StandardPageReusableRichText'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'page': ('modelcluster.fields.ParentalKey', [], {'related_name': "'reusable_rich_texts'", 'to': u"orm['rca.StandardPage']"}),
            'reusable_rich_text': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'to': u"orm['rca.ReusableRichText']"}),
            'sort_order': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'})
        },
        u'rca.studentpage': {
