...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'StudentPageSupervisor.name'
        db.delete_column(u'rca_studentpagesupervisor', 'name')

        # Adding field 'StudentPageSupervisor.supervisor'
        db.add_column(u'rca_studentpagesupervisor', 'supervisor',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['rca.StaffPage']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'StudentPageSupervisor.name'
        db.add_column(u'rca_studentpagesupervisor', 'name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Deleting field 'StudentPageSupervisor.supervisor'
        db.delete_column(u'rca_studentpagesupervisor', 'supervisor_id')
