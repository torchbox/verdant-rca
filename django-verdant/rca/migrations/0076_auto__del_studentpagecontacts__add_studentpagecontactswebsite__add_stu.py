...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'StudentPageContactsWebsite'
        db.create_table(u'rca_studentpagecontactswebsite', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('page', self.gf('django.db.models.fields.related.ForeignKey')(related_name='website', to=orm['rca.StudentPage'])),
            ('website', self.gf('django.db.models.fields.EmailField')(max_length=255, blank=True)),
        ))
        db.send_create_signal(u'rca', ['StudentPageContactsWebsite'])

        # Adding model 'StudentPageContactsPhone'
        db.create_table(u'rca_studentpagecontactsphone', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('page', self.gf('django.db.models.fields.related.ForeignKey')(related_name='phone', to=orm['rca.StudentPage'])),
            ('phone', self.gf('django.db.models.fields.EmailField')(max_length=255, blank=True)),
        ))
        db.send_create_signal(u'rca', ['StudentPageContactsPhone'])

        # Adding model 'StudentPageContactsEmail'
        db.create_table(u'rca_studentpagecontactsemail', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('page', self.gf('django.db.models.fields.related.ForeignKey')(related_name='email', to=orm['rca.StudentPage'])),
            ('email', self.gf('django.db.models.fields.EmailField')(max_length=255, blank=True)),
        ))
        db.send_create_signal(u'rca', ['StudentPageContactsEmail'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'StudentPageContactsWebsite'
        db.delete_table(u'rca_studentpagecontactswebsite')

        # Deleting model 'StudentPageContactsPhone'
        db.delete_table(u'rca_studentpagecontactsphone')

        # Deleting model 'StudentPageContactsEmail'
        db.delete_table(u'rca_studentpagecontactsemail')
    ...
    models = {
        ...
        u'rca.studentpagecontactsphone': {
            ...
            'phone': ('django.db.models.fields.EmailField', [], {'max_length': '255', 'blank': 'True'})
        },
        u'rca.studentpagecontactswebsite': {
            ...
            'website': ('django.db.models.fields.EmailField', [], {'max_length': '255', 'blank': 'True'})
        },
