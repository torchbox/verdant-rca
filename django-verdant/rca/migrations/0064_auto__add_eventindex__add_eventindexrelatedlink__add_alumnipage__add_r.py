...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EventIndex'
        db.create_table(u'rca_eventindex', (
            (u'page_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['wagtailcore.Page'], unique=True, primary_key=True)),
            ('social_image', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['rca.RcaImage'])),
        ...
        db.send_create_signal(u'rca', ['EventIndex'])

        # Adding model 'EventIndexRelatedLink'
        db.create_table(u'rca_eventindexrelatedlink', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('page', self.gf('django.db.models.fields.related.ForeignKey')(related_name='related_links', to=orm['rca.EventIndex'])),
        ...
        db.send_create_signal(u'rca', ['EventIndexRelatedLink'])

        # Adding model 'AlumniPage'
        db.create_table(u'rca_alumnipage', (
            (u'page_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['wagtailcore.Page'], unique=True, primary_key=True)),
            ('social_image', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['rca.RcaImage'])),
            ('social_text', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('seo_title', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
        ...
        db.send_create_signal(u'rca', ['AlumniPage'])

        # Adding model 'RcaNowIndexRelatedLink'
        db.create_table(u'rca_rcanowindexrelatedlink', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('page', self.gf('django.db.models.fields.related.ForeignKey')(related_name='related_links', to=orm['rca.RcaNowIndex'])),
            ('link', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['wagtailcore.Page'])),
            ('link_text', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'rca', ['RcaNowIndexRelatedLink'])

        # Adding model 'JobsIndexRelatedLink'
        db.create_table(u'rca_jobsindexrelatedlink', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('page', self.gf('django.db.models.fields.related.ForeignKey')(related_name='related_links', to=orm['rca.JobsIndex'])),
            ('link', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['wagtailcore.Page'])),
            ('link_text', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'rca', ['JobsIndexRelatedLink'])

        # Adding field 'NewsIndex.social_image'
        db.add_column(u'rca_newsindex', 'social_image',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['rca.RcaImage']),
                      keep_default=False)

        # Adding field 'NewsIndex.social_text'
        db.add_column(u'rca_newsindex', 'social_text',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'NewsIndex.intro'
        db.add_column(u'rca_newsindex', 'intro',
                      self.gf('wagtail.wagtailcore.fields.RichTextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'NewsIndex.twitter_feed'
        db.add_column(u'rca_newsindex', 'twitter_feed',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'HomePage.news_item_1'
        db.add_column(u'rca_homepage', 'news_item_1',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['wagtailcore.Page']),
                      keep_default=False)

        # Adding field 'HomePage.news_item_2'
        db.add_column(u'rca_homepage', 'news_item_2',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['wagtailcore.Page']),
                      keep_default=False)

        # Adding field 'JobsIndex.intro'
        db.add_column(u'rca_jobsindex', 'intro',
                      self.gf('wagtail.wagtailcore.fields.RichTextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'JobsIndex.twitter_feed'
        db.add_column(u'rca_jobsindex', 'twitter_feed',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'RcaNowIndex.intro'
        db.add_column(u'rca_rcanowindex', 'intro',
                      self.gf('wagtail.wagtailcore.fields.RichTextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'RcaNowIndex.twitter_feed'
        db.add_column(u'rca_rcanowindex', 'twitter_feed',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'ProgrammePage.download_document_url'
        db.add_column(u'rca_programmepage', 'download_document_url',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'ProgrammePage.download_document_text'
        db.add_column(u'rca_programmepage', 'download_document_text',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'EventIndex'
        db.delete_table(u'rca_eventindex')

        # Deleting model 'EventIndexRelatedLink'
        db.delete_table(u'rca_eventindexrelatedlink')

        # Deleting model 'AlumniPage'
        db.delete_table(u'rca_alumnipage')

        # Deleting model 'RcaNowIndexRelatedLink'
        db.delete_table(u'rca_rcanowindexrelatedlink')

        # Deleting model 'JobsIndexRelatedLink'
        db.delete_table(u'rca_jobsindexrelatedlink')

        # Deleting field 'NewsIndex.social_image'
        db.delete_column(u'rca_newsindex', 'social_image_id')

        # Deleting field 'NewsIndex.social_text'
        db.delete_column(u'rca_newsindex', 'social_text')

        # Deleting field 'NewsIndex.intro'
        db.delete_column(u'rca_newsindex', 'intro')

        # Deleting field 'NewsIndex.twitter_feed'
        db.delete_column(u'rca_newsindex', 'twitter_feed')

        # Deleting field 'HomePage.news_item_1'
        db.delete_column(u'rca_homepage', 'news_item_1_id')

        # Deleting field 'HomePage.news_item_2'
        db.delete_column(u'rca_homepage', 'news_item_2_id')

        # Deleting field 'JobsIndex.intro'
        db.delete_column(u'rca_jobsindex', 'intro')

        # Deleting field 'JobsIndex.twitter_feed'
        db.delete_column(u'rca_jobsindex', 'twitter_feed')

        # Deleting field 'RcaNowIndex.intro'
        db.delete_column(u'rca_rcanowindex', 'intro')

        # Deleting field 'RcaNowIndex.twitter_feed'
        db.delete_column(u'rca_rcanowindex', 'twitter_feed')

        # Deleting field 'ProgrammePage.download_document_url'
        db.delete_column(u'rca_programmepage', 'download_document_url')

        # Deleting field 'ProgrammePage.download_document_text'
        db.delete_column(u'rca_programmepage', 'download_document_text')
