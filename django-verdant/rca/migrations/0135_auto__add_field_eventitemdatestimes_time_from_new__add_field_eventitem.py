...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EventItemDatesTimes.time_from_new'
        db.add_column(u'rca_eventitemdatestimes', 'time_from_new',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'EventItemDatesTimes.time_to_new'
        db.add_column(u'rca_eventitemdatestimes', 'time_to_new',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EventItemDatesTimes.time_from_new'
        db.delete_column(u'rca_eventitemdatestimes', 'time_from_new')

        # Deleting field 'EventItemDatesTimes.time_to_new'
        db.delete_column(u'rca_eventitemdatestimes', 'time_to_new')
