...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SchoolPageRelatedLink'
        db.create_table(u'rca_schoolpagerelatedlink', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('page', self.gf('django.db.models.fields.related.ForeignKey')(related_name='related_links', to=orm['rca.SchoolPage'])),
        ...
        db.send_create_signal(u'rca', ['SchoolPageRelatedLink'])

        # Adding model 'SchoolPageContactTelEmail'
        db.create_table(u'rca_schoolpagecontacttelemail', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('page', self.gf('django.db.models.fields.related.ForeignKey')(related_name='contact_tel_email', to=orm['rca.SchoolPage'])),
        ...
        db.send_create_signal(u'rca', ['SchoolPageContactTelEmail'])

        # Adding model 'SchoolPageCarouselItem'
        db.create_table(u'rca_schoolpagecarouselitem', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('page', self.gf('django.db.models.fields.related.ForeignKey')(related_name='carousel_items', to=orm['rca.SchoolPage'])),
        ))
        db.send_create_signal(u'rca', ['SchoolPageCarouselItem'])

        # Adding field 'SchoolPage.social_image'
        db.add_column(u'rca_schoolpage', 'social_image',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['rca.RcaImage']),
                      keep_default=False)

        # Adding field 'SchoolPage.social_text'
        db.add_column(u'rca_schoolpage', 'social_text',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'SchoolPage.background_image'
        db.add_column(u'rca_schoolpage', 'background_image',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['rca.RcaImage']),
                      keep_default=False)

        # Adding field 'SchoolPage.head_of_school'
        db.add_column(u'rca_schoolpage', 'head_of_school',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['rca.StaffPage']),
                      keep_default=False)

        # Adding field 'SchoolPage.head_of_school_statement'
        db.add_column(u'rca_schoolpage', 'head_of_school_statement',
                      self.gf('wagtail.wagtailcore.fields.RichTextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'SchoolPage.head_of_school_link'
        db.add_column(u'rca_schoolpage', 'head_of_school_link',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['wagtailcore.Page']),
                      keep_default=False)

        # Adding field 'SchoolPage.twitter_feed'
        db.add_column(u'rca_schoolpage', 'twitter_feed',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'SchoolPage.contact_title'
        db.add_column(u'rca_schoolpage', 'contact_title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'SchoolPage.contact_address'
        db.add_column(u'rca_schoolpage', 'contact_address',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'SchoolPage.contact_link'
        db.add_column(u'rca_schoolpage', 'contact_link',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'SchoolPage.contact_link_text'
        db.add_column(u'rca_schoolpage', 'contact_link_text',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'SchoolPage.head_of_research'
        db.add_column(u'rca_schoolpage', 'head_of_research',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['rca.StaffPage']),
                      keep_default=False)

        # Adding field 'SchoolPage.head_of_research_statement'
        db.add_column(u'rca_schoolpage', 'head_of_research_statement',
                      self.gf('wagtail.wagtailcore.fields.RichTextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'SchoolPage.head_of_research_link'
        db.add_column(u'rca_schoolpage', 'head_of_research_link',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['wagtailcore.Page']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'SchoolPageRelatedLink'
        db.delete_table(u'rca_schoolpagerelatedlink')

        # Deleting model 'SchoolPageContactTelEmail'
        db.delete_table(u'rca_schoolpagecontacttelemail')

        # Deleting model 'SchoolPageCarouselItem'
        db.delete_table(u'rca_schoolpagecarouselitem')

        # Deleting field 'SchoolPage.social_image'
        db.delete_column(u'rca_schoolpage', 'social_image_id')

        # Deleting field 'SchoolPage.social_text'
        db.delete_column(u'rca_schoolpage', 'social_text')

        # Deleting field 'SchoolPage.background_image'
        db.delete_column(u'rca_schoolpage', 'background_image_id')

        # Deleting field 'SchoolPage.head_of_school'
        db.delete_column(u'rca_schoolpage', 'head_of_school_id')

        # Deleting field 'SchoolPage.head_of_school_statement'
        db.delete_column(u'rca_schoolpage', 'head_of_school_statement')

        # Deleting field 'SchoolPage.head_of_school_link'
        db.delete_column(u'rca_schoolpage', 'head_of_school_link_id')

        # Deleting field 'SchoolPage.twitter_feed'
        db.delete_column(u'rca_schoolpage', 'twitter_feed')

        # Deleting field 'SchoolPage.contact_title'
        db.delete_column(u'rca_schoolpage', 'contact_title')

        # Deleting field 'SchoolPage.contact_address'
        db.delete_column(u'rca_schoolpage', 'contact_address')

        # Deleting field 'SchoolPage.contact_link'
        db.delete_column(u'rca_schoolpage', 'contact_link')

        # Deleting field 'SchoolPage.contact_link_text'
        db.delete_column(u'rca_schoolpage', 'contact_link_text')

        # Deleting field 'SchoolPage.head_of_research'
        db.delete_column(u'rca_schoolpage', 'head_of_research_id')

        # Deleting field 'SchoolPage.head_of_research_statement'
        db.delete_column(u'rca_schoolpage', 'head_of_research_statement')

        # Deleting field 'SchoolPage.head_of_research_link'
        db.delete_column(u'rca_schoolpage', 'head_of_research_link_id')
