...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProgrammePageFacilitiesCarouselItem'
        db.create_table(u'rca_programmepagefacilitiescarouselitem', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sort_order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('page', self.gf('modelcluster.fields.ParentalKey')(related_name='facilities_carousel_items', to=orm['rca.ProgrammePage'])),
            ('facilities_text', self.gf('wagtail.wagtailcore.fields.RichTextField')(null=True, blank=True)),
            ('facilities_image', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage'])),
            ('facilities_link', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, on_delete=models.SET_NULL, to=orm['wagtailcore.Page'])),
        ))
        db.send_create_signal(u'rca', ['ProgrammePageFacilitiesCarouselItem'])


    def backwards(self, orm):
        # Deleting model 'ProgrammePageFacilitiesCarouselItem'
        db.delete_table(u'rca_programmepagefacilitiescarouselitem')
