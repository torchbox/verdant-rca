...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'StandardPageImage'
        db.create_table(u'rca_standardpageimage', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sort_order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('page', self.gf('django.db.models.fields.related.ForeignKey')(related_name='images', to=orm['rca.StandardPage'])),
            ('image', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['rca.RcaImage'])),
        ))
        db.send_create_signal(u'rca', ['StandardPageImage'])

        # Adding model 'StandardPageRelatedDocument'
        db.create_table(u'rca_standardpagerelateddocument', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sort_order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('page', self.gf('django.db.models.fields.related.ForeignKey')(related_name='documents', to=orm['rca.StandardPage'])),
        ...
        db.send_create_signal(u'rca', ['StandardPageRelatedDocument'])

        # Adding field 'StandardPage.middle_column_body'
        db.add_column(u'rca_standardpage', 'middle_column_body',
                      self.gf('wagtail.wagtailcore.fields.RichTextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'StandardPageImage'
        db.delete_table(u'rca_standardpageimage')

        # Deleting model 'StandardPageRelatedDocument'
        db.delete_table(u'rca_standardpagerelateddocument')

        # Deleting field 'StandardPage.middle_column_body'
        db.delete_column(u'rca_standardpage', 'middle_column_body')
