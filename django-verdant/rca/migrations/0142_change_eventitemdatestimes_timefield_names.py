...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column(u'rca_eventitemdatestimes', 'time_from_new', 'time_from')
        db.rename_column(u'rca_eventitemdatestimes', 'time_to_new', 'time_to')

        # Loop through event items and move all data from old fields to new ones
        for eventitem in orm['rca.EventItem'].objects.all():
            for revision in eventitem.revisions.all():
                ...
                for date_time in revision_data["dates_times"]:
                    date_time["time_from"] = date_time["time_from_new"]
                    date_time["time_to"] = date_time["time_to_new"]
                    del date_time["time_from_new"]
                    del date_time["time_to_new"]
    ...
    def backwards(self, orm):
        db.rename_column(u'rca_eventitemdatestimes', 'time_from', 'time_from_new')
        db.rename_column(u'rca_eventitemdatestimes', 'time_to', 'time_to_new')
