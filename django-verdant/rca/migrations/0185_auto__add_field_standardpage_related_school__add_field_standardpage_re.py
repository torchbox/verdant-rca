...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StandardPage.related_school'
        db.add_column(u'rca_standardpage', 'related_school',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'StandardPage.related_programme'
        db.add_column(u'rca_standardpage', 'related_programme',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StandardPage.related_school'
        db.delete_column(u'rca_standardpage', 'related_school')

        # Deleting field 'StandardPage.related_programme'
        db.delete_column(u'rca_standardpage', 'related_programme')
