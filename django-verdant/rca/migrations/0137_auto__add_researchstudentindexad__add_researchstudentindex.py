...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ResearchStudentIndexAd'
        db.create_table(u'rca_researchstudentindexad', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sort_order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('page', self.gf('modelcluster.fields.ParentalKey')(related_name='manual_adverts', to=orm['rca.ResearchStudentIndex'])),
            ('ad', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['rca.Advert'])),
        ))
        db.send_create_signal(u'rca', ['ResearchStudentIndexAd'])

        # Adding model 'ResearchStudentIndex'
        db.create_table(u'rca_researchstudentindex', (
        ...
        db.send_create_signal(u'rca', ['ResearchStudentIndex'])


    def backwards(self, orm):
        # Deleting model 'ResearchStudentIndexAd'
        db.delete_table(u'rca_researchstudentindexad')

        # Deleting model 'ResearchStudentIndex'
        db.delete_table(u'rca_researchstudentindex')
