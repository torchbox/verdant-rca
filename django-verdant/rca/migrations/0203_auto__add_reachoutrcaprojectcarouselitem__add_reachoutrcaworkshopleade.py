...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ReachOutRCAProjectCarouselItem'
        db.create_table(u'rca_reachoutrcaprojectcarouselitem', (
            ...
            ('page', self.gf('modelcluster.fields.ParentalKey')(related_name='carousel_items', to=orm['rca.ReachOutRCAProject'])),
        ))
        db.send_create_signal(u'rca', ['ReachOutRCAProjectCarouselItem'])

        # Adding model 'ReachOutRCAWorkshopLeader'
        db.create_table(u'rca_reachoutrcaworkshopleader', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sort_order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('page', self.gf('modelcluster.fields.ParentalKey')(related_name='leader', to=orm['rca.ReachOutRCAProject'])),
        ...
        db.send_create_signal(u'rca', ['ReachOutRCAWorkshopLeader'])

        # Adding model 'ReachOutRCAProject'
        db.create_table(u'rca_reachoutrcaproject', (
        ...
        db.send_create_signal(u'rca', ['ReachOutRCAProject'])

        # Adding model 'ReachOutRCAParticipants'
        db.create_table(u'rca_reachoutrcaparticipants', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sort_order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('page', self.gf('modelcluster.fields.ParentalKey')(related_name='participants', to=orm['rca.ReachOutRCAProject'])),
            ('participant', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'rca', ['ReachOutRCAParticipants'])

        # Adding model 'ReachOutRCAThemes'
        db.create_table(u'rca_reachoutrcathemes', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sort_order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('page', self.gf('modelcluster.fields.ParentalKey')(related_name='themes', to=orm['rca.ReachOutRCAProject'])),
            ('participant', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'rca', ['ReachOutRCAThemes'])

        # Adding model 'ReachOutRCAQuotation'
        db.create_table(u'rca_reachoutrcaquotation', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sort_order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('page', self.gf('modelcluster.fields.ParentalKey')(related_name='quotations', to=orm['rca.ReachOutRCAProject'])),
            ('quotation', self.gf('django.db.models.fields.TextField')()),
            ('quotee', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('quotee_job_title', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
        ))
        db.send_create_signal(u'rca', ['ReachOutRCAQuotation'])

        # Adding model 'ReachOutRCAWorkshopAssistant'
        db.create_table(u'rca_reachoutrcaworkshopassistant', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sort_order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('page', self.gf('modelcluster.fields.ParentalKey')(related_name='assistant', to=orm['rca.ReachOutRCAProject'])),
            ('person', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['wagtailcore.Page'])),
            ('manual_person_name', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
        ))
        db.send_create_signal(u'rca', ['ReachOutRCAWorkshopAssistant'])

        # Adding model 'ReachOutRCAProjectLink'
        db.create_table(u'rca_reachoutrcaprojectlink', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sort_order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('page', self.gf('modelcluster.fields.ParentalKey')(related_name='links', to=orm['rca.ReachOutRCAProject'])),
            ('link', self.gf('django.db.models.fields.URLField')(max_length=200)),
            ('link_text', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'rca', ['ReachOutRCAProjectLink'])


    def backwards(self, orm):
        # Deleting model 'ReachOutRCAProjectCarouselItem'
        db.delete_table(u'rca_reachoutrcaprojectcarouselitem')

        # Deleting model 'ReachOutRCAWorkshopLeader'
        db.delete_table(u'rca_reachoutrcaworkshopleader')

        # Deleting model 'ReachOutRCAProject'
        db.delete_table(u'rca_reachoutrcaproject')

        # Deleting model 'ReachOutRCAParticipants'
        db.delete_table(u'rca_reachoutrcaparticipants')

        # Deleting model 'ReachOutRCAThemes'
        db.delete_table(u'rca_reachoutrcathemes')

        # Deleting model 'ReachOutRCAQuotation'
        db.delete_table(u'rca_reachoutrcaquotation')

        # Deleting model 'ReachOutRCAWorkshopAssistant'
        db.delete_table(u'rca_reachoutrcaworkshopassistant')

        # Deleting model 'ReachOutRCAProjectLink'
        db.delete_table(u'rca_reachoutrcaprojectlink')
    ...
    models = {
        ...
        u'rca.newstudentpage': {
            ...
            'research_qualification': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
        ...
        u'rca.newstudentpageawards': {
            'Meta': {'ordering': "['sort_order']", 'object_name': 'NewStudentPageAwards'},
        ...
        u'rca.newstudentpageresearchawards': {
            'Meta': {'ordering': "['sort_order']", 'object_name': 'NewStudentPageResearchAwards'},
            'award': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'page': ('modelcluster.fields.ParentalKey', [], {'related_name': "'research_awards'", 'to': u"orm['rca.NewStudentPage']"}),
            'sort_order': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'})
        },
        ...
        u'rca.newstudentpageresearchcollaborator': {
            'Meta': {'ordering': "['sort_order']", 'object_name': 'NewStudentPageResearchCollaborator'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'page': ('modelcluster.fields.ParentalKey', [], {'related_name': "'research_collaborators'", 'to': u"orm['rca.NewStudentPage']"}),
            'sort_order': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'})
        },
        u'rca.newstudentpageresearchsponsor': {
            'Meta': {'ordering': "['sort_order']", 'object_name': 'NewStudentPageResearchSponsor'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'page': ('modelcluster.fields.ParentalKey', [], {'related_name': "'research_sponsors'", 'to': u"orm['rca.NewStudentPage']"}),
            'sort_order': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'})
        },
        ...
        u'rca.reachoutrcaparticipants': {
            ...
            'participant': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'sort_order': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'})
        },
