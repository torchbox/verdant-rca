...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NewsItem.show_on_news_index'
        db.add_column(u'rca_newsitem', 'show_on_news_index',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NewsItem.show_on_news_index'
        db.delete_column(u'rca_newsitem', 'show_on_news_index')
