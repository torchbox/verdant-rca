...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EventItemDatesTimes.date_to'
        db.alter_column(u'rca_eventitemdatestimes', 'date_to', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'EventItemDatesTimes.date_to'
        raise RuntimeError("Cannot reverse this migration. 'EventItemDatesTimes.date_to' and its values cannot be restored.")
