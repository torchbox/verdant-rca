...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'HomePage.packery_news_items'
        db.delete_column(u'rca_homepage', 'packery_news_items')

        # Adding field 'HomePage.packery_news'
        db.add_column(u'rca_homepage', 'packery_news',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'HomePage.packery_staff'
        db.add_column(u'rca_homepage', 'packery_staff',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'HomePage.packery_student_work'
        db.add_column(u'rca_homepage', 'packery_student_work',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'HomePage.packery_tweets'
        db.add_column(u'rca_homepage', 'packery_tweets',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'HomePage.packery_rcanow'
        db.add_column(u'rca_homepage', 'packery_rcanow',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'HomePage.packery_standard'
        db.add_column(u'rca_homepage', 'packery_standard',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'HomePage.packery_news_items'
        db.add_column(u'rca_homepage', 'packery_news_items',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'HomePage.packery_news'
        db.delete_column(u'rca_homepage', 'packery_news')

        # Deleting field 'HomePage.packery_staff'
        db.delete_column(u'rca_homepage', 'packery_staff')

        # Deleting field 'HomePage.packery_student_work'
        db.delete_column(u'rca_homepage', 'packery_student_work')

        # Deleting field 'HomePage.packery_tweets'
        db.delete_column(u'rca_homepage', 'packery_tweets')

        # Deleting field 'HomePage.packery_rcanow'
        db.delete_column(u'rca_homepage', 'packery_rcanow')

        # Deleting field 'HomePage.packery_standard'
        db.delete_column(u'rca_homepage', 'packery_standard')
