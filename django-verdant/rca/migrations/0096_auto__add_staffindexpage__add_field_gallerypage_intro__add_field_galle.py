...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'StaffIndexPage'
        db.create_table(u'rca_staffindexpage', (
        ...
        db.send_create_signal(u'rca', ['StaffIndexPage'])

        # Adding field 'GalleryPage.intro'
        db.add_column(u'rca_gallerypage', 'intro',
                      self.gf('core.fields.RichTextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'GalleryPage.twitter_feed'
        db.add_column(u'rca_gallerypage', 'twitter_feed',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'StaffIndexPage'
        db.delete_table(u'rca_staffindexpage')

        # Deleting field 'GalleryPage.intro'
        db.delete_column(u'rca_gallerypage', 'intro')

        # Deleting field 'GalleryPage.twitter_feed'
        db.delete_column(u'rca_gallerypage', 'twitter_feed')
    ...
    models = {
        ...
        u'rca.staffindexpage': {
            'Meta': {'object_name': 'StaffIndexPage', '_ormbases': [u'core.Page']},
            'feed_image': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'to': u"orm['rca.RcaImage']"}),
            'intro': ('core.fields.RichTextField', [], {'blank': 'True'}),
            u'page_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['core.Page']", 'unique': 'True', 'primary_key': 'True'}),
            'seo_title': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
