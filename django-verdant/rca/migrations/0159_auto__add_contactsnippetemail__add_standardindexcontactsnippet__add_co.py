...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'rca_contactsnippetplacement', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('page', self.gf('cluster.fields.ParentalKey')(related_name='contact_snippet_placements', to=orm['core.Page'])),
            ('contact_snippet', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['rca.ContactSnippet'])),
        ))
    ...
    models = {
        ...
        u'rca.donationpage': {
            ...
            'redirect_to_when_done': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'null': 'True', 'to': u"orm['core.Page']"}),
            'show_on_homepage': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'social_image': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'to': u"orm['rca.RcaImage']"}),
            'social_text': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
