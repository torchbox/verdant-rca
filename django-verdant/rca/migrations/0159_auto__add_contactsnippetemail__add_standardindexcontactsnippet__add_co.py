...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ContactSnippetEmail'
        db.create_table(u'rca_contactsnippetemail', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sort_order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('page', self.gf('cluster.fields.ParentalKey')(related_name='contact_email', to=orm['rca.ContactSnippet'])),
            ('email_address', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'rca', ['ContactSnippetEmail'])

        # Adding model 'StandardIndexContactSnippet'
        db.create_table(u'rca_standardindexcontactsnippet', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sort_order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('page', self.gf('cluster.fields.ParentalKey')(related_name='contact_snippets', to=orm['rca.StandardIndex'])),
            ('contact_snippet', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['rca.ContactSnippet'])),
        ))
        db.send_create_signal(u'rca', ['StandardIndexContactSnippet'])

        # Adding model 'ContactSnippetPlacement'
        db.create_table(u'rca_contactsnippetplacement', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('page', self.gf('cluster.fields.ParentalKey')(related_name='contact_snippet_placements', to=orm['wagtailcore.Page'])),
            ('contact_snippet', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['rca.ContactSnippet'])),
        ))
        db.send_create_signal(u'rca', ['ContactSnippetPlacement'])

        # Adding model 'ContactSnippetPhone'
        db.create_table(u'rca_contactsnippetphone', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sort_order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('page', self.gf('cluster.fields.ParentalKey')(related_name='contact_phone', to=orm['rca.ContactSnippet'])),
            ('phone_number', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'rca', ['ContactSnippetPhone'])

        # Adding model 'ContactSnippet'
        db.create_table(u'rca_contactsnippet', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('contact_title', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('contact_address', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('contact_link', self.gf('django.db.models.fields.URLField')(max_length=200, blank=True)),
            ('contact_link_text', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
        ))
        db.send_create_signal(u'rca', ['ContactSnippet'])


    def backwards(self, orm):
        # Deleting model 'ContactSnippetEmail'
        db.delete_table(u'rca_contactsnippetemail')

        # Deleting model 'StandardIndexContactSnippet'
        db.delete_table(u'rca_standardindexcontactsnippet')

        # Deleting model 'ContactSnippetPlacement'
        db.delete_table(u'rca_contactsnippetplacement')

        # Deleting model 'ContactSnippetPhone'
        db.delete_table(u'rca_contactsnippetphone')

        # Deleting model 'ContactSnippet'
        db.delete_table(u'rca_contactsnippet')
    ...
    models = {
        ...
        u'rca.donationpage': {
            ...
            'redirect_to_when_done': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'null': 'True', 'to': u"orm['wagtailcore.Page']"}),
            'show_on_homepage': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'social_image': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'to': u"orm['rca.RcaImage']"}),
            'social_text': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
