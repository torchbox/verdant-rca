...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'rca_contactsnippetemail', (
            ...
            ('page', self.gf('modelcluster.fields.ParentalKey')(related_name='contact_email', to=orm['rca.ContactSnippet'])),
        ...
        db.create_table(u'rca_standardindexcontactsnippet', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sort_order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('page', self.gf('modelcluster.fields.ParentalKey')(related_name='contact_snippets', to=orm['rca.StandardIndex'])),
        ...
        db.create_table(u'rca_contactsnippetplacement', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('page', self.gf('modelcluster.fields.ParentalKey')(related_name='contact_snippet_placements', to=orm['wagtailcore.Page'])),
            ('contact_snippet', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['rca.ContactSnippet'])),
        ))
        ...
        db.create_table(u'rca_contactsnippetphone', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sort_order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('page', self.gf('modelcluster.fields.ParentalKey')(related_name='contact_phone', to=orm['rca.ContactSnippet'])),
