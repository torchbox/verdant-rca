...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StandardIndex.background_image'
        db.add_column(u'rca_standardindex', 'background_image',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['rca.RcaImage']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StandardIndex.background_image'
        db.delete_column(u'rca_standardindex', 'background_image_id')
