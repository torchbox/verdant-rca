...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'JobPage.campus'
        db.alter_column(u'rca_jobpage', 'campus', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'JobPage.campus'
        db.alter_column(u'rca_jobpage', 'campus', self.gf('django.db.models.fields.CharField')(default='', max_length=255))
