...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StudentPage.student_twitter_feed'
        db.add_column(u'rca_studentpage', 'student_twitter_feed',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


        # Changing field 'StudentPage.work_description'
        db.alter_column(u'rca_studentpage', 'work_description', self.gf('wagtail.wagtailcore.fields.RichTextField')())

    def backwards(self, orm):
        # Deleting field 'StudentPage.student_twitter_feed'
        db.delete_column(u'rca_studentpage', 'student_twitter_feed')


        # Changing field 'StudentPage.work_description'
        db.alter_column(u'rca_studentpage', 'work_description', self.gf('django.db.models.fields.CharField')(max_length=255))
