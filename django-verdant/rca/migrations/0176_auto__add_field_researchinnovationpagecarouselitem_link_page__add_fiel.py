...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ResearchInnovationPageCarouselItem.link_page'
        db.add_column(u'rca_researchinnovationpagecarouselitem', 'link_page',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, on_delete=models.SET_NULL, to=orm['wagtailcore.Page']),
                      keep_default=False)

        # Adding field 'StaffPageCarouselItem.link_page'
        db.add_column(u'rca_staffpagecarouselitem', 'link_page',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, on_delete=models.SET_NULL, to=orm['wagtailcore.Page']),
                      keep_default=False)

        # Adding field 'ReviewPageCarouselItem.link_page'
        db.add_column(u'rca_reviewpagecarouselitem', 'link_page',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, on_delete=models.SET_NULL, to=orm['wagtailcore.Page']),
                      keep_default=False)

        # Adding field 'StudentPageCarouselItem.link_page'
        db.add_column(u'rca_studentpagecarouselitem', 'link_page',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, on_delete=models.SET_NULL, to=orm['wagtailcore.Page']),
                      keep_default=False)

        # Adding field 'ProgrammePageCarouselItem.link_page'
        db.add_column(u'rca_programmepagecarouselitem', 'link_page',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, on_delete=models.SET_NULL, to=orm['wagtailcore.Page']),
                      keep_default=False)

        # Adding field 'RcaNowPagePageCarouselItem.link_page'
        db.add_column(u'rca_rcanowpagepagecarouselitem', 'link_page',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, on_delete=models.SET_NULL, to=orm['wagtailcore.Page']),
                      keep_default=False)

        # Adding field 'HomePageCarouselItem.link_page'
        db.add_column(u'rca_homepagecarouselitem', 'link_page',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, on_delete=models.SET_NULL, to=orm['wagtailcore.Page']),
                      keep_default=False)

        # Adding field 'SchoolPageCarouselItem.link_page'
        db.add_column(u'rca_schoolpagecarouselitem', 'link_page',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, on_delete=models.SET_NULL, to=orm['wagtailcore.Page']),
                      keep_default=False)

        # Adding field 'NewsItemCarouselItem.link_page'
        db.add_column(u'rca_newsitemcarouselitem', 'link_page',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, on_delete=models.SET_NULL, to=orm['wagtailcore.Page']),
                      keep_default=False)

        # Adding field 'StandardPageCarouselItem.link_page'
        db.add_column(u'rca_standardpagecarouselitem', 'link_page',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, on_delete=models.SET_NULL, to=orm['wagtailcore.Page']),
                      keep_default=False)

        # Adding field 'PressReleaseCarouselItem.link_page'
        db.add_column(u'rca_pressreleasecarouselitem', 'link_page',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, on_delete=models.SET_NULL, to=orm['wagtailcore.Page']),
                      keep_default=False)

        # Adding field 'EventItemCarouselItem.link_page'
        db.add_column(u'rca_eventitemcarouselitem', 'link_page',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, on_delete=models.SET_NULL, to=orm['wagtailcore.Page']),
                      keep_default=False)

        # Adding field 'ResearchItemCarouselItem.link_page'
        db.add_column(u'rca_researchitemcarouselitem', 'link_page',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, on_delete=models.SET_NULL, to=orm['wagtailcore.Page']),
                      keep_default=False)

        # Adding field 'StandardIndexCarouselItem.link_page'
        db.add_column(u'rca_standardindexcarouselitem', 'link_page',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, on_delete=models.SET_NULL, to=orm['wagtailcore.Page']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ResearchInnovationPageCarouselItem.link_page'
        db.delete_column(u'rca_researchinnovationpagecarouselitem', 'link_page_id')

        # Deleting field 'StaffPageCarouselItem.link_page'
        db.delete_column(u'rca_staffpagecarouselitem', 'link_page_id')

        # Deleting field 'ReviewPageCarouselItem.link_page'
        db.delete_column(u'rca_reviewpagecarouselitem', 'link_page_id')

        # Deleting field 'StudentPageCarouselItem.link_page'
        db.delete_column(u'rca_studentpagecarouselitem', 'link_page_id')

        # Deleting field 'ProgrammePageCarouselItem.link_page'
        db.delete_column(u'rca_programmepagecarouselitem', 'link_page_id')

        # Deleting field 'RcaNowPagePageCarouselItem.link_page'
        db.delete_column(u'rca_rcanowpagepagecarouselitem', 'link_page_id')

        # Deleting field 'HomePageCarouselItem.link_page'
        db.delete_column(u'rca_homepagecarouselitem', 'link_page_id')

        # Deleting field 'SchoolPageCarouselItem.link_page'
        db.delete_column(u'rca_schoolpagecarouselitem', 'link_page_id')

        # Deleting field 'NewsItemCarouselItem.link_page'
        db.delete_column(u'rca_newsitemcarouselitem', 'link_page_id')

        # Deleting field 'StandardPageCarouselItem.link_page'
        db.delete_column(u'rca_standardpagecarouselitem', 'link_page_id')

        # Deleting field 'PressReleaseCarouselItem.link_page'
        db.delete_column(u'rca_pressreleasecarouselitem', 'link_page_id')

        # Deleting field 'EventItemCarouselItem.link_page'
        db.delete_column(u'rca_eventitemcarouselitem', 'link_page_id')

        # Deleting field 'ResearchItemCarouselItem.link_page'
        db.delete_column(u'rca_researchitemcarouselitem', 'link_page_id')

        # Deleting field 'StandardIndexCarouselItem.link_page'
        db.delete_column(u'rca_standardindexcarouselitem', 'link_page_id')
