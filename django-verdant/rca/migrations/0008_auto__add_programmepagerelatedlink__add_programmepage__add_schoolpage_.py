...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProgrammePageRelatedLink'
        db.create_table(u'rca_programmepagerelatedlink', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('page', self.gf('django.db.models.fields.related.ForeignKey')(related_name='related_links', to=orm['rca.ProgrammePage'])),
            ('url', self.gf('django.db.models.fields.URLField')(max_length=200)),
            ('link_text', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'rca', ['ProgrammePageRelatedLink'])

        # Adding model 'ProgrammePage'
        db.create_table(u'rca_programmepage', (
            (u'page_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['wagtailcore.Page'], unique=True, primary_key=True)),
            ('head_of_programme', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('head_of_programme_statement', self.gf('wagtail.wagtailcore.fields.RichTextField')()),
            ('programme_video', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('download_document_url', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'rca', ['ProgrammePage'])

        # Adding model 'SchoolPage'
        db.create_table(u'rca_schoolpage', (
            (u'page_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['wagtailcore.Page'], unique=True, primary_key=True)),
        ))
        db.send_create_signal(u'rca', ['SchoolPage'])

        # Adding model 'ProgrammePageStudentStory'
        db.create_table(u'rca_programmepagestudentstory', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('page', self.gf('django.db.models.fields.related.ForeignKey')(related_name='student_stories', to=orm['rca.ProgrammePage'])),
        ...
        db.send_create_signal(u'rca', ['ProgrammePageStudentStory'])

        # Adding model 'ProgrammePageCarouselItem'
        db.create_table(u'rca_programmepagecarouselitem', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('page', self.gf('django.db.models.fields.related.ForeignKey')(related_name='carousel_items', to=orm['rca.ProgrammePage'])),
            ('url', self.gf('django.db.models.fields.URLField')(max_length=200)),
        ))
        db.send_create_signal(u'rca', ['ProgrammePageCarouselItem'])

        # Adding model 'ProgrammePageFacilities'
        db.create_table(u'rca_programmepagefacilities', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('page', self.gf('django.db.models.fields.related.ForeignKey')(related_name='facilities', to=orm['rca.ProgrammePage'])),
            ('text', self.gf('wagtail.wagtailcore.fields.RichTextField')()),
            ('image', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['wagtailimages.Image'])),
        ))
        db.send_create_signal(u'rca', ['ProgrammePageFacilities'])

        # Adding model 'ProgrammePageOurSites'
        db.create_table(u'rca_programmepageoursites', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('page', self.gf('django.db.models.fields.related.ForeignKey')(related_name='our_sites', to=orm['rca.ProgrammePage'])),
            ('url', self.gf('django.db.models.fields.URLField')(max_length=200)),
            ('site_name', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'rca', ['ProgrammePageOurSites'])


    def backwards(self, orm):
        # Deleting model 'ProgrammePageRelatedLink'
        db.delete_table(u'rca_programmepagerelatedlink')

        # Deleting model 'ProgrammePage'
        db.delete_table(u'rca_programmepage')

        # Deleting model 'SchoolPage'
        db.delete_table(u'rca_schoolpage')

        # Deleting model 'ProgrammePageStudentStory'
        db.delete_table(u'rca_programmepagestudentstory')

        # Deleting model 'ProgrammePageCarouselItem'
        db.delete_table(u'rca_programmepagecarouselitem')

        # Deleting model 'ProgrammePageFacilities'
        db.delete_table(u'rca_programmepagefacilities')

        # Deleting model 'ProgrammePageOurSites'
        db.delete_table(u'rca_programmepageoursites')
    ...
    models = {
        ...
        u'rca.programmepage': {
            ...
            'download_document_url': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            ...
            u'page_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['wagtailcore.Page']", 'unique': 'True', 'primary_key': 'True'}),
            'programme_video': ('django.db.models.fields.CharField', [], {'max_length': '255'})
        },
