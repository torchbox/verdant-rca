...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'StudentPageContacts'
        db.create_table(u'rca_studentpagecontacts', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('page', self.gf('django.db.models.fields.related.ForeignKey')(related_name='contacts', to=orm['rca.StudentPage'])),
        ...
        db.send_create_signal(u'rca', ['StudentPageContacts'])

        # Adding model 'StudentPageWorkCollaborator'
        db.create_table(u'rca_studentpageworkcollaborator', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('page', self.gf('django.db.models.fields.related.ForeignKey')(related_name='collaborators', to=orm['rca.StudentPage'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'rca', ['StudentPageWorkCollaborator'])

        # Adding model 'StudentPageExhibition'
        db.create_table(u'rca_studentpageexhibition', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('page', self.gf('django.db.models.fields.related.ForeignKey')(related_name='exhibitions', to=orm['rca.StudentPage'])),
            ('exhibition', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'rca', ['StudentPageExhibition'])

        # Adding model 'StudentPageCarouselItem'
        db.create_table(u'rca_studentpagecarouselitem', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('page', self.gf('django.db.models.fields.related.ForeignKey')(related_name='carousel_items', to=orm['rca.StudentPage'])),
        ))
        db.send_create_signal(u'rca', ['StudentPageCarouselItem'])

        # Adding model 'StudentPageAwards'
        db.create_table(u'rca_studentpageawards', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('page', self.gf('django.db.models.fields.related.ForeignKey')(related_name='awards', to=orm['rca.StudentPage'])),
            ('award', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'rca', ['StudentPageAwards'])

        # Adding model 'StudentPageDegree'
        db.create_table(u'rca_studentpagedegree', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('page', self.gf('django.db.models.fields.related.ForeignKey')(related_name='degrees', to=orm['rca.StudentPage'])),
            ('degree', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'rca', ['StudentPageDegree'])

        # Adding model 'StudentPageExperience'
        db.create_table(u'rca_studentpageexperience', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('page', self.gf('django.db.models.fields.related.ForeignKey')(related_name='experiences', to=orm['rca.StudentPage'])),
            ('experience', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'rca', ['StudentPageExperience'])

        # Adding field 'StudentPage.school'
        db.add_column(u'rca_studentpage', 'school',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Adding field 'StudentPage.programme'
        db.add_column(u'rca_studentpage', 'programme',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Adding field 'StudentPage.profile_image'
        db.add_column(u'rca_studentpage', 'profile_image',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='+', to=orm['rca.RcaImage']),
                      keep_default=False)

        # Adding field 'StudentPage.statement'
        db.add_column(u'rca_studentpage', 'statement',
                      self.gf('wagtail.wagtailcore.fields.RichTextField')(default=''),
                      keep_default=False)

        # Adding field 'StudentPage.project_title'
        db.add_column(u'rca_studentpage', 'project_title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'StudentPage.work_description'
        db.add_column(u'rca_studentpage', 'work_description',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'StudentPage.work_type'
        db.add_column(u'rca_studentpage', 'work_type',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Adding field 'StudentPage.work_location'
        db.add_column(u'rca_studentpage', 'work_location',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Adding field 'StudentPage.work_awards'
        db.add_column(u'rca_studentpage', 'work_awards',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Adding field 'StudentPage.work_sponsors'
        db.add_column(u'rca_studentpage', 'work_sponsors',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Adding field 'StudentPage.twitter_feed'
        db.add_column(u'rca_studentpage', 'twitter_feed',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'StudentPageContacts'
        db.delete_table(u'rca_studentpagecontacts')

        # Deleting model 'StudentPageWorkCollaborator'
        db.delete_table(u'rca_studentpageworkcollaborator')

        # Deleting model 'StudentPageExhibition'
        db.delete_table(u'rca_studentpageexhibition')

        # Deleting model 'StudentPageCarouselItem'
        db.delete_table(u'rca_studentpagecarouselitem')

        # Deleting model 'StudentPageAwards'
        db.delete_table(u'rca_studentpageawards')

        # Deleting model 'StudentPageDegree'
        db.delete_table(u'rca_studentpagedegree')

        # Deleting model 'StudentPageExperience'
        db.delete_table(u'rca_studentpageexperience')

        # Deleting field 'StudentPage.school'
        db.delete_column(u'rca_studentpage', 'school')

        # Deleting field 'StudentPage.programme'
        db.delete_column(u'rca_studentpage', 'programme')

        # Deleting field 'StudentPage.profile_image'
        db.delete_column(u'rca_studentpage', 'profile_image_id')

        # Deleting field 'StudentPage.statement'
        db.delete_column(u'rca_studentpage', 'statement')

        # Deleting field 'StudentPage.project_title'
        db.delete_column(u'rca_studentpage', 'project_title')

        # Deleting field 'StudentPage.work_description'
        db.delete_column(u'rca_studentpage', 'work_description')

        # Deleting field 'StudentPage.work_type'
        db.delete_column(u'rca_studentpage', 'work_type')

        # Deleting field 'StudentPage.work_location'
        db.delete_column(u'rca_studentpage', 'work_location')

        # Deleting field 'StudentPage.work_awards'
        db.delete_column(u'rca_studentpage', 'work_awards')

        # Deleting field 'StudentPage.work_sponsors'
        db.delete_column(u'rca_studentpage', 'work_sponsors')

        # Deleting field 'StudentPage.twitter_feed'
        db.delete_column(u'rca_studentpage', 'twitter_feed')
