...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AlumniPage.show_on_homepage'
        db.add_column(u'rca_alumnipage', 'show_on_homepage',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AlumniPage.show_on_homepage'
        db.delete_column(u'rca_alumnipage', 'show_on_homepage')
