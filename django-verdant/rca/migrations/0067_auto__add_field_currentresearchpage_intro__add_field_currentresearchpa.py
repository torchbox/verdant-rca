...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CurrentResearchPage.intro'
        db.add_column(u'rca_currentresearchpage', 'intro',
                      self.gf('core.fields.RichTextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'CurrentResearchPage.twitter_feed'
        db.add_column(u'rca_currentresearchpage', 'twitter_feed',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CurrentResearchPage.intro'
        db.delete_column(u'rca_currentresearchpage', 'intro')

        # Deleting field 'CurrentResearchPage.twitter_feed'
        db.delete_column(u'rca_currentresearchpage', 'twitter_feed')
