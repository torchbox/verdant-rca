...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'rca_customecontentmoduleplacement', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('page', self.gf('cluster.fields.ParentalKey')(related_name='custom_content_module_placements', to=orm['wagtailcore.Page'])),
        ...
        db.create_table(u'rca_standardindexcustomcontentmodules', (
            ...
            ('page', self.gf('cluster.fields.ParentalKey')(related_name='custom_content_modules', to=orm['rca.StandardIndex'])),
            ('custom_content_module', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['rca.CustomContentModule'])),
        ))
        ...
        db.create_table(u'rca_customcontentmoduleblock', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sort_order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('content_module', self.gf('cluster.fields.ParentalKey')(related_name='blocks', to=orm['rca.CustomContentModule'])),
