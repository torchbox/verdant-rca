...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CustomContentModule'
        db.create_table(u'rca_customcontentmodule', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'rca', ['CustomContentModule'])

        # Adding model 'CustomeContentModulePlacement'
        db.create_table(u'rca_customecontentmoduleplacement', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('page', self.gf('modelcluster.fields.ParentalKey')(related_name='custom_content_module_placements', to=orm['wagtailcore.Page'])),
            ('custom_content_module', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['rca.CustomContentModule'])),
        ))
        db.send_create_signal(u'rca', ['CustomeContentModulePlacement'])

        # Adding model 'StandardIndexCustomContentModules'
        db.create_table(u'rca_standardindexcustomcontentmodules', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sort_order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('page', self.gf('modelcluster.fields.ParentalKey')(related_name='custom_content_modules', to=orm['rca.StandardIndex'])),
            ('custom_content_module', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['rca.CustomContentModule'])),
        ))
        db.send_create_signal(u'rca', ['StandardIndexCustomContentModules'])

        # Adding model 'CustomContentModuleBlock'
        db.create_table(u'rca_customcontentmoduleblock', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sort_order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('content_module', self.gf('modelcluster.fields.ParentalKey')(related_name='blocks', to=orm['rca.CustomContentModule'])),
            ('url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True)),
            ('item_title', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ...
        db.send_create_signal(u'rca', ['CustomContentModuleBlock'])


    def backwards(self, orm):
        # Deleting model 'CustomContentModule'
        db.delete_table(u'rca_customcontentmodule')

        # Deleting model 'CustomeContentModulePlacement'
        db.delete_table(u'rca_customecontentmoduleplacement')

        # Deleting model 'StandardIndexCustomContentModules'
        db.delete_table(u'rca_standardindexcustomcontentmodules')

        # Deleting model 'CustomContentModuleBlock'
        db.delete_table(u'rca_customcontentmoduleblock')
