...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StandardIndex.intro_link'
        db.add_column(u'rca_standardindex', 'intro_link',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['wagtailcore.Page']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StandardIndex.intro_link'
        db.delete_column(u'rca_standardindex', 'intro_link_id')
