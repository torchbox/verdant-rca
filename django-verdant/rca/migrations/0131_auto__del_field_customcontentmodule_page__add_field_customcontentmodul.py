...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CustomContentModule.page'
        db.delete_column(u'rca_customcontentmodule', 'page_id')

        # Adding field 'CustomContentModule.title'
        db.add_column(u'rca_customcontentmodule', 'title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'CustomContentModule.page'
        db.add_column(u'rca_customcontentmodule', 'page',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='custom_content_module', null=True, to=orm['wagtailcore.Page'], blank=True),
                      keep_default=False)

        # Deleting field 'CustomContentModule.title'
        db.delete_column(u'rca_customcontentmodule', 'title')
