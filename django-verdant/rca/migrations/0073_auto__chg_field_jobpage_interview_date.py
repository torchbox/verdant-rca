...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'JobPage.interview_date'
        db.alter_column(u'rca_jobpage', 'interview_date', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'JobPage.interview_date'
        db.alter_column(u'rca_jobpage', 'interview_date', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 10, 4, 0, 0)))
