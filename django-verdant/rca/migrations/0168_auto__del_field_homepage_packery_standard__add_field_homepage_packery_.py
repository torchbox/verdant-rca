...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'HomePage.packery_research'
        db.add_column(u'rca_homepage', 'packery_research',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'HomePage.packery_alumni'
        db.add_column(u'rca_homepage', 'packery_alumni',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'HomePage.packery_review'
        db.add_column(u'rca_homepage', 'packery_review',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'HomePage.packery_research'
        db.delete_column(u'rca_homepage', 'packery_research')

        # Deleting field 'HomePage.packery_alumni'
        db.delete_column(u'rca_homepage', 'packery_alumni')

        # Deleting field 'HomePage.packery_review'
        db.delete_column(u'rca_homepage', 'packery_review')
