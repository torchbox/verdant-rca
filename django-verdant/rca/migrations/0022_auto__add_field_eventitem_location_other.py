...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EventItem.location_other'
        db.add_column(u'rca_eventitem', 'location_other',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EventItem.location_other'
        db.delete_column(u'rca_eventitem', 'location_other')
