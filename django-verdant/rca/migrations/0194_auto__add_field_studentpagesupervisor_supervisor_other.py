...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StudentPageSupervisor.supervisor_other'
        db.add_column(u'rca_studentpagesupervisor', 'supervisor_other',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StudentPageSupervisor.supervisor_other'
        db.delete_column(u'rca_studentpagesupervisor', 'supervisor_other')
