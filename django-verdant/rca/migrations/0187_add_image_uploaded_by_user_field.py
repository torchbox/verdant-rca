...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RcaImage.uploaded_by_user'
        db.add_column(u'rca_rcaimage', 'uploaded_by_user',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RcaImage.uploaded_by_user'
        db.delete_column(u'rca_rcaimage', 'uploaded_by_user_id')
