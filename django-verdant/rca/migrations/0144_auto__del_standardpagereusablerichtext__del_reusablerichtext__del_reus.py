...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'rca_standardpagereusablerichtext', (
            ...
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('page', self.gf('cluster.fields.ParentalKey')(related_name='reusable_rich_texts', to=orm['rca.StandardPage'])),
        ))
    ...
    models = {
        ...
        u'rca.standardpagereusabletext': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'page': ('cluster.fields.ParentalKey', [], {'related_name': "'reusable_texts'", 'to': u"orm['rca.StandardPage']"}),
            'reusable_text': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'to': u"orm['rca.ReusableText']"}),
            'sort_order': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'})
        },
        u'rca.studentpage': {
