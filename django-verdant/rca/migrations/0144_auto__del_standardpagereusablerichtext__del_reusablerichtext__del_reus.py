...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'StandardPageReusableRichText'
        db.delete_table(u'rca_standardpagereusablerichtext')

        # Deleting model 'ReusableRichText'
        db.delete_table(u'rca_reusablerichtext')

        # Deleting model 'ReusableRichTextPlacement'
        db.delete_table(u'rca_reusablerichtextplacement')
    ...
    def backwards(self, orm):
        # Adding model 'StandardPageReusableRichText'
        db.create_table(u'rca_standardpagereusablerichtext', (
            ('sort_order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('reusable_rich_text', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['rca.ReusableRichText'])),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('page', self.gf('modelcluster.fields.ParentalKey')(related_name='reusable_rich_texts', to=orm['rca.StandardPage'])),
        ))
        db.send_create_signal(u'rca', ['StandardPageReusableRichText'])
        ...
        # Adding model 'ReusableRichTextPlacement'
    ...
    models = {
        ...
        u'rca.reusabletextplacement': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'page': ('modelcluster.fields.ParentalKey', [], {'related_name': "'reusable_rich_text_placements'", 'to': u"orm['wagtailcore.Page']"}),
        ...
        u'rca.standardpagereusabletext': {
            'Meta': {'ordering': "['sort_order']", 'object_name': 'StandardPageReusableText'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'page': ('modelcluster.fields.ParentalKey', [], {'related_name': "'reusable_texts'", 'to': u"orm['rca.StandardPage']"}),
            'reusable_text': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'to': u"orm['rca.ReusableText']"}),
            'sort_order': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'})
        },
        u'rca.studentpage': {
