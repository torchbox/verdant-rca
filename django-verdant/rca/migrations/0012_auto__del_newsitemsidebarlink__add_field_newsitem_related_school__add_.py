...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'rca_newsitem', 'related_school',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='related_school', null=True, to=orm['rca.SchoolPage']),
                      keep_default=False)

        # Adding field 'NewsItem.related_programme'
        db.add_column(u'rca_newsitem', 'related_programme',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='related_programme', null=True, to=orm['rca.ProgrammePage']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'rca_newsitemsidebarlink', (
            ...
            ('image', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['wagtailimages.Image'], blank=True)),
    ...
    models = {
        ...
        u'rca.newsitem': {
            ...
            u'page_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['wagtailcore.Page']", 'unique': 'True', 'primary_key': 'True'}),
            'related_programme': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'related_programme'", 'null': 'True', 'to': u"orm['rca.ProgrammePage']"}),
            'related_school': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'related_school'", 'null': 'True', 'to': u"orm['rca.SchoolPage']"}),
