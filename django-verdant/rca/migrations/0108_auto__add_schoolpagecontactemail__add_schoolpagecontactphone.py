...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SchoolPageContactEmail'
        db.create_table(u'rca_schoolpagecontactemail', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sort_order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('page', self.gf('django.db.models.fields.related.ForeignKey')(related_name='contact_email', to=orm['rca.SchoolPage'])),
            ('email_address', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'rca', ['SchoolPageContactEmail'])

        # Adding model 'SchoolPageContactPhone'
        db.create_table(u'rca_schoolpagecontactphone', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sort_order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('page', self.gf('django.db.models.fields.related.ForeignKey')(related_name='contact_phone', to=orm['rca.SchoolPage'])),
            ('phone_number', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'rca', ['SchoolPageContactPhone'])


    def backwards(self, orm):
        # Deleting model 'SchoolPageContactEmail'
        db.delete_table(u'rca_schoolpagecontactemail')

        # Deleting model 'SchoolPageContactPhone'
        db.delete_table(u'rca_schoolpagecontactphone')
