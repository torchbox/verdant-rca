...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'rca_innovationrcaproject', (
            ...
            ('description', self.gf('core.fields.RichTextField')()),
        ...
        db.create_table(u'rca_innovationrcaprojectcreator', (
            ...
            ('person', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['core.Page'])),
        ...
        db.create_table(u'rca_innovationrcaprojectcarouselitem', (
            ...
            ('link_page', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, on_delete=models.SET_NULL, to=orm['core.Page'])),
