...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'InnovationRCAProject'
        db.create_table(u'rca_innovationrcaproject', (
            ...
            ('ref', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ...
        db.send_create_signal(u'rca', ['InnovationRCAProject'])

        # Adding model 'InnovationRCAIndex'
        db.create_table(u'rca_innovationrcaindex', (
            (u'page_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['wagtailcore.Page'], unique=True, primary_key=True)),
            ('social_image', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage'])),
            ('social_text', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
        ...
        db.send_create_signal(u'rca', ['InnovationRCAIndex'])

        # Adding model 'InnovationRCAProjectLink'
        db.create_table(u'rca_innovationrcaprojectlink', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sort_order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('page', self.gf('cluster.fields.ParentalKey')(related_name='links', to=orm['rca.InnovationRCAProject'])),
            ('link', self.gf('django.db.models.fields.URLField')(max_length=200)),
            ('link_text', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'rca', ['InnovationRCAProjectLink'])

        # Adding model 'InnovationRCAProjectCreator'
        db.create_table(u'rca_innovationrcaprojectcreator', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sort_order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('page', self.gf('cluster.fields.ParentalKey')(related_name='creator', to=orm['rca.InnovationRCAProject'])),
        ...
        db.send_create_signal(u'rca', ['InnovationRCAProjectCreator'])

        # Adding model 'InnovationRCAProjectCarouselItem'
        db.create_table(u'rca_innovationrcaprojectcarouselitem', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sort_order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ...
            ('page', self.gf('cluster.fields.ParentalKey')(related_name='carousel_items', to=orm['rca.InnovationRCAProject'])),
        ))
        db.send_create_signal(u'rca', ['InnovationRCAProjectCarouselItem'])

        # Adding model 'InnovationRCAIndexAd'
        db.create_table(u'rca_innovationrcaindexad', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sort_order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('page', self.gf('cluster.fields.ParentalKey')(related_name='manual_adverts', to=orm['rca.InnovationRCAIndex'])),
            ('ad', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['rca.Advert'])),
        ))
        db.send_create_signal(u'rca', ['InnovationRCAIndexAd'])


    def backwards(self, orm):
        # Deleting model 'InnovationRCAProject'
        db.delete_table(u'rca_innovationrcaproject')

        # Deleting model 'InnovationRCAIndex'
        db.delete_table(u'rca_innovationrcaindex')

        # Deleting model 'InnovationRCAProjectLink'
        db.delete_table(u'rca_innovationrcaprojectlink')

        # Deleting model 'InnovationRCAProjectCreator'
        db.delete_table(u'rca_innovationrcaprojectcreator')

        # Deleting model 'InnovationRCAProjectCarouselItem'
        db.delete_table(u'rca_innovationrcaprojectcarouselitem')

        # Deleting model 'InnovationRCAIndexAd'
        db.delete_table(u'rca_innovationrcaindexad')
    ...
    models = {
        ...
        u'rca.studentpagesupervisor': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'page': ('cluster.fields.ParentalKey', [], {'related_name': "'supervisors'", 'to': u"orm['rca.StudentPage']"}),
            'sort_order': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
