...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HomePage.packery_blog'
        db.add_column(u'rca_homepage', 'packery_blog',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HomePage.packery_blog'
        db.delete_column(u'rca_homepage', 'packery_blog')
