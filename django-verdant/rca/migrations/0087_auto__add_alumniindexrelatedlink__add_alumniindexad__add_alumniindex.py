...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AlumniIndexRelatedLink'
        db.create_table(u'rca_alumniindexrelatedlink', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sort_order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('page', self.gf('django.db.models.fields.related.ForeignKey')(related_name='related_links', to=orm['rca.AlumniIndex'])),
        ...
        db.send_create_signal(u'rca', ['AlumniIndexRelatedLink'])

        # Adding model 'AlumniIndexAd'
        db.create_table(u'rca_alumniindexad', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sort_order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('page', self.gf('django.db.models.fields.related.ForeignKey')(related_name='manual_adverts', to=orm['rca.AlumniIndex'])),
            ('ad', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['rca.Advert'])),
        ))
        db.send_create_signal(u'rca', ['AlumniIndexAd'])

        # Adding model 'AlumniIndex'
        db.create_table(u'rca_alumniindex', (
        ...
        db.send_create_signal(u'rca', ['AlumniIndex'])


    def backwards(self, orm):
        # Deleting model 'AlumniIndexRelatedLink'
        db.delete_table(u'rca_alumniindexrelatedlink')

        # Deleting model 'AlumniIndexAd'
        db.delete_table(u'rca_alumniindexad')

        # Deleting model 'AlumniIndex'
        db.delete_table(u'rca_alumniindex')
