...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'EventItemRelatedArea.programme'
        db.delete_column(u'rca_eventitemrelatedarea', 'programme')

        # Adding field 'EventItemRelatedArea.area'
        db.add_column(u'rca_eventitemrelatedarea', 'area',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'EventItemRelatedArea.programme'
        db.add_column(u'rca_eventitemrelatedarea', 'programme',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Deleting field 'EventItemRelatedArea.area'
        db.delete_column(u'rca_eventitemrelatedarea', 'area')
