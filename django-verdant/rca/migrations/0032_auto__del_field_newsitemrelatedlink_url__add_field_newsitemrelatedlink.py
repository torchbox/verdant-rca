...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'NewsItemRelatedLink.url'
        db.delete_column(u'rca_newsitemrelatedlink', 'url')

        # Adding field 'NewsItemRelatedLink.link'
        db.add_column(u'rca_newsitemrelatedlink', 'link',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['wagtailcore.Page']),
                      keep_default=False)

        # Adding field 'StandardIndexRelatedLink.link_text'
        db.add_column(u'rca_standardindexrelatedlink', 'link_text',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)


        # Changing field 'StandardIndexRelatedLink.link'
        db.alter_column(u'rca_standardindexrelatedlink', 'link_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['wagtailcore.Page']))
        # Deleting field 'StandardPageRelatedLink.url'
        db.delete_column(u'rca_standardpagerelatedlink', 'url')

        # Adding field 'StandardPageRelatedLink.link'
        db.add_column(u'rca_standardpagerelatedlink', 'link',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['wagtailcore.Page']),
                      keep_default=False)

        # Deleting field 'ProgrammePageRelatedLink.url'
        db.delete_column(u'rca_programmepagerelatedlink', 'url')

        # Adding field 'ProgrammePageRelatedLink.link'
        db.add_column(u'rca_programmepagerelatedlink', 'link',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['wagtailcore.Page']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'NewsItemRelatedLink.url'
        raise RuntimeError("Cannot reverse this migration. 'NewsItemRelatedLink.url' and its values cannot be restored.")
        # Deleting field 'NewsItemRelatedLink.link'
        db.delete_column(u'rca_newsitemrelatedlink', 'link_id')

        # Deleting field 'StandardIndexRelatedLink.link_text'
        db.delete_column(u'rca_standardindexrelatedlink', 'link_text')


        # Changing field 'StandardIndexRelatedLink.link'
        db.alter_column(u'rca_standardindexrelatedlink', 'link_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rca.StandardPage']))

        # User chose to not deal with backwards NULL issues for 'StandardPageRelatedLink.url'
        raise RuntimeError("Cannot reverse this migration. 'StandardPageRelatedLink.url' and its values cannot be restored.")
        # Deleting field 'StandardPageRelatedLink.link'
        db.delete_column(u'rca_standardpagerelatedlink', 'link_id')


        # User chose to not deal with backwards NULL issues for 'ProgrammePageRelatedLink.url'
        raise RuntimeError("Cannot reverse this migration. 'ProgrammePageRelatedLink.url' and its values cannot be restored.")
        # Deleting field 'ProgrammePageRelatedLink.link'
        db.delete_column(u'rca_programmepagerelatedlink', 'link_id')
