...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'OEFormPage'
        db.create_table(u'rca_oeformpage', (
            ...
            ('form_id', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ...
            ('strapline', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('middle_column_body', self.gf('wagtail.wagtailcore.fields.RichTextField')(blank=True)),
        ...
        db.send_create_signal(u'rca', ['OEFormPage'])


    def backwards(self, orm):
        # Deleting model 'OEFormPage'
        db.delete_table(u'rca_oeformpage')
