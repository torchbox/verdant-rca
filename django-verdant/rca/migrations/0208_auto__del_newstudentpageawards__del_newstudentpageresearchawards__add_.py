...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Renaming model 'NewStudentPageAwards' to 'NewStudentPageAward'
        db.rename_table(u'rca_newstudentpageawards', u'rca_newstudentpageaward')
    ...
    def backwards(self, orm):
        # Renaming model 'NewStudentPageAward' to 'NewStudentPageAwards'
        db.rename_table(u'rca_newstudentpageaward', u'rca_newstudentpageawards')
    ...
    models = {
        ...
        u'rca.newstudentpage': {
            ...
            'research_work_location': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
