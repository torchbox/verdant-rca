...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RcaRendition.focal_point_key'
        db.add_column(u'rca_rcarendition', 'focal_point_key',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)

        # Adding field 'RcaImage.focal_point_x'
        db.add_column(u'rca_rcaimage', 'focal_point_x',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True),
                      keep_default=False)

        # Adding field 'RcaImage.focal_point_y'
        db.add_column(u'rca_rcaimage', 'focal_point_y',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True),
                      keep_default=False)

        # Adding field 'RcaImage.focal_point_width'
        db.add_column(u'rca_rcaimage', 'focal_point_width',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True),
                      keep_default=False)

        # Adding field 'RcaImage.focal_point_height'
        db.add_column(u'rca_rcaimage', 'focal_point_height',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RcaRendition.focal_point_key'
        db.delete_column(u'rca_rcarendition', 'focal_point_key')

        # Deleting field 'RcaImage.focal_point_x'
        db.delete_column(u'rca_rcaimage', 'focal_point_x')

        # Deleting field 'RcaImage.focal_point_y'
        db.delete_column(u'rca_rcaimage', 'focal_point_y')

        # Deleting field 'RcaImage.focal_point_width'
        db.delete_column(u'rca_rcaimage', 'focal_point_width')

        # Deleting field 'RcaImage.focal_point_height'
        db.delete_column(u'rca_rcaimage', 'focal_point_height')
