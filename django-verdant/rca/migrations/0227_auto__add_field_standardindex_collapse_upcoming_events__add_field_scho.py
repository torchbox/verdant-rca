...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StandardIndex.collapse_upcoming_events'
        db.add_column(u'rca_standardindex', 'collapse_upcoming_events',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'SchoolPage.collapse_upcoming_events'
        db.add_column(u'rca_schoolpage', 'collapse_upcoming_events',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ProgrammePage.collapse_upcoming_events'
        db.add_column(u'rca_programmepage', 'collapse_upcoming_events',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StandardIndex.collapse_upcoming_events'
        db.delete_column(u'rca_standardindex', 'collapse_upcoming_events')

        # Deleting field 'SchoolPage.collapse_upcoming_events'
        db.delete_column(u'rca_schoolpage', 'collapse_upcoming_events')

        # Deleting field 'ProgrammePage.collapse_upcoming_events'
        db.delete_column(u'rca_programmepage', 'collapse_upcoming_events')
