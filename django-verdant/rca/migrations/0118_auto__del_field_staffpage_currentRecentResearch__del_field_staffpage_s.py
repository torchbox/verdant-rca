...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'StaffPage.current_recent_research'
        db.add_column(u'rca_staffpage', 'current_recent_research',
                      self.gf('core.fields.RichTextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'StaffPage.supervised_student_other'
        db.add_column(u'rca_staffpage', 'supervised_student_other',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'StaffPage.current_recent_research'
        db.delete_column(u'rca_staffpage', 'current_recent_research')

        # Deleting field 'StaffPage.supervised_student_other'
        db.delete_column(u'rca_staffpage', 'supervised_student_other')
