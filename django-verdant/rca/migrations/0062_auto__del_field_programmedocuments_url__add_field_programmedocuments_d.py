...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ProgrammeDocuments.url'
        db.delete_column(u'rca_programmedocuments', 'url')

        # Adding field 'ProgrammeDocuments.document'
        db.add_column(u'rca_programmedocuments', 'document',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['verdantdocs.Document']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ProgrammeDocuments.url'
        db.add_column(u'rca_programmedocuments', 'url',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Deleting field 'ProgrammeDocuments.document'
        db.delete_column(u'rca_programmedocuments', 'document_id')
