...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'StandardIndexTeaser.url'
        db.delete_column(u'rca_standardindexteaser', 'url')

        # Adding field 'StandardIndexTeaser.link'
        db.add_column(u'rca_standardindexteaser', 'link',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['wagtailcore.Page']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'StandardIndexTeaser.url'
        db.add_column(u'rca_standardindexteaser', 'url',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Deleting field 'StandardIndexTeaser.link'
        db.delete_column(u'rca_standardindexteaser', 'link_id')
