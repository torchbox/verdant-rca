...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'StaffPage.school'
        raise RuntimeError("Cannot reverse this migration. 'StaffPage.school' and its values cannot be restored.")
