...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'InnovationRCAProject.ref'
        db.delete_column(u'rca_innovationrcaproject', 'ref')


    def backwards(self, orm):
        # Adding field 'InnovationRCAProject.ref'
        db.add_column(u'rca_innovationrcaproject', 'ref',
