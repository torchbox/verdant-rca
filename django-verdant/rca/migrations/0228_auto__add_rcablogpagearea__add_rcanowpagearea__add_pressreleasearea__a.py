...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RcaBlogPageArea'
        db.create_table(u'rca_rcablogpagearea', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('page', self.gf('modelcluster.fields.ParentalKey')(related_name='areas', to=orm['rca.RcaBlogPage'])),
            ('area', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'rca', ['RcaBlogPageArea'])

        # Adding model 'RcaNowPageArea'
        db.create_table(u'rca_rcanowpagearea', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('page', self.gf('modelcluster.fields.ParentalKey')(related_name='areas', to=orm['rca.RcaNowPage'])),
            ('area', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'rca', ['RcaNowPageArea'])

        # Adding model 'PressReleaseArea'
        db.create_table(u'rca_pressreleasearea', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('page', self.gf('modelcluster.fields.ParentalKey')(related_name='areas', to=orm['rca.PressRelease'])),
            ('area', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'rca', ['PressReleaseArea'])

        # Adding model 'NewsItemArea'
        db.create_table(u'rca_newsitemarea', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('page', self.gf('modelcluster.fields.ParentalKey')(related_name='areas', to=orm['rca.NewsItem'])),
            ('area', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'rca', ['NewsItemArea'])


    def backwards(self, orm):
        # Deleting model 'RcaBlogPageArea'
        db.delete_table(u'rca_rcablogpagearea')

        # Deleting model 'RcaNowPageArea'
        db.delete_table(u'rca_rcanowpagearea')

        # Deleting model 'PressReleaseArea'
        db.delete_table(u'rca_pressreleasearea')

        # Deleting model 'NewsItemArea'
        db.delete_table(u'rca_newsitemarea')
