...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'rca_pressreleaserelatedprogramme', (
            ...
            ('page', self.gf('modelcluster.fields.ParentalKey')(related_name='related_programmes', to=orm['rca.PressRelease'])),
        ...
        db.create_table(u'rca_pressreleaselink', (
            ...
            ('page', self.gf('modelcluster.fields.ParentalKey')(related_name='related_links', to=orm['rca.PressRelease'])),
        ...
        db.create_table(u'rca_pressreleaserelatedschool', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('page', self.gf('modelcluster.fields.ParentalKey')(related_name='related_schools', to=orm['rca.PressRelease'])),
        ...
        db.create_table(u'rca_pressreleasecarouselitem', (
            ...
            ('page', self.gf('modelcluster.fields.ParentalKey')(related_name='carousel_items', to=orm['rca.PressRelease'])),
        ))
