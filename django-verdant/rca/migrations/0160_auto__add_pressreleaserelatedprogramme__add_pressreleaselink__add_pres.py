...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PressReleaseRelatedProgramme'
        db.create_table(u'rca_pressreleaserelatedprogramme', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('page', self.gf('cluster.fields.ParentalKey')(related_name='related_programmes', to=orm['rca.PressRelease'])),
            ('programme', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
        ))
        db.send_create_signal(u'rca', ['PressReleaseRelatedProgramme'])

        # Adding model 'PressReleaseLink'
        db.create_table(u'rca_pressreleaselink', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sort_order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('page', self.gf('cluster.fields.ParentalKey')(related_name='related_links', to=orm['rca.PressRelease'])),
            ('link', self.gf('django.db.models.fields.URLField')(max_length=200)),
            ('link_text', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'rca', ['PressReleaseLink'])

        # Adding model 'PressReleaseRelatedSchool'
        db.create_table(u'rca_pressreleaserelatedschool', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('page', self.gf('cluster.fields.ParentalKey')(related_name='related_schools', to=orm['rca.PressRelease'])),
            ('school', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
        ))
        db.send_create_signal(u'rca', ['PressReleaseRelatedSchool'])

        # Adding model 'PressRelease'
        db.create_table(u'rca_pressrelease', (
        ...
        db.send_create_signal(u'rca', ['PressRelease'])

        # Adding model 'PressReleaseCarouselItem'
        db.create_table(u'rca_pressreleasecarouselitem', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sort_order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ...
            ('page', self.gf('cluster.fields.ParentalKey')(related_name='carousel_items', to=orm['rca.PressRelease'])),
        ))
        db.send_create_signal(u'rca', ['PressReleaseCarouselItem'])


    def backwards(self, orm):
        # Deleting model 'PressReleaseRelatedProgramme'
        db.delete_table(u'rca_pressreleaserelatedprogramme')

        # Deleting model 'PressReleaseLink'
        db.delete_table(u'rca_pressreleaselink')

        # Deleting model 'PressReleaseRelatedSchool'
        db.delete_table(u'rca_pressreleaserelatedschool')

        # Deleting model 'PressRelease'
        db.delete_table(u'rca_pressrelease')

        # Deleting model 'PressReleaseCarouselItem'
        db.delete_table(u'rca_pressreleasecarouselitem')
