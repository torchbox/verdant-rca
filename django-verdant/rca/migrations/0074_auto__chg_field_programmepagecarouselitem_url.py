...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProgrammePageCarouselItem.url'
        db.alter_column(u'rca_programmepagecarouselitem', 'url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'ProgrammePageCarouselItem.url'
        raise RuntimeError("Cannot reverse this migration. 'ProgrammePageCarouselItem.url' and its values cannot be restored.")
