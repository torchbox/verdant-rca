...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ProgrammePage.programme'
        db.delete_column(u'rca_programmepage', 'programme')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'ProgrammePage.programme'
        raise RuntimeError("Cannot reverse this migration. 'ProgrammePage.programme' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'ProgrammePage.programme'
        db.add_column(u'rca_programmepage', 'programme',
