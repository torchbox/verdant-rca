...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'NewsItemLink'
        db.create_table(u'rca_newsitemlink', (
        ...
        db.send_create_signal(u'rca', ['NewsItemLink'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'NewsItemLink'
        db.delete_table(u'rca_newsitemlink')
