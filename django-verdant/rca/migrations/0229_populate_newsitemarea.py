...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for newsitem in orm['rca.NewsItem'].objects.all():
            area_pk = None
            if newsitem.area:
                area, created = orm['rca.NewsItemArea'].objects.get_or_create(page=newsitem, area=newsitem.area)
                area_pk = area.pk

            # Update revisions
            for revision in newsitem.revisions.all():
                # Decode json
