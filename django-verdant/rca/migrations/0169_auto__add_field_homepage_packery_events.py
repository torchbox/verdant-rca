...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HomePage.packery_events'
        db.add_column(u'rca_homepage', 'packery_events',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HomePage.packery_events'
        db.delete_column(u'rca_homepage', 'packery_events')
