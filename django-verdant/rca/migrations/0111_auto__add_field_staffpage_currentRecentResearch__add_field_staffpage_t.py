...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StaffPage.currentRecentResearch'
        db.add_column(u'rca_staffpage', 'currentRecentResearch',
                      self.gf('wagtail.wagtailcore.fields.RichTextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'StaffPage.title_prefix'
        db.add_column(u'rca_staffpage', 'title_prefix',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'StaffPage.supervisedStudentOther'
        db.add_column(u'rca_staffpage', 'supervisedStudentOther',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'StudentPage.supervisor'
        db.add_column(u'rca_studentpage', 'supervisor',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['rca.StaffPage']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StaffPage.currentRecentResearch'
        db.delete_column(u'rca_staffpage', 'currentRecentResearch')

        # Deleting field 'StaffPage.title_prefix'
        db.delete_column(u'rca_staffpage', 'title_prefix')

        # Deleting field 'StaffPage.supervisedStudentOther'
        db.delete_column(u'rca_staffpage', 'supervisedStudentOther')

        # Deleting field 'StudentPage.supervisor'
        db.delete_column(u'rca_studentpage', 'supervisor_id')
