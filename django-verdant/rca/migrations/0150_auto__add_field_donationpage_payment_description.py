...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DonationPage.payment_description'
        db.add_column(u'rca_donationpage', 'payment_description',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DonationPage.payment_description'
        db.delete_column(u'rca_donationpage', 'payment_description')
