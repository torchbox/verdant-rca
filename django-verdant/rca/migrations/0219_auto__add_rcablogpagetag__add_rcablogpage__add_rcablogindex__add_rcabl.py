...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RcaBlogPageTag'
        db.create_table(u'rca_rcablogpagetag', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('tag', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'rca_rcablogpagetag_items', to=orm['taggit.Tag'])),
            ('content_object', self.gf('modelcluster.fields.ParentalKey')(related_name='tagged_items', to=orm['rca.RcaBlogPage'])),
        ))
        db.send_create_signal(u'rca', ['RcaBlogPageTag'])

        # Adding model 'RcaBlogPage'
        db.create_table(u'rca_rcablogpage', (
        ...
        db.send_create_signal(u'rca', ['RcaBlogPage'])

        # Adding model 'RcaBlogIndex'
        db.create_table(u'rca_rcablogindex', (
            (u'page_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['wagtailcore.Page'], unique=True, primary_key=True)),
            ('social_image', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage'])),
            ('social_text', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
        ...
        db.send_create_signal(u'rca', ['RcaBlogIndex'])

        # Adding model 'RcaBlogPagePageCarouselItem'
        db.create_table(u'rca_rcablogpagepagecarouselitem', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('page', self.gf('modelcluster.fields.ParentalKey')(related_name='carousel_items', to=orm['rca.RcaBlogPage'])),
        ))
        db.send_create_signal(u'rca', ['RcaBlogPagePageCarouselItem'])


    def backwards(self, orm):
        # Deleting model 'RcaBlogPageTag'
        db.delete_table(u'rca_rcablogpagetag')

        # Deleting model 'RcaBlogPage'
        db.delete_table(u'rca_rcablogpage')

        # Deleting model 'RcaBlogIndex'
        db.delete_table(u'rca_rcablogindex')

        # Deleting model 'RcaBlogPagePageCarouselItem'
        db.delete_table(u'rca_rcablogpagepagecarouselitem')
