...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'RcaNowIndex.feed_image'
        db.delete_column(u'rca_rcanowindex', 'feed_image_id')

        # Deleting field 'RcaNowIndex.show_in_menus'
        db.delete_column(u'rca_rcanowindex', 'show_in_menus')

        # Deleting field 'RcaNowIndex.seo_title'
        db.delete_column(u'rca_rcanowindex', 'seo_title')

        # Deleting field 'AlumniIndex.feed_image'
        db.delete_column(u'rca_alumniindex', 'feed_image_id')

        # Deleting field 'AlumniIndex.show_in_menus'
        db.delete_column(u'rca_alumniindex', 'show_in_menus')

        # Deleting field 'AlumniIndex.seo_title'
        db.delete_column(u'rca_alumniindex', 'seo_title')

        # Deleting field 'EventItem.feed_image'
        db.delete_column(u'rca_eventitem', 'feed_image_id')

        # Deleting field 'EventItem.seo_title'
        db.delete_column(u'rca_eventitem', 'seo_title')

        # Deleting field 'EventItem.show_in_menus'
        db.delete_column(u'rca_eventitem', 'show_in_menus')

        # Deleting field 'StandardPage.show_in_menus'
        db.delete_column(u'rca_standardpage', 'show_in_menus')

        # Deleting field 'StandardPage.feed_image'
        db.delete_column(u'rca_standardpage', 'feed_image_id')

        # Deleting field 'StandardPage.seo_title'
        db.delete_column(u'rca_standardpage', 'seo_title')

        # Deleting field 'JobsIndex.feed_image'
        db.delete_column(u'rca_jobsindex', 'feed_image_id')

        # Deleting field 'JobsIndex.show_in_menus'
        db.delete_column(u'rca_jobsindex', 'show_in_menus')

        # Deleting field 'JobsIndex.seo_title'
        db.delete_column(u'rca_jobsindex', 'seo_title')

        # Deleting field 'GalleryPage.feed_image'
        db.delete_column(u'rca_gallerypage', 'feed_image_id')

        # Deleting field 'GalleryPage.show_in_menus'
        db.delete_column(u'rca_gallerypage', 'show_in_menus')

        # Deleting field 'GalleryPage.seo_title'
        db.delete_column(u'rca_gallerypage', 'seo_title')

        # Deleting field 'ResearchItem.feed_image'
        db.delete_column(u'rca_researchitem', 'feed_image_id')

        # Deleting field 'ResearchItem.seo_title'
        db.delete_column(u'rca_researchitem', 'seo_title')

        # Deleting field 'ResearchItem.show_in_menus'
        db.delete_column(u'rca_researchitem', 'show_in_menus')

        # Deleting field 'NewsIndex.feed_image'
        db.delete_column(u'rca_newsindex', 'feed_image_id')

        # Deleting field 'NewsIndex.show_in_menus'
        db.delete_column(u'rca_newsindex', 'show_in_menus')

        # Deleting field 'NewsIndex.seo_title'
        db.delete_column(u'rca_newsindex', 'seo_title')

        # Deleting field 'JobPage.feed_image'
        db.delete_column(u'rca_jobpage', 'feed_image_id')

        # Deleting field 'JobPage.seo_title'
        db.delete_column(u'rca_jobpage', 'seo_title')

        # Deleting field 'JobPage.show_in_menus'
        db.delete_column(u'rca_jobpage', 'show_in_menus')

        # Deleting field 'ResearchInnovationPage.feed_image'
        db.delete_column(u'rca_researchinnovationpage', 'feed_image_id')

        # Deleting field 'ResearchInnovationPage.seo_title'
        db.delete_column(u'rca_researchinnovationpage', 'seo_title')
        ...
        # Deleting field 'HomePage.feed_image'
        db.delete_column(u'rca_homepage', 'feed_image_id')

        # Deleting field 'HomePage.seo_title'
        db.delete_column(u'rca_homepage', 'seo_title')

        # Deleting field 'ContactUsPage.feed_image'
        db.delete_column(u'rca_contactuspage', 'feed_image_id')

        # Deleting field 'ContactUsPage.seo_title'
        db.delete_column(u'rca_contactuspage', 'seo_title')

        # Deleting field 'ContactUsPage.show_in_menus'
        db.delete_column(u'rca_contactuspage', 'show_in_menus')

        # Deleting field 'StandardIndex.feed_image'
        db.delete_column(u'rca_standardindex', 'feed_image_id')

        # Deleting field 'StandardIndex.seo_title'
        db.delete_column(u'rca_standardindex', 'seo_title')

        # Deleting field 'StandardIndex.show_in_menus'
        db.delete_column(u'rca_standardindex', 'show_in_menus')

        # Deleting field 'AlumniPage.show_in_menus'
        db.delete_column(u'rca_alumnipage', 'show_in_menus')

        # Deleting field 'AlumniPage.feed_image'
        db.delete_column(u'rca_alumnipage', 'feed_image_id')

        # Deleting field 'AlumniPage.seo_title'
        db.delete_column(u'rca_alumnipage', 'seo_title')

        # Deleting field 'NewsItem.show_in_menus'
        db.delete_column(u'rca_newsitem', 'show_in_menus')

        # Deleting field 'NewsItem.feed_image'
        db.delete_column(u'rca_newsitem', 'feed_image_id')

        # Deleting field 'NewsItem.seo_title'
        db.delete_column(u'rca_newsitem', 'seo_title')

        # Deleting field 'SchoolPage.feed_image'
        db.delete_column(u'rca_schoolpage', 'feed_image_id')

        # Deleting field 'SchoolPage.seo_title'
        db.delete_column(u'rca_schoolpage', 'seo_title')
        ...
        # Deleting field 'RcaNowPage.feed_image'
        db.delete_column(u'rca_rcanowpage', 'feed_image_id')

        # Deleting field 'RcaNowPage.seo_title'
        db.delete_column(u'rca_rcanowpage', 'seo_title')

        # Deleting field 'StaffPage.feed_image'
        db.delete_column(u'rca_staffpage', 'feed_image_id')

        # Deleting field 'StaffPage.seo_title'
        db.delete_column(u'rca_staffpage', 'seo_title')

        # Deleting field 'StaffPage.show_in_menus'
        db.delete_column(u'rca_staffpage', 'show_in_menus')

        # Deleting field 'StaffIndex.feed_image'
        db.delete_column(u'rca_staffindex', 'feed_image_id')

        # Deleting field 'StaffIndex.show_in_menus'
        db.delete_column(u'rca_staffindex', 'show_in_menus')

        # Deleting field 'StaffIndex.seo_title'
        db.delete_column(u'rca_staffindex', 'seo_title')

        # Deleting field 'EventIndex.feed_image'
        db.delete_column(u'rca_eventindex', 'feed_image_id')

        # Deleting field 'EventIndex.show_in_menus'
        db.delete_column(u'rca_eventindex', 'show_in_menus')

        # Deleting field 'EventIndex.seo_title'
        db.delete_column(u'rca_eventindex', 'seo_title')

        # Deleting field 'StudentPage.feed_image'
        db.delete_column(u'rca_studentpage', 'feed_image_id')

        # Deleting field 'StudentPage.seo_title'
        db.delete_column(u'rca_studentpage', 'seo_title')

        # Deleting field 'StudentPage.show_in_menus'
        db.delete_column(u'rca_studentpage', 'show_in_menus')

        # Deleting field 'ProgrammePage.feed_image'
        db.delete_column(u'rca_programmepage', 'feed_image_id')

        # Deleting field 'ProgrammePage.seo_title'
        db.delete_column(u'rca_programmepage', 'seo_title')

        # Deleting field 'ProgrammePage.show_in_menus'
        db.delete_column(u'rca_programmepage', 'show_in_menus')

        # Deleting field 'CurrentResearchPage.feed_image'
        db.delete_column(u'rca_currentresearchpage', 'feed_image_id')

        # Deleting field 'CurrentResearchPage.show_in_menus'
        db.delete_column(u'rca_currentresearchpage', 'show_in_menus')

        # Deleting field 'CurrentResearchPage.seo_title'
        db.delete_column(u'rca_currentresearchpage', 'seo_title')


    def backwards(self, orm):
        # Adding field 'RcaNowIndex.feed_image'
        db.add_column(u'rca_rcanowindex', 'feed_image',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['rca.RcaImage'], blank=True),
                      keep_default=False)
        ...
        # Adding field 'RcaNowIndex.seo_title'
        db.add_column(u'rca_rcanowindex', 'seo_title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'AlumniIndex.feed_image'
        db.add_column(u'rca_alumniindex', 'feed_image',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['rca.RcaImage'], blank=True),
                      keep_default=False)

        # Adding field 'AlumniIndex.show_in_menus'
        db.add_column(u'rca_alumniindex', 'show_in_menus',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'AlumniIndex.seo_title'
        db.add_column(u'rca_alumniindex', 'seo_title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'EventItem.feed_image'
        db.add_column(u'rca_eventitem', 'feed_image',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['rca.RcaImage'], blank=True),
                      keep_default=False)

        # Adding field 'EventItem.seo_title'
        db.add_column(u'rca_eventitem', 'seo_title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'EventItem.show_in_menus'
        db.add_column(u'rca_eventitem', 'show_in_menus',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
        ...
        # Adding field 'StandardPage.feed_image'
        db.add_column(u'rca_standardpage', 'feed_image',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['rca.RcaImage'], blank=True),
                      keep_default=False)

        # Adding field 'StandardPage.seo_title'
        db.add_column(u'rca_standardpage', 'seo_title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'JobsIndex.feed_image'
        db.add_column(u'rca_jobsindex', 'feed_image',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['rca.RcaImage'], blank=True),
                      keep_default=False)
        ...
        # Adding field 'JobsIndex.seo_title'
        db.add_column(u'rca_jobsindex', 'seo_title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'GalleryPage.feed_image'
        db.add_column(u'rca_gallerypage', 'feed_image',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['rca.RcaImage'], blank=True),
                      keep_default=False)
        ...
        # Adding field 'GalleryPage.seo_title'
        db.add_column(u'rca_gallerypage', 'seo_title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'ResearchItem.feed_image'
        db.add_column(u'rca_researchitem', 'feed_image',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['rca.RcaImage'], blank=True),
                      keep_default=False)

        # Adding field 'ResearchItem.seo_title'
        db.add_column(u'rca_researchitem', 'seo_title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)
        ...
        # Adding field 'NewsIndex.feed_image'
        db.add_column(u'rca_newsindex', 'feed_image',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['rca.RcaImage'], blank=True),
                      keep_default=False)
        ...
        # Adding field 'NewsIndex.seo_title'
        db.add_column(u'rca_newsindex', 'seo_title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'JobPage.feed_image'
        db.add_column(u'rca_jobpage', 'feed_image',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['rca.RcaImage'], blank=True),
                      keep_default=False)

        # Adding field 'JobPage.seo_title'
        db.add_column(u'rca_jobpage', 'seo_title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)
        ...
        # Adding field 'ResearchInnovationPage.feed_image'
        db.add_column(u'rca_researchinnovationpage', 'feed_image',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['rca.RcaImage'], blank=True),
                      keep_default=False)

        # Adding field 'ResearchInnovationPage.seo_title'
        db.add_column(u'rca_researchinnovationpage', 'seo_title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)
        ...
        # Adding field 'HomePage.feed_image'
        db.add_column(u'rca_homepage', 'feed_image',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['rca.RcaImage'], blank=True),
                      keep_default=False)

        # Adding field 'HomePage.seo_title'
        db.add_column(u'rca_homepage', 'seo_title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'ContactUsPage.feed_image'
        db.add_column(u'rca_contactuspage', 'feed_image',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['rca.RcaImage'], blank=True),
                      keep_default=False)

        # Adding field 'ContactUsPage.seo_title'
        db.add_column(u'rca_contactuspage', 'seo_title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)
        ...
        # Adding field 'StandardIndex.feed_image'
        db.add_column(u'rca_standardindex', 'feed_image',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['rca.RcaImage'], blank=True),
                      keep_default=False)

        # Adding field 'StandardIndex.seo_title'
        db.add_column(u'rca_standardindex', 'seo_title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)
        ...
        # Adding field 'AlumniPage.show_in_menus'
        db.add_column(u'rca_alumnipage', 'show_in_menus',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'AlumniPage.feed_image'
        db.add_column(u'rca_alumnipage', 'feed_image',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['rca.RcaImage'], blank=True),
                      keep_default=False)

        # Adding field 'AlumniPage.seo_title'
        db.add_column(u'rca_alumnipage', 'seo_title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)
        ...
        # Adding field 'NewsItem.feed_image'
        db.add_column(u'rca_newsitem', 'feed_image',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['rca.RcaImage'], blank=True),
                      keep_default=False)

        # Adding field 'NewsItem.seo_title'
        db.add_column(u'rca_newsitem', 'seo_title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'SchoolPage.feed_image'
        db.add_column(u'rca_schoolpage', 'feed_image',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['rca.RcaImage'], blank=True),
                      keep_default=False)

        # Adding field 'SchoolPage.seo_title'
        db.add_column(u'rca_schoolpage', 'seo_title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)
        ...
        # Adding field 'RcaNowPage.feed_image'
        db.add_column(u'rca_rcanowpage', 'feed_image',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['rca.RcaImage'], blank=True),
                      keep_default=False)

        # Adding field 'RcaNowPage.seo_title'
        db.add_column(u'rca_rcanowpage', 'seo_title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'StaffPage.feed_image'
        db.add_column(u'rca_staffpage', 'feed_image',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['rca.RcaImage'], blank=True),
                      keep_default=False)

        # Adding field 'StaffPage.seo_title'
        db.add_column(u'rca_staffpage', 'seo_title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)
        ...
        # Adding field 'StaffIndex.feed_image'
        db.add_column(u'rca_staffindex', 'feed_image',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['rca.RcaImage'], blank=True),
                      keep_default=False)

        # Adding field 'StaffIndex.show_in_menus'
        db.add_column(u'rca_staffindex', 'show_in_menus',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'StaffIndex.seo_title'
        db.add_column(u'rca_staffindex', 'seo_title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'EventIndex.feed_image'
        db.add_column(u'rca_eventindex', 'feed_image',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['rca.RcaImage'], blank=True),
                      keep_default=False)

        # Adding field 'EventIndex.show_in_menus'
        db.add_column(u'rca_eventindex', 'show_in_menus',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'EventIndex.seo_title'
        db.add_column(u'rca_eventindex', 'seo_title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'StudentPage.feed_image'
        db.add_column(u'rca_studentpage', 'feed_image',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['rca.RcaImage'], blank=True),
                      keep_default=False)

        # Adding field 'StudentPage.seo_title'
        db.add_column(u'rca_studentpage', 'seo_title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)
        ...
        # Adding field 'ProgrammePage.feed_image'
        db.add_column(u'rca_programmepage', 'feed_image',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['rca.RcaImage'], blank=True),
                      keep_default=False)

        # Adding field 'ProgrammePage.seo_title'
        db.add_column(u'rca_programmepage', 'seo_title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)
        ...
        # Adding field 'CurrentResearchPage.feed_image'
        db.add_column(u'rca_currentresearchpage', 'feed_image',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['rca.RcaImage'], blank=True),
                      keep_default=False)
        ...
        # Adding field 'CurrentResearchPage.seo_title'
        db.add_column(u'rca_currentresearchpage', 'seo_title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'wagtailcore.page': {
            ...
            'seo_title_core': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'show_in_menus_core': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        u'rca.staffpage': {
            ...
            'currentRecentResearch': ('wagtail.wagtailcore.fields.RichTextField', [], {'blank': 'True'}),
