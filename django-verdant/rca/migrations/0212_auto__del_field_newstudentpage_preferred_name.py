...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'NewStudentPage.preferred_name'
        db.delete_column(u'rca_newstudentpage', 'preferred_name')


    def backwards(self, orm):
        # Adding field 'NewStudentPage.preferred_name'
        db.add_column(u'rca_newstudentpage', 'preferred_name',
