...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'StudentPageContactsWebsite.website'
        db.alter_column(u'rca_studentpagecontactswebsite', 'website', self.gf('django.db.models.fields.URLField')(max_length=255))

        # Changing field 'StudentPageContactsPhone.phone'
        db.alter_column(u'rca_studentpagecontactsphone', 'phone', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'StudentPageContactsWebsite.website'
        db.alter_column(u'rca_studentpagecontactswebsite', 'website', self.gf('django.db.models.fields.EmailField')(max_length=255))

        # Changing field 'StudentPageContactsPhone.phone'
        db.alter_column(u'rca_studentpagecontactsphone', 'phone', self.gf('django.db.models.fields.EmailField')(max_length=255))
