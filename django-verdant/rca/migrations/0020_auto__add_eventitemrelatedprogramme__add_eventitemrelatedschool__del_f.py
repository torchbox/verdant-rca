...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EventItemRelatedProgramme'
        db.create_table(u'rca_eventitemrelatedprogramme', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('page', self.gf('django.db.models.fields.related.ForeignKey')(related_name='related_programmes', to=orm['rca.EventItem'])),
            ('programme', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
        ))
        db.send_create_signal(u'rca', ['EventItemRelatedProgramme'])

        # Adding model 'EventItemRelatedSchool'
        db.create_table(u'rca_eventitemrelatedschool', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('page', self.gf('django.db.models.fields.related.ForeignKey')(related_name='related_schools', to=orm['rca.EventItem'])),
            ('school', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
        ))
        db.send_create_signal(u'rca', ['EventItemRelatedSchool'])

        # Deleting field 'NewsItem.related_programme'
        db.delete_column(u'rca_newsitem', 'related_programme_id')

        # Deleting field 'NewsItem.related_school'
        db.delete_column(u'rca_newsitem', 'related_school_id')

        # Deleting field 'EventItem.related_school'
        db.delete_column(u'rca_eventitem', 'related_school_id')

        # Deleting field 'EventItem.related_programme'
        db.delete_column(u'rca_eventitem', 'related_programme_id')


    def backwards(self, orm):
        # Deleting model 'EventItemRelatedProgramme'
        db.delete_table(u'rca_eventitemrelatedprogramme')

        # Deleting model 'EventItemRelatedSchool'
        db.delete_table(u'rca_eventitemrelatedschool')

        # Adding field 'NewsItem.related_programme'
        db.add_column(u'rca_newsitem', 'related_programme',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='news_item', null=True, to=orm['rca.ProgrammePage'], blank=True),
                      keep_default=False)

        # Adding field 'NewsItem.related_school'
        db.add_column(u'rca_newsitem', 'related_school',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='news_item', null=True, to=orm['rca.SchoolPage'], blank=True),
                      keep_default=False)

        # Adding field 'EventItem.related_school'
        db.add_column(u'rca_eventitem', 'related_school',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='event_item', null=True, to=orm['rca.SchoolPage'], blank=True),
                      keep_default=False)

        # Adding field 'EventItem.related_programme'
        db.add_column(u'rca_eventitem', 'related_programme',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='event_item', null=True, to=orm['rca.ProgrammePage'], blank=True),
                      keep_default=False)
