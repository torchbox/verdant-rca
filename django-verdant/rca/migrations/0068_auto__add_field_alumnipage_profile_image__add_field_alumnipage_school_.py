...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AlumniPage.profile_image'
        db.add_column(u'rca_alumnipage', 'profile_image',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['rca.RcaImage']),
                      keep_default=False)

        # Adding field 'AlumniPage.school'
        db.add_column(u'rca_alumnipage', 'school',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Adding field 'AlumniPage.programme'
        db.add_column(u'rca_alumnipage', 'programme',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Adding field 'AlumniPage.year'
        db.add_column(u'rca_alumnipage', 'year',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=4, blank=True),
                      keep_default=False)

        # Adding field 'AlumniPage.intro'
        db.add_column(u'rca_alumnipage', 'intro',
                      self.gf('wagtail.wagtailcore.fields.RichTextField')(default=''),
                      keep_default=False)

        # Adding field 'AlumniPage.biography'
        db.add_column(u'rca_alumnipage', 'biography',
                      self.gf('wagtail.wagtailcore.fields.RichTextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AlumniPage.profile_image'
        db.delete_column(u'rca_alumnipage', 'profile_image_id')

        # Deleting field 'AlumniPage.school'
        db.delete_column(u'rca_alumnipage', 'school')

        # Deleting field 'AlumniPage.programme'
        db.delete_column(u'rca_alumnipage', 'programme')

        # Deleting field 'AlumniPage.year'
        db.delete_column(u'rca_alumnipage', 'year')

        # Deleting field 'AlumniPage.intro'
        db.delete_column(u'rca_alumnipage', 'intro')

        # Deleting field 'AlumniPage.biography'
        db.delete_column(u'rca_alumnipage', 'biography')
