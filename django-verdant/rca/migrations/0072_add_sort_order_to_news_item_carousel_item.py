...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NewsItemCarouselItem.sort_order'
        db.add_column(u'rca_newsitemcarouselitem', 'sort_order',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NewsItemCarouselItem.sort_order'
        db.delete_column(u'rca_newsitemcarouselitem', 'sort_order')
