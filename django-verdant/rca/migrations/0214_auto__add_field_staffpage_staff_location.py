...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StaffPage.staff_location'
        db.add_column(u'rca_staffpage', 'staff_location',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StaffPage.staff_location'
        db.delete_column(u'rca_staffpage', 'staff_location')
