...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AlumniIndex.body'
        db.add_column(u'rca_alumniindex', 'body',
                      self.gf('wagtail.wagtailcore.fields.RichTextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'GalleryPage.body'
        db.add_column(u'rca_gallerypage', 'body',
                      self.gf('wagtail.wagtailcore.fields.RichTextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'EventIndex.body'
        db.add_column(u'rca_eventindex', 'body',
                      self.gf('wagtail.wagtailcore.fields.RichTextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'TalksIndex.body'
        db.add_column(u'rca_talksindex', 'body',
                      self.gf('wagtail.wagtailcore.fields.RichTextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'PressReleaseIndex.body'
        db.add_column(u'rca_pressreleaseindex', 'body',
                      self.gf('wagtail.wagtailcore.fields.RichTextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'ReviewsIndex.body'
        db.add_column(u'rca_reviewsindex', 'body',
                      self.gf('wagtail.wagtailcore.fields.RichTextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'StaffIndex.body'
        db.add_column(u'rca_staffindex', 'body',
                      self.gf('wagtail.wagtailcore.fields.RichTextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'RcaNowIndex.body'
        db.add_column(u'rca_rcanowindex', 'body',
                      self.gf('wagtail.wagtailcore.fields.RichTextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AlumniIndex.body'
        db.delete_column(u'rca_alumniindex', 'body')

        # Deleting field 'GalleryPage.body'
        db.delete_column(u'rca_gallerypage', 'body')

        # Deleting field 'EventIndex.body'
        db.delete_column(u'rca_eventindex', 'body')

        # Deleting field 'TalksIndex.body'
        db.delete_column(u'rca_talksindex', 'body')

        # Deleting field 'PressReleaseIndex.body'
        db.delete_column(u'rca_pressreleaseindex', 'body')

        # Deleting field 'ReviewsIndex.body'
        db.delete_column(u'rca_reviewsindex', 'body')

        # Deleting field 'StaffIndex.body'
        db.delete_column(u'rca_staffindex', 'body')

        # Deleting field 'RcaNowIndex.body'
        db.delete_column(u'rca_rcanowindex', 'body')
