...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StandardIndex.show_events_feed'
        db.add_column(u'rca_standardindex', 'show_events_feed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'StandardIndex.events_feed_area'
        db.add_column(u'rca_standardindex', 'events_feed_area',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StandardIndex.show_events_feed'
        db.delete_column(u'rca_standardindex', 'show_events_feed')

        # Deleting field 'StandardIndex.events_feed_area'
        db.delete_column(u'rca_standardindex', 'events_feed_area')
