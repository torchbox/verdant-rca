...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ProgrammePageCarouselItem.url'
        db.delete_column(u'rca_programmepagecarouselitem', 'url')

        # Deleting field 'ProgrammePageCarouselItem.text'
        db.delete_column(u'rca_programmepagecarouselitem', 'text')

        # Adding field 'ProgrammePageCarouselItem.overlay_text'
        db.add_column(u'rca_programmepagecarouselitem', 'overlay_text',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'ProgrammePageCarouselItem.link'
        db.add_column(u'rca_programmepagecarouselitem', 'link',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'ProgrammePageCarouselItem.embedly_url'
        db.add_column(u'rca_programmepagecarouselitem', 'embedly_url',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'ProgrammePageCarouselItem.poster_image'
        db.add_column(u'rca_programmepagecarouselitem', 'poster_image',
        ...
        db.alter_column(u'rca_programmepagecarouselitem', 'image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rca.RcaImage']))

    def backwards(self, orm):
        # Adding field 'ProgrammePageCarouselItem.url'
        db.add_column(u'rca_programmepagecarouselitem', 'url',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ProgrammePageCarouselItem.text'
        db.add_column(u'rca_programmepagecarouselitem', 'text',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Deleting field 'ProgrammePageCarouselItem.overlay_text'
        db.delete_column(u'rca_programmepagecarouselitem', 'overlay_text')

        # Deleting field 'ProgrammePageCarouselItem.link'
        db.delete_column(u'rca_programmepagecarouselitem', 'link')

        # Deleting field 'ProgrammePageCarouselItem.embedly_url'
        db.delete_column(u'rca_programmepagecarouselitem', 'embedly_url')

        # Deleting field 'ProgrammePageCarouselItem.poster_image'
        db.delete_column(u'rca_programmepagecarouselitem', 'poster_image_id')
