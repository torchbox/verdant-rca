...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ReachOutRCAProject.date'
        db.delete_column(u'rca_reachoutrcaproject', 'date')

        # Adding field 'ReachOutRCAProject.year'
        db.add_column(u'rca_reachoutrcaproject', 'year',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'ReachOutRCAProject.date'
        raise RuntimeError("Cannot reverse this migration. 'ReachOutRCAProject.date' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'ReachOutRCAProject.date'
        db.add_column(u'rca_reachoutrcaproject', 'date',
                      self.gf('django.db.models.fields.DateField')(),
                      keep_default=False)

        # Deleting field 'ReachOutRCAProject.year'
        db.delete_column(u'rca_reachoutrcaproject', 'year')
