...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'StudentPage.degree_qualification'
        db.add_column(u'rca_studentpage', 'degree_qualification',
                      self.gf('django.db.models.fields.CharField')(default='MA', max_length=255),
                      keep_default=False)

        # Adding field 'StudentPage.degree_subject'
        db.add_column(u'rca_studentpage', 'degree_subject',
                      self.gf('django.db.models.fields.CharField')(default='Architecture', max_length=255),
                      keep_default=False)

        # Adding field 'StudentPage.degree_year'
        db.add_column(u'rca_studentpage', 'degree_year',
                      self.gf('django.db.models.fields.IntegerField')(default=2013, max_length=255),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'rca_studentpage', 'current_degree',
                      self.gf('django.db.models.fields.CharField')(default='MA Architecture 2013', max_length=255),
                      keep_default=False)

        # Deleting field 'StudentPage.degree_qualification'
        db.delete_column(u'rca_studentpage', 'degree_qualification')

        # Deleting field 'StudentPage.degree_subject'
        db.delete_column(u'rca_studentpage', 'degree_subject')

        # Deleting field 'StudentPage.degree_year'
        db.delete_column(u'rca_studentpage', 'degree_year')
