...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ResearchInnovationPageCarouselItem'
        db.create_table(u'rca_researchinnovationpagecarouselitem', (
            ...
            ('page', self.gf('django.db.models.fields.related.ForeignKey')(related_name='carousel_items', to=orm['rca.ResearchInnovationPage'])),
        ))
        db.send_create_signal(u'rca', ['ResearchInnovationPageCarouselItem'])

        # Adding model 'ResearchInnovationPageContactPhone'
        db.create_table(u'rca_researchinnovationpagecontactphone', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('page', self.gf('django.db.models.fields.related.ForeignKey')(related_name='contact_phone', to=orm['rca.ResearchInnovationPage'])),
            ('phone_number', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'rca', ['ResearchInnovationPageContactPhone'])

        # Adding model 'ResearchInnovationPageCurrentResearch'
        db.create_table(u'rca_researchinnovationpagecurrentresearch', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('page', self.gf('django.db.models.fields.related.ForeignKey')(related_name='current_research', to=orm['rca.ResearchInnovationPage'])),
            ('link', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['wagtailcore.Page'])),
        ))
        db.send_create_signal(u'rca', ['ResearchInnovationPageCurrentResearch'])

        # Adding model 'ResearchInnovationPageContactEmail'
        db.create_table(u'rca_researchinnovationpagecontactemail', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('page', self.gf('django.db.models.fields.related.ForeignKey')(related_name='contact_email', to=orm['rca.ResearchInnovationPage'])),
            ('email_address', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'rca', ['ResearchInnovationPageContactEmail'])

        # Adding model 'ResearchInnovationPageRelatedLink'
        db.create_table(u'rca_researchinnovationpagerelatedlink', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('page', self.gf('django.db.models.fields.related.ForeignKey')(related_name='related_links', to=orm['rca.ResearchInnovationPage'])),
            ('link', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['wagtailcore.Page'])),
            ('link_text', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'rca', ['ResearchInnovationPageRelatedLink'])

        # Adding model 'ResearchInnovationPageTeaser'
        db.create_table(u'rca_researchinnovationpageteaser', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('page', self.gf('django.db.models.fields.related.ForeignKey')(related_name='teasers', to=orm['rca.ResearchInnovationPage'])),
            ('image', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['rca.RcaImage'])),
            ('url', self.gf('django.db.models.fields.URLField')(max_length=200, blank=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('text', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
        ))
        db.send_create_signal(u'rca', ['ResearchInnovationPageTeaser'])

        # Adding field 'ResearchInnovationPage.intro'
        db.add_column(u'rca_researchinnovationpage', 'intro',
                      self.gf('wagtail.wagtailcore.fields.RichTextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'ResearchInnovationPage.intro_link'
        db.add_column(u'rca_researchinnovationpage', 'intro_link',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['wagtailcore.Page']),
                      keep_default=False)

        # Adding field 'ResearchInnovationPage.teasers_title'
        db.add_column(u'rca_researchinnovationpage', 'teasers_title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'ResearchInnovationPage.twitter_feed'
        db.add_column(u'rca_researchinnovationpage', 'twitter_feed',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'ResearchInnovationPage.background_image'
        db.add_column(u'rca_researchinnovationpage', 'background_image',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['rca.RcaImage']),
                      keep_default=False)

        # Adding field 'ResearchInnovationPage.contact_title'
        db.add_column(u'rca_researchinnovationpage', 'contact_title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'ResearchInnovationPage.contact_address'
        db.add_column(u'rca_researchinnovationpage', 'contact_address',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'ResearchInnovationPage.contact_link'
        db.add_column(u'rca_researchinnovationpage', 'contact_link',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'ResearchInnovationPage.contact_link_text'
        db.add_column(u'rca_researchinnovationpage', 'contact_link_text',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'ResearchInnovationPage.news_carousel_area'
        db.add_column(u'rca_researchinnovationpage', 'news_carousel_area',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'ResearchInnovationPageCarouselItem'
        db.delete_table(u'rca_researchinnovationpagecarouselitem')

        # Deleting model 'ResearchInnovationPageContactPhone'
        db.delete_table(u'rca_researchinnovationpagecontactphone')

        # Deleting model 'ResearchInnovationPageCurrentResearch'
        db.delete_table(u'rca_researchinnovationpagecurrentresearch')

        # Deleting model 'ResearchInnovationPageContactEmail'
        db.delete_table(u'rca_researchinnovationpagecontactemail')

        # Deleting model 'ResearchInnovationPageRelatedLink'
        db.delete_table(u'rca_researchinnovationpagerelatedlink')

        # Deleting model 'ResearchInnovationPageTeaser'
        db.delete_table(u'rca_researchinnovationpageteaser')

        # Deleting field 'ResearchInnovationPage.intro'
        db.delete_column(u'rca_researchinnovationpage', 'intro')

        # Deleting field 'ResearchInnovationPage.intro_link'
        db.delete_column(u'rca_researchinnovationpage', 'intro_link_id')

        # Deleting field 'ResearchInnovationPage.teasers_title'
        db.delete_column(u'rca_researchinnovationpage', 'teasers_title')

        # Deleting field 'ResearchInnovationPage.twitter_feed'
        db.delete_column(u'rca_researchinnovationpage', 'twitter_feed')

        # Deleting field 'ResearchInnovationPage.background_image'
        db.delete_column(u'rca_researchinnovationpage', 'background_image_id')

        # Deleting field 'ResearchInnovationPage.contact_title'
        db.delete_column(u'rca_researchinnovationpage', 'contact_title')

        # Deleting field 'ResearchInnovationPage.contact_address'
        db.delete_column(u'rca_researchinnovationpage', 'contact_address')

        # Deleting field 'ResearchInnovationPage.contact_link'
        db.delete_column(u'rca_researchinnovationpage', 'contact_link')

        # Deleting field 'ResearchInnovationPage.contact_link_text'
        db.delete_column(u'rca_researchinnovationpage', 'contact_link_text')

        # Deleting field 'ResearchInnovationPage.news_carousel_area'
        db.delete_column(u'rca_researchinnovationpage', 'news_carousel_area')
    ...
    models = {
        ...
        u'rca.studentpage': {
            ...
            'current_degree': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            u'page_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['wagtailcore.Page']", 'unique': 'True', 'primary_key': 'True'}),
            ...
            'social_image': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'to': u"orm['rca.RcaImage']"}),
            'social_text': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'statement': ('wagtail.wagtailcore.fields.RichTextField', [], {}),
            'twitter_feed': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
