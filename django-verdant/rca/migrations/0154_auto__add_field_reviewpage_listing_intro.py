...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ReviewPage.listing_intro'
        db.add_column(u'rca_reviewpage', 'listing_intro',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ReviewPage.listing_intro'
        db.delete_column(u'rca_reviewpage', 'listing_intro')
