...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HomePage.twitter_feed'
        db.add_column(u'rca_homepage', 'twitter_feed',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HomePage.twitter_feed'
        db.delete_column(u'rca_homepage', 'twitter_feed')
