...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProgrammePage.head_of_programme_second'
        db.add_column(u'rca_programmepage', 'head_of_programme_second',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, on_delete=models.SET_NULL, to=orm['rca.StaffPage']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProgrammePage.head_of_programme_second'
        db.delete_column(u'rca_programmepage', 'head_of_programme_second_id')
