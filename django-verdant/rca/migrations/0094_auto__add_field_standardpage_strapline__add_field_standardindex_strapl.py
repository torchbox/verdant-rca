...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StandardPage.strapline'
        db.add_column(u'rca_standardpage', 'strapline',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'StandardIndex.strapline'
        db.add_column(u'rca_standardindex', 'strapline',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StandardPage.strapline'
        db.delete_column(u'rca_standardpage', 'strapline')

        # Deleting field 'StandardIndex.strapline'
        db.delete_column(u'rca_standardindex', 'strapline')
