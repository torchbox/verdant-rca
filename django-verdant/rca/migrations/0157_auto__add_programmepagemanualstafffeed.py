...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProgrammePageManualStaffFeed'
        db.create_table(u'rca_programmepagemanualstafffeed', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sort_order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('page', self.gf('cluster.fields.ParentalKey')(related_name='manual_staff_feed', to=orm['rca.ProgrammePage'])),
        ...
        db.send_create_signal(u'rca', ['ProgrammePageManualStaffFeed'])


    def backwards(self, orm):
        # Deleting model 'ProgrammePageManualStaffFeed'
        db.delete_table(u'rca_programmepagemanualstafffeed')
