...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EventItemScreen'
        db.create_table(u'rca_eventitemscreen', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('page', self.gf('cluster.fields.ParentalKey')(related_name='screens', to=orm['rca.EventItem'])),
            ('screen', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
        ))
        db.send_create_signal(u'rca', ['EventItemScreen'])

        # Adding field 'EventItem.special_event'
        db.add_column(u'rca_eventitem', 'special_event',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'EventItemScreen'
        db.delete_table(u'rca_eventitemscreen')

        # Deleting field 'EventItem.special_event'
        db.delete_column(u'rca_eventitem', 'special_event')
