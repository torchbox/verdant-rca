...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StudentPage.graduation_year'
        db.add_column(u'rca_studentpage', 'graduation_year',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=4, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StudentPage.graduation_year'
        db.delete_column(u'rca_studentpage', 'graduation_year')
