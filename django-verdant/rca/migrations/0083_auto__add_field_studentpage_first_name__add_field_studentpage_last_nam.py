...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StudentPage.first_name'
        db.add_column(u'rca_studentpage', 'first_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Adding field 'StudentPage.last_name'
        db.add_column(u'rca_studentpage', 'last_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Adding field 'SchoolPage.school'
        db.add_column(u'rca_schoolpage', 'school',
                      self.gf('django.db.models.fields.CharField')(default='schoolofarchitecture', max_length=255),
                      keep_default=False)

        # Adding field 'RcaNowPage.date'
        db.add_column(u'rca_rcanowpage', 'date',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 10, 9, 0, 0)),
                      keep_default=False)

        # Adding field 'StaffPage.first_name'
        db.add_column(u'rca_staffpage', 'first_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Adding field 'StaffPage.last_name'
        db.add_column(u'rca_staffpage', 'last_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StudentPage.first_name'
        db.delete_column(u'rca_studentpage', 'first_name')

        # Deleting field 'StudentPage.last_name'
        db.delete_column(u'rca_studentpage', 'last_name')

        # Deleting field 'SchoolPage.school'
        db.delete_column(u'rca_schoolpage', 'school')

        # Deleting field 'RcaNowPage.date'
        db.delete_column(u'rca_rcanowpage', 'date')

        # Deleting field 'StaffPage.first_name'
        db.delete_column(u'rca_staffpage', 'first_name')

        # Deleting field 'StaffPage.last_name'
        db.delete_column(u'rca_staffpage', 'last_name')
