...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'StudentPageSupervisor'
        db.create_table(u'rca_studentpagesupervisor', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sort_order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('page', self.gf('cluster.fields.ParentalKey')(related_name='supervisors', to=orm['rca.StudentPage'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
        ))
        db.send_create_signal(u'rca', ['StudentPageSupervisor'])


    def backwards(self, orm):
        # Deleting model 'StudentPageSupervisor'
        db.delete_table(u'rca_studentpagesupervisor')
