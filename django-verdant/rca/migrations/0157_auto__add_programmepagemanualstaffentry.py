...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProgrammePageManualStaffEntry'
        db.create_table(u'rca_programmepagemanualstaffentry', (
        ...
        db.send_create_signal(u'rca', ['ProgrammePageManualStaffEntry'])


    def backwards(self, orm):
        # Deleting model 'ProgrammePageManualStaffEntry'
        db.delete_table(u'rca_programmepagemanualstaffentry')
    ...
    models = {
        ...
        u'rca.programmepagemanualstaffentry': {
            'Meta': {'ordering': "['sort_order']", 'object_name': 'ProgrammePageManualStaffEntry'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
