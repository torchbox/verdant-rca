...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StaffPage.rca_content_id'
        db.add_column(u'rca_staffpage', 'rca_content_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StaffPage.rca_content_id'
        db.delete_column(u'rca_staffpage', 'rca_content_id')
