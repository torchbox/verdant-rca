...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ReachOutRCAThemes.participant'
        db.delete_column(u'rca_reachoutrcathemes', 'participant')

        # Adding field 'ReachOutRCAThemes.theme'
        db.add_column(u'rca_reachoutrcathemes', 'theme',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'ReachOutRCAThemes.participant'
        raise RuntimeError("Cannot reverse this migration. 'ReachOutRCAThemes.participant' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'ReachOutRCAThemes.participant'
        db.add_column(u'rca_reachoutrcathemes', 'participant',
                      self.gf('django.db.models.fields.CharField')(max_length=255),
                      keep_default=False)

        # Deleting field 'ReachOutRCAThemes.theme'
        db.delete_column(u'rca_reachoutrcathemes', 'theme')
