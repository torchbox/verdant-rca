...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'RcaRendition', fields ['image', 'filter']
        db.delete_unique(u'rca_rcarendition', ['image_id', 'filter_id'])

        # Adding unique constraint on 'RcaRendition', fields ['image', 'filter', 'focal_point_key']
        db.create_unique(u'rca_rcarendition', ['image_id', 'filter_id', 'focal_point_key'])


    def backwards(self, orm):
        # Removing unique constraint on 'RcaRendition', fields ['image', 'filter', 'focal_point_key']
        db.delete_unique(u'rca_rcarendition', ['image_id', 'filter_id', 'focal_point_key'])

        # Adding unique constraint on 'RcaRendition', fields ['image', 'filter']
        db.create_unique(u'rca_rcarendition', ['image_id', 'filter_id'])
