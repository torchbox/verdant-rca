...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'EventItemDatesTimes.time_from'
        db.delete_column(u'rca_eventitemdatestimes', 'time_from')

        # Deleting field 'EventItemDatesTimes.time_to'
        db.delete_column(u'rca_eventitemdatestimes', 'time_to')

        # Loop through event items and remove these fields from all past revisions
        for eventitem in orm['rca.EventItem'].objects.all():
            for revision in eventitem.revisions.all():
                ...
                for date_time in revision_data["dates_times"]:
                    del date_time["time_from"]
                    del date_time["time_to"]
    ...
    def backwards(self, orm):
        # Adding field 'EventItemDatesTimes.time_from'
        db.add_column(u'rca_eventitemdatestimes', 'time_from',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'EventItemDatesTimes.time_to'
        db.add_column(u'rca_eventitemdatestimes', 'time_to',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)
