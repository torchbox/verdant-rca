...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StandardIndexTeaser.external_link'
        db.add_column(u'rca_standardindexteaser', 'external_link',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StandardIndexTeaser.external_link'
        db.delete_column(u'rca_standardindexteaser', 'external_link')
