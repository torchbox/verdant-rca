...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'NewStudentPageAwards'
        db.create_table(u'rca_newstudentpageawards', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sort_order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('page', self.gf('modelcluster.fields.ParentalKey')(related_name='awards', to=orm['rca.NewStudentPage'])),
            ('award', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
        ))
        db.send_create_signal(u'rca', ['NewStudentPageAwards'])

        # Deleting field 'NewStudentPage.postgrad_degree_year'
        db.delete_column(u'rca_newstudentpage', 'postgrad_degree_year')

        # Adding field 'NewStudentPage.postgrad_graduation_year'
        db.add_column(u'rca_newstudentpage', 'postgrad_graduation_year',
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'NewStudentPageAwards'
        db.delete_table(u'rca_newstudentpageawards')

        # Adding field 'NewStudentPage.postgrad_degree_year'
        db.add_column(u'rca_newstudentpage', 'postgrad_degree_year',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=4, blank=True),
                      keep_default=False)

        # Deleting field 'NewStudentPage.postgrad_graduation_year'
        db.delete_column(u'rca_newstudentpage', 'postgrad_graduation_year')
    ...
    models = {
        ...
        u'rca.newstudentpage': {
            ...
            u'page_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['wagtailcore.Page']", 'unique': 'True', 'primary_key': 'True'}),
            'postgrad_graduation_year': ('django.db.models.fields.CharField', [], {'max_length': '4', 'blank': 'True'}),
