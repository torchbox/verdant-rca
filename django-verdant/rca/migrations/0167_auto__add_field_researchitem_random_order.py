...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ResearchItem.random_order'
        db.add_column(u'rca_researchitem', 'random_order',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ResearchItem.random_order'
        db.delete_column(u'rca_researchitem', 'random_order')
