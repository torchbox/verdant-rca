...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StudentPage.specialism'
        db.add_column(u'rca_studentpage', 'specialism',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StudentPage.specialism'
        db.delete_column(u'rca_studentpage', 'specialism')
