...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'ProgrammePage.head_of_programme' to match new field type.
        # db.rename_column(u'rca_programmepage', 'head_of_programme', 'head_of_programme_id')
        db.delete_column(u'rca_programmepage', 'head_of_programme')
        # Changing field 'ProgrammePage.head_of_programme'
        db.add_column(u'rca_programmepage', 'head_of_programme', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['wagtailcore.Page']),
                      keep_default=False)
        # Adding index on 'ProgrammePage', fields ['head_of_programme']
        #db.create_index(u'rca_programmepage', ['head_of_programme_id'])


    def backwards(self, orm):
        # Removing index on 'ProgrammePage', fields ['head_of_programme']
        db.delete_index(u'rca_programmepage', ['head_of_programme_id'])


        # User chose to not deal with backwards NULL issues for 'ProgrammePage.head_of_programme'
        raise RuntimeError("Cannot reverse this migration. 'ProgrammePage.head_of_programme' and its values cannot be restored.")
