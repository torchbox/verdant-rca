...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProgrammePageStudentStory.link'
        db.add_column(u'rca_programmepagestudentstory', 'link',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['wagtailcore.Page']),
                      keep_default=False)

        # Adding field 'ProgrammePage.school'
        db.add_column(u'rca_programmepage', 'school',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'ProgrammePage.background_image'
        db.add_column(u'rca_programmepage', 'background_image',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['rca.RcaImage']),
                      keep_default=False)

        # Adding field 'ProgrammePage.open_day'
        db.add_column(u'rca_programmepage', 'open_day',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 10, 1, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'ProgrammePage.open_day_link'
        db.add_column(u'rca_programmepage', 'open_day_link',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'ProgrammePage.programme_video_poster_image'
        db.add_column(u'rca_programmepage', 'programme_video_poster_image',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['rca.RcaImage']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProgrammePageStudentStory.link'
        db.delete_column(u'rca_programmepagestudentstory', 'link_id')

        # Deleting field 'ProgrammePage.school'
        db.delete_column(u'rca_programmepage', 'school')

        # Deleting field 'ProgrammePage.background_image'
        db.delete_column(u'rca_programmepage', 'background_image_id')

        # Deleting field 'ProgrammePage.open_day'
        db.delete_column(u'rca_programmepage', 'open_day')

        # Deleting field 'ProgrammePage.open_day_link'
        db.delete_column(u'rca_programmepage', 'open_day_link')

        # Deleting field 'ProgrammePage.programme_video_poster_image'
        db.delete_column(u'rca_programmepage', 'programme_video_poster_image_id')
