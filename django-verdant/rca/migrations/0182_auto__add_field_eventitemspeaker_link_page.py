...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EventItemSpeaker.link_page'
        db.add_column(u'rca_eventitemspeaker', 'link_page',
    ...
    def backwards(self, orm):
        # Deleting field 'EventItemSpeaker.link_page'
        db.delete_column(u'rca_eventitemspeaker', 'link_page_id')
