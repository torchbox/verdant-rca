...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StandardIndex.exclude_twitter_block'
        db.add_column(u'rca_standardindex', 'exclude_twitter_block',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'StandardIndex.exclude_events_sidebar'
        db.add_column(u'rca_standardindex', 'exclude_events_sidebar',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'StandardIndex.exclude_global_adverts'
        db.add_column(u'rca_standardindex', 'exclude_global_adverts',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StandardIndex.exclude_twitter_block'
        db.delete_column(u'rca_standardindex', 'exclude_twitter_block')

        # Deleting field 'StandardIndex.exclude_events_sidebar'
        db.delete_column(u'rca_standardindex', 'exclude_events_sidebar')

        # Deleting field 'StandardIndex.exclude_global_adverts'
        db.delete_column(u'rca_standardindex', 'exclude_global_adverts')
