...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StandardIndex.hide_body'
        db.add_column(u'rca_standardindex', 'hide_body',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StandardIndex.hide_body'
        db.delete_column(u'rca_standardindex', 'hide_body')
