...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'rca_programmepage', 'facilities_text', self.gf('core.fields.RichTextField')(null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'ProgrammePage.facilities_text'
        db.alter_column(u'rca_programmepage', 'facilities_text', self.gf('core.fields.RichTextField')(default=''))
