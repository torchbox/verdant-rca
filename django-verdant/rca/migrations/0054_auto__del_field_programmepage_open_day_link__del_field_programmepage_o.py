...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProgrammePage.facilities_text'
        db.alter_column(u'rca_programmepage', 'facilities_text', self.gf('wagtail.wagtailcore.fields.RichTextField')(null=True))
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'ProgrammePage.open_day'
        raise RuntimeError("Cannot reverse this migration. 'ProgrammePage.open_day' and its values cannot be restored.")

        # Changing field 'ProgrammePage.facilities_text'
        db.alter_column(u'rca_programmepage', 'facilities_text', self.gf('wagtail.wagtailcore.fields.RichTextField')(default=''))
