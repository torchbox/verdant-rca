...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column(u'rca_newstudentpage', 'postgrad_graduation_year', 'ma_graduation_year')
        db.rename_column(u'rca_newstudentpage', 'postgrad_school', 'ma_school')
        db.rename_column(u'rca_newstudentpage', 'postgrad_specialism', 'ma_specialism')
        db.rename_column(u'rca_newstudentpage', 'postgrad_programme', 'ma_programme')


    def backwards(self, orm):
        db.rename_column(u'rca_newstudentpage', 'ma_graduation_year', 'postgrad_graduation_year')
        db.rename_column(u'rca_newstudentpage', 'ma_school', 'postgrad_school')
        db.rename_column(u'rca_newstudentpage', 'ma_specialism', 'postgrad_specialism')
        db.rename_column(u'rca_newstudentpage', 'ma_programme', 'postgrad_programme')
