...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StandardPage.collapse_upcoming_events'
        db.add_column(u'rca_standardpage', 'collapse_upcoming_events',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StandardPage.collapse_upcoming_events'
        db.delete_column(u'rca_standardpage', 'collapse_upcoming_events')
