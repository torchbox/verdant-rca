...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'StaffPageCollaborations'
        db.create_table(u'rca_staffpagecollaborations', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('page', self.gf('django.db.models.fields.related.ForeignKey')(related_name='collaborations', to=orm['rca.StaffPage'])),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('link', self.gf('django.db.models.fields.URLField')(max_length=200)),
            ('text', self.gf('wagtail.wagtailcore.fields.RichTextField')(blank=True)),
            ('date', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
        ))
        db.send_create_signal(u'rca', ['StaffPageCollaborations'])

        # Adding model 'StaffPageRole'
        db.create_table(u'rca_staffpagerole', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('page', self.gf('django.db.models.fields.related.ForeignKey')(related_name='roles', to=orm['rca.StaffPage'])),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('programme', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('email', self.gf('django.db.models.fields.EmailField')(max_length=255)),
        ))
        db.send_create_signal(u'rca', ['StaffPageRole'])

        # Adding model 'StaffPagePublicationExhibition'
        db.create_table(u'rca_staffpagepublicationexhibition', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('page', self.gf('django.db.models.fields.related.ForeignKey')(related_name='publications_exhibitions', to=orm['rca.StaffPage'])),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('typeof', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('location_year', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('authors_collaborators', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('link', self.gf('django.db.models.fields.URLField')(max_length=200, blank=True)),
        ))
        db.send_create_signal(u'rca', ['StaffPagePublicationExhibition'])

        # Adding field 'StudentPage.current_degree'
        db.add_column(u'rca_studentpage', 'current_degree',
        ...
        db.add_column(u'rca_staffpage', 'staff_type',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'StaffPage.twitter_feed'
        db.add_column(u'rca_staffpage', 'twitter_feed',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'StaffPage.intro'
        db.add_column(u'rca_staffpage', 'intro',
                      self.gf('wagtail.wagtailcore.fields.RichTextField')(default=''),
                      keep_default=False)

        # Adding field 'StaffPage.biography'
        db.add_column(u'rca_staffpage', 'biography',
                      self.gf('wagtail.wagtailcore.fields.RichTextField')(default=''),
                      keep_default=False)

        # Adding field 'StaffPage.practice'
        db.add_column(u'rca_staffpage', 'practice',
                      self.gf('wagtail.wagtailcore.fields.RichTextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'StaffPage.practice_link'
        db.add_column(u'rca_staffpage', 'practice_link',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'StaffPage.show_on_homepage'
        db.add_column(u'rca_staffpage', 'show_on_homepage',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'StaffPage.show_on_programme_page'
        db.add_column(u'rca_staffpage', 'show_on_programme_page',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'StaffPage.listing_intro'
        db.add_column(u'rca_staffpage', 'listing_intro',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'StaffPage.research_interests'
        db.add_column(u'rca_staffpage', 'research_interests',
                      self.gf('wagtail.wagtailcore.fields.RichTextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'StaffPageCollaborations'
        db.delete_table(u'rca_staffpagecollaborations')

        # Deleting model 'StaffPageRole'
        db.delete_table(u'rca_staffpagerole')

        # Deleting model 'StaffPagePublicationExhibition'
        db.delete_table(u'rca_staffpagepublicationexhibition')

        # Deleting field 'StudentPage.current_degree'
        db.delete_column(u'rca_studentpage', 'current_degree')

        # Deleting field 'StaffPage.school'
        db.delete_column(u'rca_staffpage', 'school')

        # Deleting field 'StaffPage.profile_image'
        db.delete_column(u'rca_staffpage', 'profile_image_id')

        # Deleting field 'StaffPage.staff_type'
        db.delete_column(u'rca_staffpage', 'staff_type')

        # Deleting field 'StaffPage.twitter_feed'
        db.delete_column(u'rca_staffpage', 'twitter_feed')

        # Deleting field 'StaffPage.intro'
        db.delete_column(u'rca_staffpage', 'intro')

        # Deleting field 'StaffPage.biography'
        db.delete_column(u'rca_staffpage', 'biography')

        # Deleting field 'StaffPage.practice'
        db.delete_column(u'rca_staffpage', 'practice')

        # Deleting field 'StaffPage.practice_link'
        db.delete_column(u'rca_staffpage', 'practice_link')

        # Deleting field 'StaffPage.show_on_homepage'
        db.delete_column(u'rca_staffpage', 'show_on_homepage')

        # Deleting field 'StaffPage.show_on_programme_page'
        db.delete_column(u'rca_staffpage', 'show_on_programme_page')

        # Deleting field 'StaffPage.listing_intro'
        db.delete_column(u'rca_staffpage', 'listing_intro')

        # Deleting field 'StaffPage.research_interests'
        db.delete_column(u'rca_staffpage', 'research_interests')
