...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PressReleaseIndexAd'
        db.create_table(u'rca_pressreleaseindexad', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sort_order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('page', self.gf('cluster.fields.ParentalKey')(related_name='manual_adverts', to=orm['rca.PressReleaseIndex'])),
            ('ad', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['rca.Advert'])),
        ))
        db.send_create_signal(u'rca', ['PressReleaseIndexAd'])

        # Adding model 'PressReleaseIndex'
        db.create_table(u'rca_pressreleaseindex', (
        ...
        db.send_create_signal(u'rca', ['PressReleaseIndex'])


    def backwards(self, orm):
        # Deleting model 'PressReleaseIndexAd'
        db.delete_table(u'rca_pressreleaseindexad')

        # Deleting model 'PressReleaseIndex'
        db.delete_table(u'rca_pressreleaseindex')
