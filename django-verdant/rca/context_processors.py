...
from rca.models import YEARS, EVENT_LOCATION_CHOICES, EVENT_AUDIENCE_CHOICES, RESEARCH_TYPES_CHOICES, WORK_THEME_CHOICES, WORK_TYPES_CHOICES, STAFF_TYPES_CHOICES, INNOVATIONRCA_PROJECT_TYPES_CHOICES, SUSTAINRCA_CATEGORY_CHOICES
...
def global_vars(request):
    ...
    years_until_current_year = [y for y in YEARS if int(y) <= current_year]
