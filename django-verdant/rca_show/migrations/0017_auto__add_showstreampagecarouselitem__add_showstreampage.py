...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ShowStreamPageCarouselItem'
        db.create_table(u'rca_show_showstreampagecarouselitem', (
            ...
            ('page', self.gf('modelcluster.fields.ParentalKey')(related_name='carousel_items', to=orm['rca_show.ShowStreamPage'])),
        ))
        db.send_create_signal(u'rca_show', ['ShowStreamPageCarouselItem'])

        # Adding model 'ShowStreamPage'
        db.create_table(u'rca_show_showstreampage', (
        ...
        db.send_create_signal(u'rca_show', ['ShowStreamPage'])


    def backwards(self, orm):
        # Deleting model 'ShowStreamPageCarouselItem'
        db.delete_table(u'rca_show_showstreampagecarouselitem')

        # Deleting model 'ShowStreamPage'
        db.delete_table(u'rca_show_showstreampage')
