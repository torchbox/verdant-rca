...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ShowIndexPage.school'
        db.delete_column(u'rca_show_showindexpage', 'school')


    def backwards(self, orm):
        # Adding field 'ShowIndexPage.school'
        db.add_column(u'rca_show_showindexpage', 'school',
