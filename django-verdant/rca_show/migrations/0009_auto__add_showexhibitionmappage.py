...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ShowExhibitionMapPage'
        db.create_table(u'rca_show_showexhibitionmappage', (
        ...
        db.send_create_signal(u'rca_show', ['ShowExhibitionMapPage'])


    def backwards(self, orm):
        # Deleting model 'ShowExhibitionMapPage'
        db.delete_table(u'rca_show_showexhibitionmappage')
