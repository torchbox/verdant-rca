...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ShowIndexPage.body'
        db.add_column(u'rca_show_showindexpage', 'body',
                      self.gf('wagtail.wagtailcore.fields.RichTextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ShowIndexPage.body'
        db.delete_column(u'rca_show_showindexpage', 'body')
