...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ShowIndexPage.exhibition_date'
        db.add_column(u'rca_show_showindexpage', 'exhibition_date',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ShowIndexPage.exhibition_date'
        db.delete_column(u'rca_show_showindexpage', 'exhibition_date')
