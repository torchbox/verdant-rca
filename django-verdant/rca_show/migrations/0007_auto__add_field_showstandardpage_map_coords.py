...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ShowStandardPage.map_coords'
        db.add_column(u'rca_show_showstandardpage', 'map_coords',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ShowStandardPage.map_coords'
        db.delete_column(u'rca_show_showstandardpage', 'map_coords')
