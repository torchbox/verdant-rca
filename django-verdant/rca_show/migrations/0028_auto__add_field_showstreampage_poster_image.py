...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ShowStreamPage.poster_image'
        db.add_column(u'rca_show_showstreampage', 'poster_image',
    ...
    def backwards(self, orm):
        # Deleting field 'ShowStreamPage.poster_image'
        db.delete_column(u'rca_show_showstreampage', 'poster_image_id')
    ...
    models = {
        ...
        u'rca_show.showindexpage': {
            ...
            'body': ('wagtail.wagtailcore.fields.RichTextField', [], {'blank': 'True'}),
            'exhibition_date': ('django.db.models.fields.TextField', [], {'max_length': '255', 'blank': 'True'}),
