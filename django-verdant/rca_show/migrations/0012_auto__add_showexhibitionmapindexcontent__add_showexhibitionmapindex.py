...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ShowExhibitionMapIndexContent'
        db.create_table(u'rca_show_showexhibitionmapindexcontent', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sort_order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('page', self.gf('modelcluster.fields.ParentalKey')(related_name='content_block', to=orm['rca_show.ShowExhibitionMapIndex'])),
            ('body', self.gf('wagtail.wagtailcore.fields.RichTextField')(blank=True)),
            ('map_coords', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
        ))
        db.send_create_signal(u'rca_show', ['ShowExhibitionMapIndexContent'])

        # Adding model 'ShowExhibitionMapIndex'
        db.create_table(u'rca_show_showexhibitionmapindex', (
        ...
        db.send_create_signal(u'rca_show', ['ShowExhibitionMapIndex'])


    def backwards(self, orm):
        # Deleting model 'ShowExhibitionMapIndexContent'
        db.delete_table(u'rca_show_showexhibitionmapindexcontent')

        # Deleting model 'ShowExhibitionMapIndex'
        db.delete_table(u'rca_show_showexhibitionmapindex')
