...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ShowIndexPageCarouselItem'
        db.create_table(u'rca_show_showindexpagecarouselitem', (
            ...
            ('page', self.gf('modelcluster.fields.ParentalKey')(related_name='carousel_items', to=orm['rca_show.ShowIndexPage'])),
        ))
        db.send_create_signal(u'rca_show', ['ShowIndexPageCarouselItem'])


        # Changing field 'ShowIndexPage.exhibition_date'
        db.alter_column(u'rca_show_showindexpage', 'exhibition_date', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):
        # Deleting model 'ShowIndexPageCarouselItem'
        db.delete_table(u'rca_show_showindexpagecarouselitem')


        # Changing field 'ShowIndexPage.exhibition_date'
        db.alter_column(u'rca_show_showindexpage', 'exhibition_date', self.gf('django.db.models.fields.TextField')(max_length=255))
    ...
    models = {
        ...
        u'rca_show.showindexpageschool': {
            'Meta': {'ordering': "['sort_order']", 'object_name': 'ShowIndexPageSchool'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'intro': ('wagtail.wagtailcore.fields.RichTextField', [], {'blank': 'True'}),
            'page': ('modelcluster.fields.ParentalKey', [], {'related_name': "'schools'", 'to': u"orm['rca_show.ShowIndexPage']"}),
