...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for show_index in orm['rca_show.ShowIndexPage'].objects.all():
            programme_pk = None
            if show_index.programme:
                programme, created = orm['rca_show.ShowIndexPageProgramme'].objects.get_or_create(page=show_index, programme=show_index.programme)
                programme_pk = programme.pk

            # Update revisions
            for revision in orm['wagtailcore.PageRevision'].objects.filter(page_id=show_index.page_ptr_id):
                # Decode json
