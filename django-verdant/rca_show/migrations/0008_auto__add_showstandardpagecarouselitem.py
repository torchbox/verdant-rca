...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ShowStandardPageCarouselItem'
        db.create_table(u'rca_show_showstandardpagecarouselitem', (
            ...
            ('page', self.gf('modelcluster.fields.ParentalKey')(related_name='carousel_items', to=orm['rca_show.ShowStandardPage'])),
        ))
        db.send_create_signal(u'rca_show', ['ShowStandardPageCarouselItem'])


    def backwards(self, orm):
        # Deleting model 'ShowStandardPageCarouselItem'
        db.delete_table(u'rca_show_showstandardpagecarouselitem')
