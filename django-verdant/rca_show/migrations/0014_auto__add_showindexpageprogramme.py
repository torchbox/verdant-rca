...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ShowIndexPageProgramme'
        db.create_table(u'rca_show_showindexpageprogramme', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sort_order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('page', self.gf('modelcluster.fields.ParentalKey')(related_name='programmes', to=orm['rca_show.ShowIndexPage'])),
            ('programme', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'rca_show', ['ShowIndexPageProgramme'])


    def backwards(self, orm):
        # Deleting model 'ShowIndexPageProgramme'
        db.delete_table(u'rca_show_showindexpageprogramme')
