...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ShowStandardPage'
        db.create_table(u'rca_show_showstandardpage', (
        ...
        db.send_create_signal(u'rca_show', ['ShowStandardPage'])


    def backwards(self, orm):
        # Deleting model 'ShowStandardPage'
        db.delete_table(u'rca_show_showstandardpage')
