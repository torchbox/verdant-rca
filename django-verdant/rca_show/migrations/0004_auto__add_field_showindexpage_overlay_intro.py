...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ShowIndexPage.overlay_intro'
        db.add_column(u'rca_show_showindexpage', 'overlay_intro',
                      self.gf('wagtail.wagtailcore.fields.RichTextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ShowIndexPage.overlay_intro'
        db.delete_column(u'rca_show_showindexpage', 'overlay_intro')
