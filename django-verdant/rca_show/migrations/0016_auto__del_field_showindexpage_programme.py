...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ShowIndexPage.programme'
        db.delete_column(u'rca_show_showindexpage', 'programme')


    def backwards(self, orm):
        # Adding field 'ShowIndexPage.programme'
        db.add_column(u'rca_show_showindexpage', 'programme',
