...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ShowStandardPageContent'
        db.create_table(u'rca_show_showstandardpagecontent', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sort_order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('page', self.gf('modelcluster.fields.ParentalKey')(related_name='content_block', to=orm['rca_show.ShowStandardPage'])),
        ...
        db.send_create_signal(u'rca_show', ['ShowStandardPageContent'])


    def backwards(self, orm):
        # Deleting model 'ShowStandardPageContent'
        db.delete_table(u'rca_show_showstandardpagecontent')
