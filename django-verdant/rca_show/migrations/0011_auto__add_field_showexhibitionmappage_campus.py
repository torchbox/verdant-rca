...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ShowExhibitionMapPage.campus'
        db.add_column(u'rca_show_showexhibitionmappage', 'campus',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ShowExhibitionMapPage.campus'
        db.delete_column(u'rca_show_showexhibitionmappage', 'campus')
