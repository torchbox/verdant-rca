...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EditorsPick.sort_order'
        db.alter_column(u'verdantsearch_editorspick', 'sort_order', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'EditorsPick.sort_order'
        db.alter_column(u'verdantsearch_editorspick', 'sort_order', self.gf('django.db.models.fields.IntegerField')())
