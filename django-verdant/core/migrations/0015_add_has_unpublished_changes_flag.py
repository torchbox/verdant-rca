...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Page.has_unpublished_changes'
        db.add_column(u'core_page', 'has_unpublished_changes',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Page.has_unpublished_changes'
        db.delete_column(u'core_page', 'has_unpublished_changes')
