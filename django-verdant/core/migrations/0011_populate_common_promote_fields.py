...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        page_types = [
            ...
            "rca.RcaNowIndex",
            "rca.ResearchItem",
            "rca.ResearchInnovationPage",
            "rca.CurrentResearchPage",
            "rca.GalleryPage",
            "rca.ContactUsPage",
        ]

        for page_type in page_types:
            for page in orm[page_type].objects.all():
                page.seo_title_core = page.seo_title
                page.show_in_menus_core = page.show_in_menus
                page.feed_image_core = page.feed_image
                page.save()
