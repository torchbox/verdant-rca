...
class Migration(SchemaMigration):
    depends_on = (
        ("rca", "0113_auto__add_field_staffpagepublicationexhibition_image"),
    )

    def forwards(self, orm):
        # Adding field 'Page.seo_title_core'
        db.add_column(u'core_page', 'seo_title_core',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Page.show_in_menus_core'
        db.add_column(u'core_page', 'show_in_menus_core',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Page.feed_image_core'
        db.add_column(u'core_page', 'feed_image_core',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['rca.RcaImage']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Page.seo_title_core'
        db.delete_column(u'core_page', 'seo_title_core')

        # Deleting field 'Page.show_in_menus_core'
        db.delete_column(u'core_page', 'show_in_menus_core')

        # Deleting field 'Page.feed_image_core'
        db.delete_column(u'core_page', 'feed_image_core_id')
