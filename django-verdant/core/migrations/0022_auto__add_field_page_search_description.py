...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Page.search_description'
        db.add_column(u'core_page', 'search_description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Page.search_description'
        db.delete_column(u'core_page', 'search_description')
