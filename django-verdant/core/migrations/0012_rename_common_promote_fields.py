...
class Migration(SchemaMigration):
    depends_on = (
        ("rca", "0114_remove_common_promote_fields"),
    )

    def forwards(self, orm):
        db.rename_column('core_page', 'feed_image_core_id', 'feed_image_id')
        db.rename_column('core_page', 'seo_title_core', 'seo_title')
        db.rename_column('core_page', 'show_in_menus_core', 'show_in_menus')


    def backwards(self, orm):
        db.rename_column('core_page', 'feed_image_id', 'feed_image_core_id')
        db.rename_column('core_page', 'seo_title', 'seo_title_core')
        db.rename_column('core_page', 'show_in_menus', 'show_in_menus_core')
