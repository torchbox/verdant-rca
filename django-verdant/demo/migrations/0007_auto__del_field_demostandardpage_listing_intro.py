...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'DemoStandardPage.listing_intro'
        db.delete_column(u'demo_demostandardpage', 'listing_intro')


    def backwards(self, orm):
        # Adding field 'DemoStandardPage.listing_intro'
        db.add_column(u'demo_demostandardpage', 'listing_intro',
