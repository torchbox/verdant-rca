...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EventPage.cost'
        db.alter_column(u'demo_eventpage', 'cost', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'EventPage.cost'
        db.alter_column(u'demo_eventpage', 'cost', self.gf('core.fields.RichTextField')())
