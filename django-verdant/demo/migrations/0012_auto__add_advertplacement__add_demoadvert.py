...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'demo_advertplacement', (
            ...
            ('page', self.gf('cluster.fields.ParentalKey')(related_name='demo_advert_placements', to=orm['core.Page'])),
            ('advert', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['demo.DemoAdvert'])),
        ))
        db.send_create_signal(u'demo', ['AdvertPlacement'])

        # Adding model 'DemoAdvert'
        db.create_table(u'demo_demoadvert', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('page', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='demo_adverts', null=True, to=orm['core.Page'])),
            ('url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True)),
            ('text', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'demo', ['DemoAdvert'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'DemoAdvert'
        db.delete_table(u'demo_demoadvert')
    ...
    models = {
        ...
        u'demo.advertplacement': {
            ...
            'advert': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'to': u"orm['demo.DemoAdvert']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'page': ('cluster.fields.ParentalKey', [], {'related_name': "'demo_advert_placements'", 'to': u"orm['core.Page']"})
        },
        ...
        u'demo.demoadvert': {
            'Meta': {'object_name': 'DemoAdvert'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'page': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'demo_adverts'", 'null': 'True', 'to': u"orm['core.Page']"}),
