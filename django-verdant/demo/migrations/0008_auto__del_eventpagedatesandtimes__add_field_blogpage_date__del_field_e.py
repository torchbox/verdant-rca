...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'BlogPage.date'
        db.add_column(u'demo_blogpage', 'date',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2014, 1, 23, 0, 0)),
                      keep_default=False)

        # Deleting field 'EventPage.specific_directions_link'
        db.delete_column(u'demo_eventpage', 'specific_directions_link')

        # Deleting field 'EventPage.specific_directions'
        db.delete_column(u'demo_eventpage', 'specific_directions')

        # Adding field 'EventPage.date_from'
        db.add_column(u'demo_eventpage', 'date_from',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2014, 1, 23, 0, 0)),
                      keep_default=False)

        # Adding field 'EventPage.date_to'
        db.add_column(u'demo_eventpage', 'date_to',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'EventPage.time_from'
        db.add_column(u'demo_eventpage', 'time_from',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'EventPage.time_to'
        db.add_column(u'demo_eventpage', 'time_to',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'BlogPage.date'
        db.delete_column(u'demo_blogpage', 'date')

        # Adding field 'EventPage.specific_directions_link'
        db.add_column(u'demo_eventpage', 'specific_directions_link',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'EventPage.specific_directions'
        db.add_column(u'demo_eventpage', 'specific_directions',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Deleting field 'EventPage.date_from'
        db.delete_column(u'demo_eventpage', 'date_from')

        # Deleting field 'EventPage.date_to'
        db.delete_column(u'demo_eventpage', 'date_to')

        # Deleting field 'EventPage.time_from'
        db.delete_column(u'demo_eventpage', 'time_from')

        # Deleting field 'EventPage.time_to'
        db.delete_column(u'demo_eventpage', 'time_to')
    ...
    models = {
        ...
        u'demo.blogpagetag': {
            ...
            'content_object': ('cluster.fields.ParentalKey', [], {'related_name': "'tagged_items'", 'to': u"orm['demo.BlogPage']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'demo.standardindexpagerelatedlink': {
            ...
            'link_external': ('django.db.models.fields.URLField', [], {'max_length': '200', 'blank': 'True'}),
            'link_page': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'to': u"orm['core.Page']"}),
            'page': ('cluster.fields.ParentalKey', [], {'related_name': "'related_links'", 'to': u"orm['demo.DemoStandardIndexPage']"}),
            'sort_order': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '255'})
        },
