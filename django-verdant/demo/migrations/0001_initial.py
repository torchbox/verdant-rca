...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'demo_advertplacement', (
            ...
            ('page', self.gf('cluster.fields.ParentalKey')(related_name='advert_placements', to=orm['wagtailcore.Page'])),
        ...
        db.create_table(u'demo_standardindexpagerelatedlink', (
            ...
            ('link_document', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['verdantdocs.Document'])),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('page', self.gf('cluster.fields.ParentalKey')(related_name='related_links', to=orm['demo.StandardIndexPage'])),
        ))
        ...
        db.create_table(u'demo_standardindexpage', (
            ...
            ('feed_image', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, on_delete=models.SET_NULL, to=orm['verdantimages.Image'])),
        ))
        ...
        db.create_table(u'demo_blogpagetag', (
            ...
            ('content_object', self.gf('cluster.fields.ParentalKey')(related_name='tagged_items', to=orm['demo.BlogPage'])),
        ))
    ...
    models = {
        ...
        u'demo.standardindexpagerelatedlink': {
            ...
            'link_external': ('django.db.models.fields.URLField', [], {'max_length': '200', 'blank': 'True'}),
            'link_page': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'to': u"orm['wagtailcore.Page']"}),
            'page': ('cluster.fields.ParentalKey', [], {'related_name': "'related_links'", 'to': u"orm['demo.StandardIndexPage']"}),
            'sort_order': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '255'})
        },
        u'demo.standardpage': {
