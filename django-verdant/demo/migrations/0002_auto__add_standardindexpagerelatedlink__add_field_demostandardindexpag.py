...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'demo_standardindexpagerelatedlink', (
            ...
            ('page', self.gf('cluster.fields.ParentalKey')(related_name='related_links', to=orm['demo.DemoStandardIndexPage'])),
        ))
        db.send_create_signal(u'demo', ['StandardIndexPageRelatedLink'])

        # Adding field 'DemoStandardIndexPage.intro'
        db.add_column(u'demo_demostandardindexpage', 'intro',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'DemoStandardIndexPage.intro'
        db.delete_column(u'demo_demostandardindexpage', 'intro')
