...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DemoStandardIndexPage.feed_image'
        db.add_column(u'demo_demostandardindexpage', 'feed_image',
    ...
    def backwards(self, orm):
        # Deleting field 'DemoStandardIndexPage.feed_image'
        db.delete_column(u'demo_demostandardindexpage', 'feed_image_id')
