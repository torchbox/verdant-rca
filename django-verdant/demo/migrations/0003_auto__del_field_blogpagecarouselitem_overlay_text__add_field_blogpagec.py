...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'BlogPageCarouselItem.overlay_text'
        db.delete_column(u'demo_blogpagecarouselitem', 'overlay_text')
        ...
        db.delete_column(u'demo_standardpagecarouselitem', 'overlay_text')
        ...
        # Deleting field 'EventPageCarouselItem.overlay_text'
        db.delete_column(u'demo_eventpagecarouselitem', 'overlay_text')

        # Adding field 'EventPageCarouselItem.caption'
        db.add_column(u'demo_eventpagecarouselitem', 'caption',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Deleting field 'HomePageCarouselItem.overlay_text'
        db.delete_column(u'demo_homepagecarouselitem', 'overlay_text')
    ...
    def backwards(self, orm):
        # Adding field 'BlogPageCarouselItem.overlay_text'
        db.add_column(u'demo_blogpagecarouselitem', 'overlay_text',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)
        ...
        db.add_column(u'demo_standardpagecarouselitem', 'overlay_text',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)
        ...
        # Adding field 'EventPageCarouselItem.overlay_text'
        db.add_column(u'demo_eventpagecarouselitem', 'overlay_text',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Deleting field 'EventPageCarouselItem.caption'
        db.delete_column(u'demo_eventpagecarouselitem', 'caption')

        # Adding field 'HomePageCarouselItem.overlay_text'
        db.add_column(u'demo_homepagecarouselitem', 'overlay_text',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)
