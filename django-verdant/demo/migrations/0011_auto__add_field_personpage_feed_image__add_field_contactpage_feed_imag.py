...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PersonPage.feed_image'
        db.add_column(u'demo_personpage', 'feed_image',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, on_delete=models.SET_NULL, to=orm['verdantimages.Image']),
                      keep_default=False)

        # Adding field 'ContactPage.feed_image'
        db.add_column(u'demo_contactpage', 'feed_image',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, on_delete=models.SET_NULL, to=orm['verdantimages.Image']),
                      keep_default=False)

        # Adding field 'BlogPage.feed_image'
        db.add_column(u'demo_blogpage', 'feed_image',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, on_delete=models.SET_NULL, to=orm['verdantimages.Image']),
                      keep_default=False)

        # Adding field 'EventPage.feed_image'
        db.add_column(u'demo_eventpage', 'feed_image',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, on_delete=models.SET_NULL, to=orm['verdantimages.Image']),
                      keep_default=False)

        # Adding field 'DemoStandardPage.feed_image'
        db.add_column(u'demo_demostandardpage', 'feed_image',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, on_delete=models.SET_NULL, to=orm['verdantimages.Image']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PersonPage.feed_image'
        db.delete_column(u'demo_personpage', 'feed_image_id')

        # Deleting field 'ContactPage.feed_image'
        db.delete_column(u'demo_contactpage', 'feed_image_id')

        # Deleting field 'BlogPage.feed_image'
        db.delete_column(u'demo_blogpage', 'feed_image_id')

        # Deleting field 'EventPage.feed_image'
        db.delete_column(u'demo_eventpage', 'feed_image_id')

        # Deleting field 'DemoStandardPage.feed_image'
        db.delete_column(u'demo_demostandardpage', 'feed_image_id')
    ...
    models = {
        ...
        u'demo.blogpage': {
            ...
            'feed_image': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['verdantimages.Image']"}),
            u'page_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['core.Page']", 'unique': 'True', 'primary_key': 'True'})
        },
