...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'BlogPageCarouselItem.link_document'
        db.add_column(u'demo_blogpagecarouselitem', 'link_document',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['verdantdocs.Document']),
                      keep_default=False)

        # Adding field 'StandardPageCarouselItem.link_document'
        db.add_column(u'demo_standardpagecarouselitem', 'link_document',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['verdantdocs.Document']),
                      keep_default=False)

        # Adding field 'EventPageCarouselItem.link_document'
        db.add_column(u'demo_eventpagecarouselitem', 'link_document',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['verdantdocs.Document']),
                      keep_default=False)

        # Adding field 'EventPageSpeaker.link_document'
        db.add_column(u'demo_eventpagespeaker', 'link_document',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['verdantdocs.Document']),
                      keep_default=False)

        # Adding field 'HomePageCarouselItem.link_document'
        db.add_column(u'demo_homepagecarouselitem', 'link_document',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['verdantdocs.Document']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'BlogPageCarouselItem.link_document'
        db.delete_column(u'demo_blogpagecarouselitem', 'link_document_id')

        # Deleting field 'StandardPageCarouselItem.link_document'
        db.delete_column(u'demo_standardpagecarouselitem', 'link_document_id')

        # Deleting field 'EventPageCarouselItem.link_document'
        db.delete_column(u'demo_eventpagecarouselitem', 'link_document_id')

        # Deleting field 'EventPageSpeaker.link_document'
        db.delete_column(u'demo_eventpagespeaker', 'link_document_id')

        # Deleting field 'HomePageCarouselItem.link_document'
        db.delete_column(u'demo_homepagecarouselitem', 'link_document_id')
