...
class SiteSummaryPanel(object):
    ...
    def render(self):
        return render_to_string('verdantadmin/home/site_summary.html', {
...
class PagesForModerationPanel(object):
    ...
    def render(self):
        return render_to_string('verdantadmin/home/pages_for_moderation.html', {
...
class RecentEditsPanel(object):
    ...
    def render(self):
        return render_to_string('verdantadmin/home/recent_edits.html', {
