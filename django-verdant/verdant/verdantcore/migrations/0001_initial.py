...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Site'
        db.create_table(u'verdantcore_site', (
            ...
            ('root_page', self.gf('django.db.models.fields.related.ForeignKey')(related_name='sites_rooted_here', to=orm['verdantcore.Page'])),
            ('is_default_site', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'verdantcore', ['Site'])

        # Adding model 'Page'
        db.create_table(u'verdantcore_page', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'verdantcore', ['Page'])

        # Adding model 'PageRevision'
        db.create_table(u'verdantcore_pagerevision', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('page', self.gf('django.db.models.fields.related.ForeignKey')(related_name='revisions', to=orm['verdantcore.Page'])),
        ...
        db.send_create_signal(u'verdantcore', ['PageRevision'])


    def backwards(self, orm):
        # Deleting model 'Site'
        db.delete_table(u'verdantcore_site')

        # Deleting model 'Page'
        db.delete_table(u'verdantcore_page')

        # Deleting model 'PageRevision'
        db.delete_table(u'verdantcore_pagerevision')
    ...
    models = {
        ...
        u'verdantcore.pagerevision': {
            'Meta': {'object_name': 'PageRevision'},
            'content_json': ('django.db.models.fields.TextField', [], {}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'page': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'revisions'", 'to': u"orm['verdantcore.Page']"}),
        ...
        u'verdantcore.site': {
            ...
            'root_page': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'sites_rooted_here'", 'to': u"orm['verdantcore.Page']"})
        }
    }

    complete_apps = ['verdantcore']