...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SavedEmbed.thumbnail_url'
        db.add_column(u'django_embedly_savedembed', 'thumbnail_url',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SavedEmbed.thumbnail_url'
        db.delete_column(u'django_embedly_savedembed', 'thumbnail_url')
