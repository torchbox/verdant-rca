...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SavedEmbed.title'
        db.add_column(u'django_embedly_savedembed', 'title',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SavedEmbed.title'
        db.delete_column(u'django_embedly_savedembed', 'title')
