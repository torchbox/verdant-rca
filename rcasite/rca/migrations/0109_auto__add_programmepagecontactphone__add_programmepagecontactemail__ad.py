...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProgrammePageContactPhone'
        db.create_table(u'rca_programmepagecontactphone', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sort_order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('page', self.gf('django.db.models.fields.related.ForeignKey')(related_name='contact_phone', to=orm['rca.ProgrammePage'])),
            ('phone_number', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'rca', ['ProgrammePageContactPhone'])

        # Adding model 'ProgrammePageContactEmail'
        db.create_table(u'rca_programmepagecontactemail', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sort_order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('page', self.gf('django.db.models.fields.related.ForeignKey')(related_name='contact_email', to=orm['rca.ProgrammePage'])),
            ('email_address', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'rca', ['ProgrammePageContactEmail'])

        # Adding field 'ProgrammePage.contact_title'
        db.add_column(u'rca_programmepage', 'contact_title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'ProgrammePage.contact_address'
        db.add_column(u'rca_programmepage', 'contact_address',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'ProgrammePage.contact_link'
        db.add_column(u'rca_programmepage', 'contact_link',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'ProgrammePage.contact_link_text'
        db.add_column(u'rca_programmepage', 'contact_link_text',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'ProgrammePageContactPhone'
        db.delete_table(u'rca_programmepagecontactphone')

        # Deleting model 'ProgrammePageContactEmail'
        db.delete_table(u'rca_programmepagecontactemail')

        # Deleting field 'ProgrammePage.contact_title'
        db.delete_column(u'rca_programmepage', 'contact_title')

        # Deleting field 'ProgrammePage.contact_address'
        db.delete_column(u'rca_programmepage', 'contact_address')

        # Deleting field 'ProgrammePage.contact_link'
        db.delete_column(u'rca_programmepage', 'contact_link')

        # Deleting field 'ProgrammePage.contact_link_text'
        db.delete_column(u'rca_programmepage', 'contact_link_text')
