...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'EventItem.signup_link'
        db.delete_column(u'rca_eventitem', 'signup_link')

        # Adding field 'EventItem.eventbrite_id'
        db.add_column(u'rca_eventitem', 'eventbrite_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'EventItem.signup_link'
        db.add_column(u'rca_eventitem', 'signup_link',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Deleting field 'EventItem.eventbrite_id'
        db.delete_column(u'rca_eventitem', 'eventbrite_id')
