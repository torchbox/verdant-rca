...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StandardPageRelatedDocument.document_name'
        db.add_column(u'rca_standardpagerelateddocument', 'document_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StandardPageRelatedDocument.document_name'
        db.delete_column(u'rca_standardpagerelateddocument', 'document_name')
    ...
    models = {
        ...
        u'rca.standardpagerelateddocument': {
            ...
            'document': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'to': u"orm['verdantdocs.Document']"}),
            'document_name': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
