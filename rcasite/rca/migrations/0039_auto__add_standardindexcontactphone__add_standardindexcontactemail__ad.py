...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'StandardIndexContactPhone'
        db.create_table(u'rca_standardindexcontactphone', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('page', self.gf('django.db.models.fields.related.ForeignKey')(related_name='contact_phone', to=orm['rca.StandardIndex'])),
            ('phone_number', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'rca', ['StandardIndexContactPhone'])

        # Adding model 'StandardIndexContactEmail'
        db.create_table(u'rca_standardindexcontactemail', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('page', self.gf('django.db.models.fields.related.ForeignKey')(related_name='contact_email', to=orm['rca.StandardIndex'])),
            ('email_address', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'rca', ['StandardIndexContactEmail'])

        # Adding field 'StandardIndex.contact_title'
        db.add_column(u'rca_standardindex', 'contact_title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'StandardIndex.contact_address'
        db.add_column(u'rca_standardindex', 'contact_address',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'StandardIndex.contact_link'
        db.add_column(u'rca_standardindex', 'contact_link',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'StandardIndex.contact_link_text'
        db.add_column(u'rca_standardindex', 'contact_link_text',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'StandardIndexContactPhone'
        db.delete_table(u'rca_standardindexcontactphone')

        # Deleting model 'StandardIndexContactEmail'
        db.delete_table(u'rca_standardindexcontactemail')

        # Deleting field 'StandardIndex.contact_title'
        db.delete_column(u'rca_standardindex', 'contact_title')

        # Deleting field 'StandardIndex.contact_address'
        db.delete_column(u'rca_standardindex', 'contact_address')

        # Deleting field 'StandardIndex.contact_link'
        db.delete_column(u'rca_standardindex', 'contact_link')

        # Deleting field 'StandardIndex.contact_link_text'
        db.delete_column(u'rca_standardindex', 'contact_link_text')
