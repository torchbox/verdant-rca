...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ResearchItem.ref'
        #db.alter_column(u'rca_researchitem', 'ref', self.gf('django.db.models.fields.BooleanField')())
        db.delete_column("rca_researchitem", "ref")
        db.add_column("rca_researchitem", "ref", self.gf('django.db.models.fields.BooleanField')(default=False))

    def backwards(self, orm):

        # Changing field 'ResearchItem.ref'
        #db.alter_column(u'rca_researchitem', 'ref', self.gf('django.db.models.fields.CharField')(max_length=255))
        db.delete_column("rca_researchitem", "ref")
        db.add_column("rca_researchitem", "ref", self.gf('django.db.models.fields.CharField')(max_length=255))
