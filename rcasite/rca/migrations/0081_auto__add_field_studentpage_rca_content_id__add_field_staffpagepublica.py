...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StudentPage.rca_content_id'
        db.add_column(u'rca_studentpage', 'rca_content_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'StaffPagePublicationExhibition.rca_content_id'
        db.add_column(u'rca_staffpagepublicationexhibition', 'rca_content_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'ResearchItem.rca_content_id'
        db.add_column(u'rca_researchitem', 'rca_content_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'ResearchItem.eprintid'
        db.add_column(u'rca_researchitem', 'eprintid',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'NewsItem.rca_content_id'
        db.add_column(u'rca_newsitem', 'rca_content_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'RcaImage.rca_content_id'
        db.add_column(u'rca_rcaimage', 'rca_content_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'RcaImage.eprint_docid'
        db.add_column(u'rca_rcaimage', 'eprint_docid',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StudentPage.rca_content_id'
        db.delete_column(u'rca_studentpage', 'rca_content_id')

        # Deleting field 'StaffPagePublicationExhibition.rca_content_id'
        db.delete_column(u'rca_staffpagepublicationexhibition', 'rca_content_id')

        # Deleting field 'ResearchItem.rca_content_id'
        db.delete_column(u'rca_researchitem', 'rca_content_id')

        # Deleting field 'ResearchItem.eprintid'
        db.delete_column(u'rca_researchitem', 'eprintid')

        # Deleting field 'NewsItem.rca_content_id'
        db.delete_column(u'rca_newsitem', 'rca_content_id')

        # Deleting field 'RcaImage.rca_content_id'
        db.delete_column(u'rca_rcaimage', 'rca_content_id')

        # Deleting field 'RcaImage.eprint_docid'
        db.delete_column(u'rca_rcaimage', 'eprint_docid')
