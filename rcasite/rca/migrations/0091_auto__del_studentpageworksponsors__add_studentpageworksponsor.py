...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'StudentPageWorkSponsors'
        db.delete_table(u'rca_studentpageworksponsors')

        # Adding model 'StudentPageWorkSponsor'
        db.create_table(u'rca_studentpageworksponsor', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sort_order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('page', self.gf('django.db.models.fields.related.ForeignKey')(related_name='sponsor', to=orm['rca.StudentPage'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
        ))
        db.send_create_signal(u'rca', ['StudentPageWorkSponsor'])


    def backwards(self, orm):
        # Adding model 'StudentPageWorkSponsors'
        db.create_table(u'rca_studentpageworksponsors', (
            ('sort_order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sponsors', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('page', self.gf('django.db.models.fields.related.ForeignKey')(related_name='sponsors', to=orm['rca.StudentPage'])),
        ))
        db.send_create_signal(u'rca', ['StudentPageWorkSponsors'])

        # Deleting model 'StudentPageWorkSponsor'
        db.delete_table(u'rca_studentpageworksponsor')
