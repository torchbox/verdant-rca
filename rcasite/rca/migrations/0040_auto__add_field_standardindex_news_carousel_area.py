...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StandardIndex.news_carousel_area'
        db.add_column(u'rca_standardindex', 'news_carousel_area',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StandardIndex.news_carousel_area'
        db.delete_column(u'rca_standardindex', 'news_carousel_area')
