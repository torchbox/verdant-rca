...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StaffPage.publications_exhibtions_and_other_outcomes_placeholder'
        db.add_column(u'rca_staffpage', 'publications_exhibtions_and_other_outcomes_placeholder',
                      self.gf('core.fields.RichTextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'StaffPage.external_collaborations_placeholder'
        db.add_column(u'rca_staffpage', 'external_collaborations_placeholder',
                      self.gf('core.fields.RichTextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StaffPage.publications_exhibtions_and_other_outcomes_placeholder'
        db.delete_column(u'rca_staffpage', 'publications_exhibtions_and_other_outcomes_placeholder')

        # Deleting field 'StaffPage.external_collaborations_placeholder'
        db.delete_column(u'rca_staffpage', 'external_collaborations_placeholder')
