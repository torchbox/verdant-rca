...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'rca_advertplacement', (
            ...
            ('page', self.gf('django.db.models.fields.related.ForeignKey')(related_name='advert_placements', to=orm['core.Page'])),
        ...
        db.alter_column(u'rca_advert', 'page_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['core.Page']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Advert.page'
        db.alter_column(u'rca_advert', 'page_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['core.Page']))
