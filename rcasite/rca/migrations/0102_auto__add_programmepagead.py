...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProgrammePageAd'
        db.create_table(u'rca_programmepagead', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sort_order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('page', self.gf('django.db.models.fields.related.ForeignKey')(related_name='manual_adverts', to=orm['rca.ProgrammePage'])),
            ('ad', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['rca.Advert'])),
        ))
        db.send_create_signal(u'rca', ['ProgrammePageAd'])


    def backwards(self, orm):
        # Deleting model 'ProgrammePageAd'
        db.delete_table(u'rca_programmepagead')
