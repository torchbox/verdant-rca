...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'EventItemCarouselItem.link'
        db.add_column(u'rca_eventitemcarouselitem', 'link',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'EventItemCarouselItem.poster_image'
        db.add_column(u'rca_eventitemcarouselitem', 'poster_image',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'EventItemCarouselItem.link'
        db.delete_column(u'rca_eventitemcarouselitem', 'link')

        # Deleting field 'EventItemCarouselItem.poster_image'
        db.delete_column(u'rca_eventitemcarouselitem', 'poster_image_id')
