...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'JobPage.listing_intro'
        db.alter_column(u'rca_jobpage', 'listing_intro', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'JobPage.listing_intro'
        db.alter_column(u'rca_jobpage', 'listing_intro', self.gf('django.db.models.fields.CharField')(max_length=100))
