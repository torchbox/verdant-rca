...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'NewsItemCarouselItem.url'
        db.delete_column(u'rca_newsitemcarouselitem', 'url')

        # Deleting field 'NewsItemCarouselItem.text'
        db.delete_column(u'rca_newsitemcarouselitem', 'text')

        # Adding field 'NewsItemCarouselItem.image_year'
        db.add_column(u'rca_newsitemcarouselitem', 'image_year',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=25, blank=True),
                      keep_default=False)

        # Adding field 'NewsItemCarouselItem.image_creator'
        db.add_column(u'rca_newsitemcarouselitem', 'image_creator',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'NewsItemCarouselItem.image_medium'
        db.add_column(u'rca_newsitemcarouselitem', 'image_medium',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'NewsItemCarouselItem.image_dimensions'
        db.add_column(u'rca_newsitemcarouselitem', 'image_dimensions',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=25, blank=True),
                      keep_default=False)

        # Adding field 'NewsItemCarouselItem.image_photographer'
        db.add_column(u'rca_newsitemcarouselitem', 'image_photographer',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=25, blank=True),
                      keep_default=False)

        # Adding field 'NewsItemCarouselItem.overlay_text'
        db.add_column(u'rca_newsitemcarouselitem', 'overlay_text',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'NewsItemCarouselItem.link'
        db.add_column(u'rca_newsitemcarouselitem', 'link',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'NewsItemCarouselItem.embedly_url'
        db.add_column(u'rca_newsitemcarouselitem', 'embedly_url',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'NewsItemCarouselItem.poster_image'
        db.add_column(u'rca_newsitemcarouselitem', 'poster_image',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['verdantimages.Image']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'NewsItemCarouselItem.url'
        db.add_column(u'rca_newsitemcarouselitem', 'url',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200),
                      keep_default=False)

        # Adding field 'NewsItemCarouselItem.text'
        db.add_column(u'rca_newsitemcarouselitem', 'text',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=25, blank=True),
                      keep_default=False)

        # Deleting field 'NewsItemCarouselItem.image_year'
        db.delete_column(u'rca_newsitemcarouselitem', 'image_year')

        # Deleting field 'NewsItemCarouselItem.image_creator'
        db.delete_column(u'rca_newsitemcarouselitem', 'image_creator')

        # Deleting field 'NewsItemCarouselItem.image_medium'
        db.delete_column(u'rca_newsitemcarouselitem', 'image_medium')

        # Deleting field 'NewsItemCarouselItem.image_dimensions'
        db.delete_column(u'rca_newsitemcarouselitem', 'image_dimensions')

        # Deleting field 'NewsItemCarouselItem.image_photographer'
        db.delete_column(u'rca_newsitemcarouselitem', 'image_photographer')

        # Deleting field 'NewsItemCarouselItem.overlay_text'
        db.delete_column(u'rca_newsitemcarouselitem', 'overlay_text')

        # Deleting field 'NewsItemCarouselItem.link'
        db.delete_column(u'rca_newsitemcarouselitem', 'link')

        # Deleting field 'NewsItemCarouselItem.embedly_url'
        db.delete_column(u'rca_newsitemcarouselitem', 'embedly_url')

        # Deleting field 'NewsItemCarouselItem.poster_image'
        db.delete_column(u'rca_newsitemcarouselitem', 'poster_image_id')
    ...
    models = {
        ...
        u'rca.newsitemcarouselitem': {
            ...
            'poster_image': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'to': u"orm['verdantimages.Image']"})
        },
