...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'StandardIndexCarouselItem'
        db.create_table(u'rca_standardindexcarouselitem', (
            ...
            ('page', self.gf('django.db.models.fields.related.ForeignKey')(related_name='carousel_items', to=orm['rca.StandardIndex'])),
        ))
        db.send_create_signal(u'rca', ['StandardIndexCarouselItem'])

        # Adding model 'StandardIndexRelatedLink'
        db.create_table(u'rca_standardindexrelatedlink', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('page', self.gf('django.db.models.fields.related.ForeignKey')(related_name='related_links', to=orm['rca.StandardIndex'])),
            ('link', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='related_links_link', null=True, to=orm['rca.StandardPage'])),
        ))
        db.send_create_signal(u'rca', ['StandardIndexRelatedLink'])

        # Adding model 'StandardIndexTeaser'
        db.create_table(u'rca_standardindexteaser', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('page', self.gf('django.db.models.fields.related.ForeignKey')(related_name='teasers', to=orm['rca.StandardIndex'])),
            ('image', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['rca.RcaImage'])),
            ('url', self.gf('django.db.models.fields.URLField')(max_length=200, blank=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('text', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
        ))
        db.send_create_signal(u'rca', ['StandardIndexTeaser'])

        # Adding field 'StandardIndex.teasers_title'
        db.add_column(u'rca_standardindex', 'teasers_title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'StandardIndex.twitter_feed'
        db.add_column(u'rca_standardindex', 'twitter_feed',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'StandardIndexCarouselItem'
        db.delete_table(u'rca_standardindexcarouselitem')

        # Deleting model 'StandardIndexRelatedLink'
        db.delete_table(u'rca_standardindexrelatedlink')

        # Deleting model 'StandardIndexTeaser'
        db.delete_table(u'rca_standardindexteaser')

        # Deleting field 'StandardIndex.teasers_title'
        db.delete_column(u'rca_standardindex', 'teasers_title')

        # Deleting field 'StandardIndex.twitter_feed'
        db.delete_column(u'rca_standardindex', 'twitter_feed')
    ...
    models = {
        ...
        u'rca.standardindexrelatedlink': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'link': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'related_links_link'", 'null': 'True', 'to': u"orm['rca.StandardPage']"}),
