...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SchoolPageAd'
        db.create_table(u'rca_schoolpagead', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sort_order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('page', self.gf('django.db.models.fields.related.ForeignKey')(related_name='manual_adverts', to=orm['rca.SchoolPage'])),
            ('ad', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['rca.Advert'])),
        ))
        db.send_create_signal(u'rca', ['SchoolPageAd'])

        # Adding model 'JobsIndexAd'
        db.create_table(u'rca_jobsindexad', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sort_order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('page', self.gf('django.db.models.fields.related.ForeignKey')(related_name='manual_adverts', to=orm['rca.JobsIndex'])),
            ('ad', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['rca.Advert'])),
        ))
        db.send_create_signal(u'rca', ['JobsIndexAd'])

        # Adding model 'NewsIndexAd'
        db.create_table(u'rca_newsindexad', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sort_order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('page', self.gf('django.db.models.fields.related.ForeignKey')(related_name='manual_adverts', to=orm['rca.NewsIndex'])),
            ('ad', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['rca.Advert'])),
        ))
        db.send_create_signal(u'rca', ['NewsIndexAd'])

        # Adding model 'ResearchInnovationPageAd'
        db.create_table(u'rca_researchinnovationpagead', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sort_order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('page', self.gf('django.db.models.fields.related.ForeignKey')(related_name='manual_adverts', to=orm['rca.ResearchInnovationPage'])),
            ('ad', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['rca.Advert'])),
        ))
        db.send_create_signal(u'rca', ['ResearchInnovationPageAd'])

        # Adding model 'StandardIndexAd'
        db.create_table(u'rca_standardindexad', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sort_order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('page', self.gf('django.db.models.fields.related.ForeignKey')(related_name='manual_adverts', to=orm['rca.StandardIndex'])),
            ('ad', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['rca.Advert'])),
        ))
        db.send_create_signal(u'rca', ['StandardIndexAd'])

        # Adding model 'StandardPageAd'
        db.create_table(u'rca_standardpagead', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sort_order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('page', self.gf('django.db.models.fields.related.ForeignKey')(related_name='manual_adverts', to=orm['rca.StandardPage'])),
            ('ad', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['rca.Advert'])),
        ))
        db.send_create_signal(u'rca', ['StandardPageAd'])

        # Adding model 'CurrentResearchPageAd'
        db.create_table(u'rca_currentresearchpagead', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sort_order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('page', self.gf('django.db.models.fields.related.ForeignKey')(related_name='manual_adverts', to=orm['rca.CurrentResearchPage'])),
            ('ad', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['rca.Advert'])),
        ))
        db.send_create_signal(u'rca', ['CurrentResearchPageAd'])

        # Adding model 'EventIndexAd'
        db.create_table(u'rca_eventindexad', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sort_order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('page', self.gf('django.db.models.fields.related.ForeignKey')(related_name='manual_adverts', to=orm['rca.EventIndex'])),
            ('ad', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['rca.Advert'])),
        ))
        db.send_create_signal(u'rca', ['EventIndexAd'])

        # Adding model 'StaffIndexAd'
        db.create_table(u'rca_staffindexad', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sort_order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('page', self.gf('django.db.models.fields.related.ForeignKey')(related_name='manual_adverts', to=orm['rca.StaffIndex'])),
            ('ad', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['rca.Advert'])),
        ))
        db.send_create_signal(u'rca', ['StaffIndexAd'])


    def backwards(self, orm):
        # Deleting model 'SchoolPageAd'
        db.delete_table(u'rca_schoolpagead')

        # Deleting model 'JobsIndexAd'
        db.delete_table(u'rca_jobsindexad')

        # Deleting model 'NewsIndexAd'
        db.delete_table(u'rca_newsindexad')

        # Deleting model 'ResearchInnovationPageAd'
        db.delete_table(u'rca_researchinnovationpagead')

        # Deleting model 'StandardIndexAd'
        db.delete_table(u'rca_standardindexad')

        # Deleting model 'StandardPageAd'
        db.delete_table(u'rca_standardpagead')

        # Deleting model 'CurrentResearchPageAd'
        db.delete_table(u'rca_currentresearchpagead')

        # Deleting model 'EventIndexAd'
        db.delete_table(u'rca_eventindexad')

        # Deleting model 'StaffIndexAd'
        db.delete_table(u'rca_staffindexad')
