...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'NewsItemRelatedProgramme'
        db.create_table(u'rca_newsitemrelatedprogramme', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('page', self.gf('django.db.models.fields.related.ForeignKey')(related_name='related_programmes', to=orm['rca.NewsItem'])),
            ('programme', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
        ))
        db.send_create_signal(u'rca', ['NewsItemRelatedProgramme'])

        # Adding model 'NewsItemRelatedSchool'
        db.create_table(u'rca_newsitemrelatedschool', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('page', self.gf('django.db.models.fields.related.ForeignKey')(related_name='related_schools', to=orm['rca.NewsItem'])),
            ('school', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
        ))
        db.send_create_signal(u'rca', ['NewsItemRelatedSchool'])


    def backwards(self, orm):
        # Deleting model 'NewsItemRelatedProgramme'
        db.delete_table(u'rca_newsitemrelatedprogramme')

        # Deleting model 'NewsItemRelatedSchool'
        db.delete_table(u'rca_newsitemrelatedschool')
