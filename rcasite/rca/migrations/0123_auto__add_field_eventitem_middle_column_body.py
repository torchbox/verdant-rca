...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EventItem.middle_column_body'
        db.add_column(u'rca_eventitem', 'middle_column_body',
                      self.gf('core.fields.RichTextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EventItem.middle_column_body'
        db.delete_column(u'rca_eventitem', 'middle_column_body')
