...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StaffPage.awards_and_grants'
        db.add_column(u'rca_staffpage', 'awards_and_grants',
                      self.gf('core.fields.RichTextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StaffPage.awards_and_grants'
        db.delete_column(u'rca_staffpage', 'awards_and_grants')
