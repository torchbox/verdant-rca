...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StandardPage.show_on_homepage'
        db.add_column(u'rca_standardpage', 'show_on_homepage',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StandardPage.show_on_homepage'
        db.delete_column(u'rca_standardpage', 'show_on_homepage')
