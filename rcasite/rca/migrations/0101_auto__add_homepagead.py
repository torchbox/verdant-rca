...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'HomePageAd'
        db.create_table(u'rca_homepagead', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sort_order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('page', self.gf('django.db.models.fields.related.ForeignKey')(related_name='manual_adverts', to=orm['rca.HomePage'])),
            ('ad', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['rca.Advert'])),
        ))
        db.send_create_signal(u'rca', ['HomePageAd'])


    def backwards(self, orm):
        # Deleting model 'HomePageAd'
        db.delete_table(u'rca_homepagead')
