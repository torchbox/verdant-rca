...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'rca_advertplacement', 'page_id', self.gf('cluster.fields.ParentalKey')(to=orm['core.Page']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'StandardPageQuotation.page'
        db.alter_column(u'rca_standardpagequotation', 'page_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rca.StandardPage']))

        # Changing field 'ResearchInnovationPageCarouselItem.page'
        db.alter_column(u'rca_researchinnovationpagecarouselitem', 'page_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rca.ResearchInnovationPage']))

        # Changing field 'ResearchInnovationPageContactPhone.page'
        db.alter_column(u'rca_researchinnovationpagecontactphone', 'page_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rca.ResearchInnovationPage']))

        # Changing field 'StudentPageWorkCollaborator.page'
        db.alter_column(u'rca_studentpageworkcollaborator', 'page_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rca.StudentPage']))

        # Changing field 'ProgrammeDocuments.page'
        db.alter_column(u'rca_programmedocuments', 'page_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rca.ProgrammePage']))

        # Changing field 'SchoolPageContactEmail.page'
        db.alter_column(u'rca_schoolpagecontactemail', 'page_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rca.SchoolPage']))

        # Changing field 'SchoolPageAd.page'
        db.alter_column(u'rca_schoolpagead', 'page_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rca.SchoolPage']))

        # Changing field 'StaffPageCollaborations.page'
        db.alter_column(u'rca_staffpagecollaborations', 'page_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rca.StaffPage']))

        # Changing field 'StaffPageCarouselItem.page'
        db.alter_column(u'rca_staffpagecarouselitem', 'page_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rca.StaffPage']))

        # Changing field 'JobsIndexAd.page'
        db.alter_column(u'rca_jobsindexad', 'page_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rca.JobsIndex']))

        # Changing field 'EventIndexRelatedLink.page'
        db.alter_column(u'rca_eventindexrelatedlink', 'page_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rca.EventIndex']))

        # Changing field 'StudentPageWorkSponsor.page'
        db.alter_column(u'rca_studentpageworksponsor', 'page_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rca.StudentPage']))

        # Changing field 'ProgrammePageOurSites.page'
        db.alter_column(u'rca_programmepageoursites', 'page_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rca.ProgrammePage']))

        # Changing field 'NewsIndexAd.page'
        db.alter_column(u'rca_newsindexad', 'page_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rca.NewsIndex']))

        # Changing field 'StudentPageCarouselItem.page'
        db.alter_column(u'rca_studentpagecarouselitem', 'page_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rca.StudentPage']))

        # Changing field 'StaffPageRole.page'
        db.alter_column(u'rca_staffpagerole', 'page_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rca.StaffPage']))

        # Changing field 'ProgrammePageCarouselItem.page'
        db.alter_column(u'rca_programmepagecarouselitem', 'page_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rca.ProgrammePage']))

        # Changing field 'RcaNowIndexRelatedLink.page'
        db.alter_column(u'rca_rcanowindexrelatedlink', 'page_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rca.RcaNowIndex']))

        # Changing field 'StaffPagePublicationExhibition.page'
        db.alter_column(u'rca_staffpagepublicationexhibition', 'page_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rca.StaffPage']))

        # Changing field 'HomePageAd.page'
        db.alter_column(u'rca_homepagead', 'page_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rca.HomePage']))

        # Changing field 'RcaNowPagePageCarouselItem.page'
        db.alter_column(u'rca_rcanowpagepagecarouselitem', 'page_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rca.RcaNowPage']))

        # Changing field 'NewsItemRelatedProgramme.page'
        db.alter_column(u'rca_newsitemrelatedprogramme', 'page_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rca.NewsItem']))

        # Changing field 'StudentPageExhibition.page'
        db.alter_column(u'rca_studentpageexhibition', 'page_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rca.StudentPage']))

        # Changing field 'EventItemDatesTimes.page'
        db.alter_column(u'rca_eventitemdatestimes', 'page_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rca.EventItem']))

        # Changing field 'HomePageCarouselItem.page'
        db.alter_column(u'rca_homepagecarouselitem', 'page_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rca.HomePage']))

        # Changing field 'StandardIndexTeaser.page'
        db.alter_column(u'rca_standardindexteaser', 'page_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rca.StandardIndex']))

        # Changing field 'StudentPageDegree.page'
        db.alter_column(u'rca_studentpagedegree', 'page_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rca.StudentPage']))

        # Changing field 'SchoolPageCarouselItem.page'
        db.alter_column(u'rca_schoolpagecarouselitem', 'page_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rca.SchoolPage']))

        # Changing field 'NewsItemCarouselItem.page'
        db.alter_column(u'rca_newsitemcarouselitem', 'page_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rca.NewsItem']))

        # Changing field 'ResearchInnovationPageAd.page'
        db.alter_column(u'rca_researchinnovationpagead', 'page_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rca.ResearchInnovationPage']))

        # Changing field 'ResearchItemLink.page'
        db.alter_column(u'rca_researchitemlink', 'page_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rca.ResearchItem']))

        # Changing field 'StandardPageRelatedDocument.page'
        db.alter_column(u'rca_standardpagerelateddocument', 'page_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rca.StandardPage']))

        # Changing field 'EventItemSpeaker.page'
        db.alter_column(u'rca_eventitemspeaker', 'page_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rca.EventItem']))

        # Changing field 'StandardIndexAd.page'
        db.alter_column(u'rca_standardindexad', 'page_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rca.StandardIndex']))

        # Changing field 'StandardPageCarouselItem.page'
        db.alter_column(u'rca_standardpagecarouselitem', 'page_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rca.StandardPage']))

        # Changing field 'AlumniIndexAd.page'
        db.alter_column(u'rca_alumniindexad', 'page_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rca.AlumniIndex']))

        # Changing field 'ResearchItemCreator.page'
        db.alter_column(u'rca_researchitemcreator', 'page_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rca.ResearchItem']))

        # Changing field 'ResearchInnovationPageRelatedLink.page'
        db.alter_column(u'rca_researchinnovationpagerelatedlink', 'page_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rca.ResearchInnovationPage']))

        # Changing field 'StandardPageAd.page'
        db.alter_column(u'rca_standardpagead', 'page_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rca.StandardPage']))

        # Changing field 'CurrentResearchPageAd.page'
        db.alter_column(u'rca_currentresearchpagead', 'page_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rca.CurrentResearchPage']))

        # Changing field 'ResearchInnovationPageCurrentResearch.page'
        db.alter_column(u'rca_researchinnovationpagecurrentresearch', 'page_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rca.ResearchInnovationPage']))

        # Changing field 'ProgrammePageStudentStory.page'
        db.alter_column(u'rca_programmepagestudentstory', 'page_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rca.ProgrammePage']))

        # Changing field 'ProgrammePageAd.page'
        db.alter_column(u'rca_programmepagead', 'page_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rca.ProgrammePage']))

        # Changing field 'SchoolPageContactTelEmail.page'
        db.alter_column(u'rca_schoolpagecontacttelemail', 'page_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rca.SchoolPage']))

        # Changing field 'EventItemRelatedSchool.page'
        db.alter_column(u'rca_eventitemrelatedschool', 'page_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rca.EventItem']))

        # Changing field 'ResearchInnovationPageTeaser.page'
        db.alter_column(u'rca_researchinnovationpageteaser', 'page_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rca.ResearchInnovationPage']))

        # Changing field 'StudentPageContactsEmail.page'
        db.alter_column(u'rca_studentpagecontactsemail', 'page_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rca.StudentPage']))

        # Changing field 'EventIndexAd.page'
        db.alter_column(u'rca_eventindexad', 'page_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rca.EventIndex']))

        # Changing field 'StudentPageContactsWebsite.page'
        db.alter_column(u'rca_studentpagecontactswebsite', 'page_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rca.StudentPage']))

        # Changing field 'SchoolPageContactPhone.page'
        db.alter_column(u'rca_schoolpagecontactphone', 'page_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rca.SchoolPage']))

        # Changing field 'StandardPageRelatedLink.page'
        db.alter_column(u'rca_standardpagerelatedlink', 'page_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rca.StandardPage']))

        # Changing field 'AdvertPlacement.page'
        db.alter_column(u'rca_advertplacement', 'page_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Page']))

        # Changing field 'ProgrammePageRelatedLink.page'
        db.alter_column(u'rca_programmepagerelatedlink', 'page_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rca.ProgrammePage']))

        # Changing field 'ProgrammePageContactPhone.page'
        db.alter_column(u'rca_programmepagecontactphone', 'page_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rca.ProgrammePage']))

        # Changing field 'StaffIndexAd.page'
        db.alter_column(u'rca_staffindexad', 'page_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rca.StaffIndex']))

        # Changing field 'StandardIndexContactEmail.page'
        db.alter_column(u'rca_standardindexcontactemail', 'page_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rca.StandardIndex']))

        # Changing field 'SchoolPageRelatedLink.page'
        db.alter_column(u'rca_schoolpagerelatedlink', 'page_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rca.SchoolPage']))

        # Changing field 'EventItemCarouselItem.page'
        db.alter_column(u'rca_eventitemcarouselitem', 'page_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rca.EventItem']))

        # Changing field 'StandardIndexContactPhone.page'
        db.alter_column(u'rca_standardindexcontactphone', 'page_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rca.StandardIndex']))

        # Changing field 'AlumniIndexRelatedLink.page'
        db.alter_column(u'rca_alumniindexrelatedlink', 'page_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rca.AlumniIndex']))

        # Changing field 'StandardPageImage.page'
        db.alter_column(u'rca_standardpageimage', 'page_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rca.StandardPage']))

        # Changing field 'StudentPageContactsPhone.page'
        db.alter_column(u'rca_studentpagecontactsphone', 'page_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rca.StudentPage']))

        # Changing field 'ResearchInnovationPageContactEmail.page'
        db.alter_column(u'rca_researchinnovationpagecontactemail', 'page_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rca.ResearchInnovationPage']))

        # Changing field 'StudentPageAwards.page'
        db.alter_column(u'rca_studentpageawards', 'page_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rca.StudentPage']))

        # Changing field 'StandardIndexCarouselItem.page'
        db.alter_column(u'rca_standardindexcarouselitem', 'page_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rca.StandardIndex']))

        # Changing field 'EventItemRelatedProgramme.page'
        db.alter_column(u'rca_eventitemrelatedprogramme', 'page_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rca.EventItem']))

        # Changing field 'ResearchItemCarouselItem.page'
        db.alter_column(u'rca_researchitemcarouselitem', 'page_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rca.ResearchItem']))

        # Changing field 'StandardIndexRelatedLink.page'
        db.alter_column(u'rca_standardindexrelatedlink', 'page_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rca.StandardIndex']))

        # Changing field 'NewsItemLink.page'
        db.alter_column(u'rca_newsitemlink', 'page_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rca.NewsItem']))

        # Changing field 'EventItemRelatedArea.page'
        db.alter_column(u'rca_eventitemrelatedarea', 'page_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rca.EventItem']))

        # Changing field 'NewsItemRelatedSchool.page'
        db.alter_column(u'rca_newsitemrelatedschool', 'page_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rca.NewsItem']))

        # Changing field 'ProgrammePageContactEmail.page'
        db.alter_column(u'rca_programmepagecontactemail', 'page_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rca.ProgrammePage']))

        # Changing field 'JobsIndexRelatedLink.page'
        db.alter_column(u'rca_jobsindexrelatedlink', 'page_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rca.JobsIndex']))

        # Changing field 'StudentPageExperience.page'
        db.alter_column(u'rca_studentpageexperience', 'page_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rca.StudentPage']))
