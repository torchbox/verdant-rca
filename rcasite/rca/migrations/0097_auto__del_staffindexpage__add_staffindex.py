...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'StaffIndex'
        db.create_table(u'rca_staffindex', (
        ...
        db.send_create_signal(u'rca', ['StaffIndex'])


    def backwards(self, orm):
        # Adding model 'StaffIndexPage'
        db.create_table(u'rca_staffindexpage', (
            ('feed_image', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['rca.RcaImage'], blank=True)),
            ('twitter_feed', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('social_text', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('show_in_menus', self.gf('django.db.models.fields.BooleanField')(default=False)),
            (u'page_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['core.Page'], unique=True, primary_key=True)),
            ('social_image', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['rca.RcaImage'], blank=True)),
            ('intro', self.gf('core.fields.RichTextField')(blank=True)),
            ('seo_title', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
        ))
        db.send_create_signal(u'rca', ['StaffIndexPage'])

        # Deleting model 'StaffIndex'
        db.delete_table(u'rca_staffindex')
