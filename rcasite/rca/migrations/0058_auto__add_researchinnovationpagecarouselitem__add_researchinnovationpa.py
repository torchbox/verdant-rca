...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'rca_researchinnovationpagecurrentresearch', (
            ...
            ('link', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['core.Page'])),
        ))
        ...
        db.add_column(u'rca_researchinnovationpage', 'intro',
                      self.gf('core.fields.RichTextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'ResearchInnovationPage.intro_link'
        db.add_column(u'rca_researchinnovationpage', 'intro_link',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['core.Page']),
                      keep_default=False)
