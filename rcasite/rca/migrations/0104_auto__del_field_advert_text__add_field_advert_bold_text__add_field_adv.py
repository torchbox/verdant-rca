...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Advert.text'
        db.delete_column(u'rca_advert', 'text')

        # Adding field 'Advert.bold_text'
        db.add_column(u'rca_advert', 'bold_text',
                      self.gf('django.db.models.fields.CharField')(default='adboldtext', max_length=255),
                      keep_default=False)

        # Adding field 'Advert.plain_text'
        db.add_column(u'rca_advert', 'plain_text',
                      self.gf('django.db.models.fields.CharField')(default='adplaintext', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Advert.text'
        db.add_column(u'rca_advert', 'text',
                      self.gf('django.db.models.fields.CharField')(default='adtextold', max_length=255),
                      keep_default=False)

        # Deleting field 'Advert.bold_text'
        db.delete_column(u'rca_advert', 'bold_text')

        # Deleting field 'Advert.plain_text'
        db.delete_column(u'rca_advert', 'plain_text')
    ...
    models = {
        ...
        u'rca.advert': {
            ...
            'bold_text': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'page': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'adverts'", 'null': 'True', 'to': u"orm['core.Page']"}),
            'plain_text': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
