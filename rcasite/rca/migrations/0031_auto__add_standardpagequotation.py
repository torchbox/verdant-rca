...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'StandardPageQuotation'
        db.create_table(u'rca_standardpagequotation', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('page', self.gf('django.db.models.fields.related.ForeignKey')(related_name='quotations', to=orm['rca.StandardPage'])),
        ...
        db.send_create_signal(u'rca', ['StandardPageQuotation'])


    def backwards(self, orm):
        # Deleting model 'StandardPageQuotation'
        db.delete_table(u'rca_standardpagequotation')
