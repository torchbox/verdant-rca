# Django settings for rcasite project.
...
MIDDLEWARE_CLASSES = (
    ...
    'verdant.verdantredirects.middleware.RedirectMiddleware',
...
INSTALLED_APPS = (
    ...
    'verdant.verdantsearch',
    'verdant.verdantusers',
    'verdant.verdantredirects',
