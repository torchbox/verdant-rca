...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'core_page', 'parent_id')


    def backwards(self, orm):
        # Adding field 'Page.parent'
        db.add_column(u'core_page', 'parent',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='subpages', null=True, to=orm['core.Page'], blank=True),
                      keep_default=False)
