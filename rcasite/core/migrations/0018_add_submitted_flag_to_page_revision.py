...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PageRevision.submitted_for_moderation'
        db.add_column(u'core_pagerevision', 'submitted_for_moderation',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PageRevision.submitted_for_moderation'
        db.delete_column(u'core_pagerevision', 'submitted_for_moderation')
